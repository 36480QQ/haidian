...
metrics = {
  ...
  "metrics": {
    ...
    "parcel_pairs": 6,
    "sunlight_rule": "居住地块纯住宅（无教育/底商/点式）：统一60×14m板楼5排南低北高（10-15层/30-45m，参照万柳书院/使馆壹号院/融创北京壹号院），全部以中轴x=0左右镜像（两翼楼栋严格对称），每排栋数按两翼边界较窄者自适应、外端离边界5m贴紧，排距380m≈8.4×最高楼高（北京大寒日≥2h），层高3.0m",
