...
本表给参赛者、翻译人员和 AI agent 提供赛事方推荐译法。双语展示材料应优先使用这些译法，并在中文、英文版本中保持名称、指标和状态一致。v2 方案缺少必需译稿或语言映射会阻断投稿合并；术语和语义一致性由参赛者负责、维护者人工核对。历史 v1 单语方案继续兼容展示。
...
| 双语门禁 | Bilingual Gate | BG | v2 缺少必需译稿、语言映射或有效文件时阻断合并；v1 仅作兼容提醒 | Optional Translation |
