---
title: "SCREENLESS JING-ZHANG: Bringing AI Back to Walking, Touch, Sound, and Face-to-Face Urban Life"
...
summary: "A screen-optional civic AI corridor along the Jing-Zhang railway heritage park, with three key areas for technical validation, public translation, and everyday application. All spatial moves are conceptual and use provisional geometry."
...
![Three scopes and spatial structure](assets/figures/land-use-structure.en.png)
...
The screenless ecosystem is not a single hardware sector. It links foundation models and chips, edge inference, multimodal interaction, accessibility design, privacy computing, scenario operations, and third-party evaluation. Seven public reference directions are identified for later primary-source verification: MIT tangible interfaces, Google Project Euphonia, Microsoft Seeing AI, the Wayfindr open audio-navigation standard, Barcelona’s human-centered superblocks, Helsinki’s public digital-twin practice, and Tokyo’s accessible wayfinding. They are methodological references, not site facts, guaranteed outcomes, or investment commitments. [source:SOURCE-REGISTRY] [standard:MOHURD-URBAN-DESIGN-MEASURES]
...
![Validation, translation, and application ports](assets/figures/key-areas.en.png)
...
![Walking, blue-green space, and service touchpoints](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, provenance, and self-check](assets/figures/metrics-evidence.en.png)
