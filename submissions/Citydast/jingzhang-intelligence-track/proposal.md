...
| 受益群体 | 对应空间举措 | 公共价值 | 包容性设计 | 数据与隐私边界 |
| --- | --- | --- | --- | --- |
| 周边居民 | 遗址公园慢行缝合、社区服务嵌入、蓝绿公共空间 | 通勤便利、休闲健康、生活品质 | 无障碍坡道、适老化照明与活动分级 | 居民画像不用于商业推荐，热力仅聚合 |
| 青年人才 | 低成本办公、端侧算力驿站、人才住区 | 就业创业、低成本创新 | 青年友好公共空间、夜间活力与第三空间 | 算力与就业数据聚合使用 |
| AI 企业 | 产业载体、测试场、国际路演客厅 | 创新生态、产业集聚 | 中小企业普惠（算力券方向）、标准治理咨询 | 企业标识与案例须清权 |
| 高校师生 | 近校成果转化街、开源协作、教育体验点 | 成果转化、跨校协作 | 跨校共享设施、成果转化驿站 | 校园数据与科研成果须授权 |
| 游客/全球开发者 | 遗址公园、贡献墙、活动周路线 | 文化体验、开源荣誉 | 免费开放、无障碍导览、双语导视 | 行为数据仅聚合统计 |
| 弱势群体 | 主动服务、社区级智能体 | 服务可达、数字鸿沟弥合 | 适老化/无障碍交互、方言语音辅助方向 | 个人数据最小化+人工复核 |
...
实施方案形成六个可审查的更新项目清单 [metric:renewal_project_count]：JZ-01 京张遗址公园慢行断点缝合（公共空间/交通，依赖道路红线、桥下空间与交通组织复核）、JZ-02 众智园清河创新界面（蓝绿空间/产业展示，依赖河道蓝线与防洪条件）、JZ-03 原点社区近校成果转化街（城市更新/产业服务，依赖校区边界、权属与首层业态）、JZ-04 大钟寺站四象限步行连通（轨道一体化/慢行，依赖站点、道路交叉口与市政管线）、JZ-05 AI 公共服务与端侧算力节点（新基建/公共服务，依赖能源、算力、安全与运营主体）、JZ-06 全球 AI 活动周公共路线（运营/品牌，依赖公共空间许可、活动安全与版权清权）[depth:renewal_project_list]。每个项目说明位置、类型、功能、责任主体、依赖条件、实施阶段、风险与评估指标，缺少权属、资金、实施主体与审批路径的内容均作为实施风险列出，不承诺落地 [depth:phasing_implementation][data:geometry/phasing.geojson#PHASE-001]。为回应评审对可实施性的要求，方案为六个项目配置**概念性实施 KPI 与监测框架**（下表），作为专业团队深化时校准与考核的起点；所有基准值均待官方现状、权属与控规数据发布后校准，不构成审定指标或政府承诺 [depth:metrics_recalculation]。

| 项目 | 概念 KPI 指标 | 基准/口径（待校准） | 概念目标方向 | 责任主体（概念） | 评估周期 |
| --- | --- | --- | --- | --- | --- |
| JZ-01 慢行断点缝合 | 缝合断点数量、贯通慢行道长度（km） | 现状断点清单（官方现状数据） | 断点缝合为主、贯通率提升 | 区级城管/交通+运营方 | 年度 |
| JZ-02 清河创新界面 | 滨水绿带贯通率、低碳展示节点数 | 河道蓝线与防洪条件 | 界面贯通、展示节点≥2 | 区级水务/园林+产业运营 | 年度 |
| JZ-03 近校成果转化街 | 入驻服务机构数、孵化转化项目数 | 校区边界与权属 | 服务集聚、转化项目递增 | 园区运营+高校成果转化专班 | 季度 |
| JZ-04 大钟寺四象限连通 | 连通路径数、无障碍覆盖率 | 站点与路口工程条件 | 四象限步行连通、无障碍达标 | 轨道/市政+交通部门 | 交付期 |
| JZ-05 AI 公共服务与算力节点 | 服务点数量、试点场景数、单位能耗 | 能源与算力条件 | 服务点落地、试点场景≥3 | 新基建运营+街道 | 年度 |
| JZ-06 全球 AI 活动周 | 活动场次、参与开发者数、国际传播覆盖 | 公共空间许可与版权清权 | 年度活动体系成型 | 活动运营方+品牌团队 | 年度 |
