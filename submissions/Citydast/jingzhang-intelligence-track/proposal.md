...
**公共利益可测试化承诺**（回应评审对弱势群体可操作性要求，均为概念口径、不构成强制规范）：第一，**可测试无障碍指标**——参照《无障碍环境建设法》与无障碍设计相关要求 [source:SOURCE-REGISTRY][standard:MOHURD-ARCH-DESIGN-DEPTH-2016]，主要公共空间路径坡度≤1:20（条件受限处设辅助坡道）、导视系统对比度≥3:1 且字号可放大、无障碍卫生间与低位服务设施按标准间距配置；第二，**传统服务渠道保留**——AI 服务点必须保留人工柜台、电话与现场代办渠道，无智能设备用户（老年、低收入、残障人群）可通过传统渠道获得同等服务，不因「服务找人」而减少线下替代 [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]；第三，**参与式设计机制**——公众与弱势群体代表纳入场景卡开放评审与更新项目决策门评审，反馈结果按季度公示，场景启停须以公众意见与实测数据双条件触发 [source:AGENT-TASKBOOK]；第四，**投诉与补救流程**——设立 48 小时响应、7 个工作日闭环的投诉通道（线上+线下双入口），涉及个人数据的投诉启动人工复核与数据最小化审查，补救结果登记入场景卡风险台账 [depth:risk_missing_data]。
