...
| T2 慢行接驳 | 建议 6 周；S01–S04；一处获准 IT-04/05 接口；未授权未运行 | 未来 A=获授权项目所有者、R=慢行试验运营者；C=无障碍使用者/交通/公园/安全，I=周边社区；资源为纸图、现场引导、遮阴避雨、审计清单和撤场工具 | 授权后建立最不利组基线；不可绕行、疏散冲突或错误预警即停止数字引导，恢复既有路线并复演 |
