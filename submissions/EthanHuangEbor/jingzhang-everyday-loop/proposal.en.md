---
title: "Jing-Zhang Symbiotic Everyday Loop: An AI Innovation Belt People Can Use, Question and Leave"
...
summary: "One spine, three loops and nine stations connect heritage, community, innovation and public services through six agent tasks, six global precedents and reversible pilots with visible evidence and exit routes."
...
![Overall concept, scope hierarchy and task response](assets/figures/site-overview.en.png)
...
![One spine, three loops, eight ecosystem factors and land-use strategy](assets/figures/land-use-structure.en.png)
...
![Three key areas, nine station ledgers and conceptual landmarks](assets/figures/key-areas.en.png)
...
![Twelve scenarios, three pilots, slow mobility, blue-green space and governance](assets/figures/mobility-bluegreen.en.png)
...
This iteration concentrates the nine-station network in a 1:1 public prototype at AOC-02. It is not a miniature technology showroom: the sequence begins with entry that does not require AI and ends with restoration to ordinary public service. Its five moments are 01 Ordinary Passage, 02 Human Service Commons, 03 Voluntary AI Alcove, 04 Public Receipt Gallery, and 05 Quiet Restoration Garden. Ordinary passage and staffed service never depend on using an intelligent system, providing a face, or surrendering unnecessary trajectory data. Voluntary AI serves only a bounded public task; the public receipt contains no personal information; the restoration garden has no screen. The prototype is `not_authorized_not_run`; the real site, rights holder, operator, and professional signatories remain unconfirmed. [data:visual/assets/origin-life-service-station.json#/spatial_moments] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]

Each of the twelve scenarios is rewritten as a reviewable service contract with a purpose, accountable and responsible roles, data ceiling, same-task human route, success evidence, pause action, stop authority, appeal, restoration acceptance, and data-expiry owner. A zero-network runner produces one qualified case and five negative variants per scenario: missing accountable role, unavailable human route, exceeded data ceiling, unavailable stop authority, and missing restoration evidence. Of 72 synthetic cases, only the twelve qualified cases receive a “tabletop only” release and all sixty negative cases are blocked. This demonstrates deterministic rule behaviour, not field performance or service effectiveness. [data:visual/assets/public-acceptance-tabletop/scenario-contracts.json#/scenarios] [data:simulation.json#/cases] [metric:synthetic_tabletop_check_count]

The first 100 days are divided into eight exit-capable work packages controlled by five evidence gates. G0 checks rights, site, and evidence; G1 checks same-task equivalence; G2 permits only controlled service; G3 rehearses stop, removal, restoration, and data expiry; G4 asks an independent reviewer to continue, revise, or exit. If a gate lacks a named duty, human fallback, or restoration evidence, the default is not to proceed. The RACI currently contains proposed roles only and is not a government, site, procurement, or operator commitment. [data:visual/assets/first-100-days.json#/programme] [data:visual/assets/raci-and-signoff.json#/items] [depth:phasing_implementation]
...
![Six cases, twelve scenarios, three pilots, annual operations and evidence chain](assets/figures/metrics-evidence.en.png)
