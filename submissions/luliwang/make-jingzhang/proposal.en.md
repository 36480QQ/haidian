---
title: "MAKE JINGZHANG — Turning the Full Life of Urban AI Devices into a Visible Innovation Chain"
...
summary: "Using the engineering autonomy of the historic Jing-Zhang Railway as its cultural premise, the proposal links controlled prototyping at Zhongzhiyuan, open making at the AI Origin Community, and everyday use and repair at Dazhongsi into a maintainable and reversible urban-device innovation chain."
...
![Overall concept, three maker yards, and provisional-boundary disclosure](assets/figures/site-overview.en.png)

All figures, offline pages, and PDFs are generated from package GeoJSON, metrics, and text. They contain no commercial map screenshots, uncleared photographs, or redistributed external font files. Pale dashed lines show provisional constraints; saturated marks show design relationships rather than official redlines, surveyed buildings, or engineering alignments.[depth:existing_conditions_diagnosis]
...
![Three-level scope, land-use structure, and transmission through the making chain](assets/figures/land-use-structure.en.png)
...
![Roles, projects, and evidence gates for the three maker yards](assets/figures/key-areas.en.png)
...
![Slow-mobility spine, green space, public workstations, and east-west services](assets/figures/mobility-bluegreen.en.png)
...
![Recomputation and audit from geometry to metrics, matrices, and figures](assets/figures/metrics-evidence.en.png)
