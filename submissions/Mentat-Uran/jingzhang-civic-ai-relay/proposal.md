...
| SC-05 开源维护者产品诊所 | 初创、维护者；原点转译院 | 按周接诊，登记问题、依赖、许可证和后续责任 | 商业机密由提交者选择；法律/安全人员复核，随时撤单 |
...
数据与 AI 风险采用预防原则：不使用秘密地图、内部数据或个人隐私；不依赖持续生物识别；高风险公共决策不得由模型自动完成；每个场景保留人工复核、非 AI 替代、申诉、暂停、回滚和删除机制。合成数据测试不自动证明真实环境安全，限域试用也不自动证明可规模化部署。
