...
iteration: "v1.0"
license: "CC-BY-4.0"
summary: "A human-first public-ground protocol where pedestrians, wheelchairs, strollers, and low-speed urban robots can safely share the Centennial Jingzhang AI Innovation Belt."
...
![CO-WALK overview and evidence chain](assets/figures/site-overview.en.png)
...
![Six longitudinal bands and the Co-Walk structure](assets/figures/land-use-structure.en.png)
...
![Three Co-Walk gardens and key-area designs](assets/figures/key-areas.en.png)
...
![Co-Walk Protocol, blue-green mobility, and twelve stations](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, review dimensions, and implementation gates](assets/figures/metrics-evidence.en.png)
