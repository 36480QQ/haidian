---
title: "Loop of Minds v0.3: Right-to-Question Public AI Loop"
title_zh: "回环成带 v0.3：可质询公共 AI 回路"
...
summary: "A reversible, question-able, human-reviewed public AI service prototype that deepens Loop of Minds while retaining provisional-data and confirmation limits."
iteration: "v0.3"
version: "0.3.0"
---
...
![Right-to-Question Public AI Loop](assets/figures/site-overview.en.png)
...
![One loop grammar from brand to decision](assets/figures/land-use-structure.en.png)
...
![Three Prototype Atlas](assets/figures/key-areas.en.png)
...
![From a walking break to a public return](assets/figures/mobility-bluegreen.en.png)
...
![Memory and evidence gateway: conceptual visual, not site evidence](assets/media/concept-evidence-gateway.png)

![Question and co-creation commons: conceptual visual, not site evidence](assets/media/concept-question-commons.png)

![Human-review service corner: conceptual visual, not site evidence](assets/media/concept-human-review-corner.png)

![Walking and accessibility-break diagnostic: conceptual visual, not site evidence](assets/media/concept-walking-diagnostic.png)
...
![90-Day Pilot Charter](assets/figures/pilot-charter.en.png)
