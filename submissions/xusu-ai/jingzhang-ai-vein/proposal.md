...
summary: "以京张遗址公园带为城市中轴（x=0），土地性质与地块划分重大调整：12个建设用地6对镜像对称双翼+3段中轴绿带。居住地块纯住宅：统一60×14m板楼5排南低北高贴边排布（10-15层，北京阳光自南射入，南排30m矮、北排45m高、每排+3m，任何一排不被遮挡，参照万柳书院/使馆壹号院/融创北京壹号院；每排按地块宽度自适应栋数左右贴边界，无点式塔楼/教育/底商），排距380m≈8.4倍最高楼高满足大寒日≥2h日照；科研地块采用大基底点式写字楼（56-75m见方/单层3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%），以4.0%低密度支撑0.35容积率（高度换面积），层高3.6-4.2m符合北京办公标准；商业综合体参照清河万象汇（8层/36m），底商≤3层；文化馆参照首都博物馆/中国科技馆。所有建筑体块均有北京真实案例支撑，非凭空体块。"
...
**V3 方案核心转向**：在 V2「中轴对称」基础上，本版对**土地性质、地块划分与建筑体块**做重大调整——继续以城市中轴线（x=0，京张遗址公园带）为对称轴、东西双翼镜像成对；**建筑体块全部对应北京真实案例，高度锚定中国尊上限、层高符合北京标准**：居住地块为**纯住宅、统一 60×14m 板楼**（5 排南低北高贴边排布——北京在北半球阳光自南射入，南排 30m、北排 45m、每排 +3m 递增，任何一排不被前排遮挡，参照万柳书院/使馆壹号院/融创北京壹号院；每排按地块宽度自适应栋数左右贴边界，无点式塔楼/教育/底商）并严格满足大寒日≥2h日照，科研地块采用大基底点式写字楼（56-75m 见方/单层 3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%，层高3.6-4.2m）以高度换容积率、大幅降低土地覆盖率，商业地块采用综合体（参照清河万象汇/西红门荟聚）与≤3层底商，文化地块采用大型文化馆（参照首都博物馆/中国科技馆）。设计意图：中轴作为京张铁路遗产的文化叙事主轴与城市通风廊道，双翼镜像保证城市服务均衡与天际线对称，建筑体块真实可信、高度与层高符合北京北五环外城市肌理。
...
| 居住 0701 | 板式高层住宅 | 统一 60×14m，10-15 层/30-45m | 万柳书院(10-15层/30-45m)、使馆壹号院(11-14层)、融创北京壹号院(12-15层) | **纯住宅**，5 排南低北高（南排30m→北排45m，每排+3m），每排贴边，排距380m≈8.4×楼高满足日照（见 4.2） |
...
- **南低北高梯度说明**：北半球住宅地块标准做法——南排最矮（10 层/30m）、北排最高（15 层/45m）、每排 +3m 递增。阳光自南射入时，南排 30m 不挡第 2 排，第 2 排 33m 不挡第 3 排……依此类推，**任何一排在大寒日均获得 ≥2h 满窗日照**。每排板楼按该位置地块实际宽度自适应栋数、左右贴边界排满（四角自然有楼贴边），与北京高端住宅社区（万柳书院 7-15 层、融创北京壹号院 12-18 层、使馆壹号院 12-18 层）的南低北高布置逻辑一致（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）。
...
- **建筑排布**：科研地块每翼 10 栋大基底点式写字楼（56-75m 见方，单层 3000-5500㎡ 超中国尊级，45-80m，层高 3.6-4.2m）+ 研发裙房；文化地块每翼 2 座大型文化馆 + 商业配套；居住地块为**纯住宅、统一 60×14m 板楼**（每翼 5 排南低北高 zigzag 错位铺满 1.6km 纵深，南排 30m → 北排 45m 每排 +3m；每排按地块实际宽度自适应栋数左右贴边界，无点式塔楼/教育/底商）；商业地块每翼综合体 + 副楼 + 底商裙房。全部镜像排布（[data:geometry/buildings.geojson]）。
...
- **日照专项**：居住地块为**纯住宅、统一 60×14m 板楼**（5 排/10-15 层/30-45m，层高 3.0m，参照万柳书院/使馆壹号院/融创北京壹号院），**南低北高贴边排布整个地块**（5 排 zigzag 错位铺满 1.6km 纵深，南排 30m → 北排 45m 每排 +3m；每排按地块实际宽度自适应栋数左右贴边界，四角自然有楼），严格执行 4.2 节间距校核（排距 380m ≈ 8.4×最高楼高，远超系数 1.5-1.7），保证大寒日 ≥2h（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）
- 建筑动作：双翼各 5 排统一 60m 板楼南低北高贴边排布（西翼 27 栋/东翼 24 栋，栋数差异因东翼中段边界内缩的物理上限）——**住宅区无点式/教育/底商，纯住宅**
...
**建筑规模**（[metric:total_floor_area_sqm]）：概念总建筑面积约 398 万 m²，FAR 约 0.35（[metric:floor_area_ratio]），建筑密度约 4.0%（[metric:building_density]），建筑 113 栋（镜像对称，[metric:building_count]）。**高度换覆盖率策略**：大基底点式写字楼以 4.0% 低密度支撑 0.35 FAR（对比 V2 密度 12.2%/FAR 0.56，建筑占地减少约 67%），释放大量地面空间。层数构成：科研大基底点式写字楼 11-20 层（45-80m，单层 3000-5500㎡ 超中国尊级，层高 3.6-4.2m，参照中国尊/正大中心/国贸三期单层面积）、文化馆 3-4 层（30-36m，参照首博/科技馆）、居住纯住宅 10-15 层（30-45m，层高 3.0m，参照万柳书院/使馆壹号院/融创北京壹号院——统一 60×14m 板楼 5 排南低北高贴边排布，无点式/教育/底商）、商业综合体 5-8 层（24-36m，参照清河万象汇）、底商与裙房 ≤3 层（9-12m）。**高度上限**：全方案最高 80m，仅为北京最高楼中国尊（528m）的 15%。
