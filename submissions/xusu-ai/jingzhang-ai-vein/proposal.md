...
summary: "以京张遗址公园带为城市中轴（x=0），土地性质与地块划分重大调整：12个建设用地6对镜像对称双翼+3段中轴绿带。居住地块纯住宅（无教育/底商）：5排板式住宅南低北高均匀分布（楼栋长45-65m/进深14m/10-15层，北京阳光自南射入，南排30m矮、北排45m高、每排+3m，任何一排不被遮挡，参照万柳书院/使馆壹号院/融创北京壹号院）+4栋点式塔楼四角贴边界（南角30m/北角45m），排距350m≈7.8倍最高楼高满足大寒日≥2h日照；科研地块采用大基底点式写字楼（56-75m见方/单层3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%），以4.0%低密度支撑0.34容积率（高度换面积），层高3.6-4.2m符合北京办公标准；商业综合体参照清河万象汇（8层/36m），底商≤3层；文化馆参照首都博物馆/中国科技馆。所有建筑体块均有北京真实案例支撑，非凭空体块。"
...
**V3 方案核心转向**：在 V2「中轴对称」基础上，本版对**土地性质、地块划分与建筑体块**做重大调整——继续以城市中轴线（x=0，京张遗址公园带）为对称轴、东西双翼镜像成对；**建筑体块全部对应北京真实案例，高度锚定中国尊上限、层高符合北京标准**：居住地块为**纯住宅**（5 排板式住宅南低北高均匀分布全地块——北京在北半球阳光自南射入，南排 30m、北排 45m、每排 +3m 递增，任何一排不被前排遮挡，参照万柳书院/使馆壹号院/融创北京壹号院；4 栋点式塔楼四角贴边界，南角 30m/北角 45m）并严格满足大寒日≥2h日照，科研地块采用大基底点式写字楼（56-75m 见方/单层 3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%，层高3.6-4.2m）以高度换容积率、大幅降低土地覆盖率，商业地块采用综合体（参照清河万象汇/西红门荟聚）与≤3层底商，文化地块采用大型文化馆（参照首都博物馆/中国科技馆）。设计意图：中轴作为京张铁路遗产的文化叙事主轴与城市通风廊道，双翼镜像保证城市服务均衡与天际线对称，建筑体块真实可信、高度与层高符合北京北五环外城市肌理。
...
| 居住 0701 | 板式高层住宅 | 45-65×14m，10-15 层/30-45m | 万柳书院(10-15层/30-45m)、使馆壹号院(11-14层)、融创北京壹号院(12-15层) | **纯住宅**，5 排南低北高（南排30m→北排45m，每排+3m），排距350m≈7.8×楼高满足日照（见 4.2） |
| 居住 0701 | 点式住宅（四角） | 30×30m，10-15 层/30-45m | 万柳书院/使馆壹号院式点式楼 | 4 栋贴地块四角（南角30m/北角45m），无教育/底商 |
...
**日照标准**：北京属Ⅱ类气候区，住宅建筑日照按大寒日满窗日照 ≥ 2 小时控制（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）。**全部居住建筑为纯住宅**（5 排板式住宅楼栋长 45-65m、进深 14m、层高 3.0m——北京板楼常规取值，案例参照万柳书院/使馆壹号院/融创北京壹号院；4 栋点式塔楼贴四角），**南低北高梯度排布**：北京在北半球，冬季阳光自南射入，南排楼栋必须低于北排，北排才能获得直射阳光。本方案 5 排板楼从南到北高度 30→45m 每排 +3m 递增，南北排距 350m ≈ 7.8×最高楼高，远超北京板楼日照间距系数 1.5-1.7 要求：

| 排次（南→北） | 高度/层数 | 与后排间距 | 校核（间距≥1.2H） |
|------|----------|-----------|-------------------|
| 第1排（最南） | 10 层/30m | 349m | 1.2×30=36m < 349m ✅ |
| 第2排 | 11 层/33m | 350m | 1.2×33=39.6m < 350m ✅ |
| 第3排 | 12 层/36m | 349m | 1.2×36=43.2m < 349m ✅ |
| 第4排 | 13 层/39m | 350m | 1.2×39=46.8m < 350m ✅ |
| 第5排（最北） | 15 层/45m | — | 北排最高，但其南侧各排均更矮，无遮挡 ✅ |

- **南低北高梯度说明**：北半球住宅地块标准做法——南排最矮（10 层/30m）、北排最高（15 层/45m）、每排 +3m 递增。阳光自南射入时，南排 30m 不挡第 2 排，第 2 排 33m 不挡第 3 排……依此类推，**任何一排在大寒日均获得 ≥2h 满窗日照**。四角点式塔楼同样南低北高（南角 30m/北角 45m，与相邻板排同高），与北京高端住宅社区（万柳书院 7-15 层、融创北京壹号院 12-18 层、使馆壹号院 12-18 层）的南低北高布置逻辑一致（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）。
...
- **高度换覆盖率**：大基底点式办公楼以 4.0% 的建筑密度支撑 FAR 0.34（V2 为密度 12.2%/FAR 0.56），建筑占地减少约 67%，腾出大量地面空间用于绿地、广场与慢行系统——"用高度换面积、满足容积率"策略，同时保持高度与层高合理性。
- **建筑排布**：科研地块每翼 10 栋大基底点式写字楼（56-75m 见方，单层 3000-5500㎡ 超中国尊级，45-80m，层高 3.6-4.2m）+ 研发裙房；文化地块每翼 2 座大型文化馆 + 商业配套；居住地块为**纯住宅**（每翼 20 栋板楼**南低北高均匀分布**（5 排 zigzag 错位铺满 1.6km 纵深，楼栋长 45-65m 交错，南排 30m → 北排 45m 每排 +3m）+ 4 栋点式塔楼**四角贴边界**（南角 30m/北角 45m），无教育/底商）；商业地块每翼综合体 + 副楼 + 底商裙房。全部镜像排布（[data:geometry/buildings.geojson]）。
...
- **日照专项**：居住地块为**纯住宅**（5 排板式住宅楼栋长 45-65m/进深 14m/10-15 层/30-45m，层高 3.0m，参照万柳书院/使馆壹号院/融创北京壹号院 + 4 栋点式塔楼四角贴边界），**南低北高均匀分布整个地块**（5 排 zigzag 错位铺满 1.6km 纵深，南排 30m → 北排 45m 每排 +3m，模拟北京高端住宅社区万柳书院/使馆壹号院式点板结合），严格执行 4.2 节间距校核（排距 350m ≈ 7.8×最高楼高，远超系数 1.5-1.7），保证大寒日 ≥2h（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）
- 建筑动作：双翼各 20 栋板楼南低北高均匀分布全地块（5 排铺满 1.6km 纵深，南低北高梯度）+ 4 栋点式塔楼贴四角（南角 30m/北角 45m）——**住宅区无教育/底商，纯住宅**
...
**建筑规模**（[metric:total_floor_area_sqm]）：概念总建筑面积约 391 万 m²，FAR 约 0.34（[metric:floor_area_ratio]），建筑密度约 4.0%（[metric:building_density]），建筑 110 栋（镜像对称，[metric:building_count]）。**高度换覆盖率策略**：大基底点式写字楼以 4.0% 低密度支撑 0.34 FAR（对比 V2 密度 12.2%/FAR 0.56，建筑占地减少约 67%），释放大量地面空间。层数构成：科研大基底点式写字楼 11-20 层（45-80m，单层 3000-5500㎡ 超中国尊级，层高 3.6-4.2m，参照中国尊/正大中心/国贸三期单层面积）、文化馆 3-4 层（30-36m，参照首博/科技馆）、居住纯住宅 10-15 层（30-45m，层高 3.0m，参照万柳书院/使馆壹号院/融创北京壹号院——每翼 20 栋板楼 5 排南低北高 + 4 栋点式塔楼四角贴边界，无教育/底商）、商业综合体 5-8 层（24-36m，参照清河万象汇）、底商与裙房 ≤3 层（9-12m）。**高度上限**：全方案最高 80m，仅为北京最高楼中国尊（528m）的 15%。
