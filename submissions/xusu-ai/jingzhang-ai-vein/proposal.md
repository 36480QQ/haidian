...
summary: "以京张遗址公园带为城市中轴（x=0），土地性质与地块划分重大调整：12个建设用地6对镜像对称双翼+3段中轴绿带。居住地块全部采用板式住宅（楼栋长45-65m/进深14m/11-18层，6排均匀分布全地块，参照万柳书院/融泽嘉园/天通苑），排距≥1.2倍楼高满足大寒日≥2h日照；科研地块采用大基底点式写字楼（56-75m见方/单层3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%），以4.3%低密度支撑0.37容积率（高度换面积），层高3.6-4.2m符合北京办公标准；商业综合体参照清河万象汇（8层/36m），底商≤3层；文化馆参照首都博物馆/中国科技馆。所有建筑体块均有北京真实案例支撑，非凭空体块。"
...
**V3 方案核心转向**：在 V2「中轴对称」基础上，本版对**土地性质、地块划分与建筑体块**做重大调整——继续以城市中轴线（x=0，京张遗址公园带）为对称轴、东西双翼镜像成对；**建筑体块全部对应北京真实案例，高度锚定中国尊上限、层高符合北京标准**：居住地块全部采用板式住宅（6 排均匀分布全地块，参照万柳书院/融泽嘉园/天通苑/望京新城）并严格满足大寒日≥2h日照，科研地块采用大基底点式写字楼（56-75m 见方/单层 3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%，层高3.6-4.2m）以高度换容积率、大幅降低土地覆盖率，商业地块采用综合体（参照清河万象汇/西红门荟聚）与≤3层底商，文化地块采用大型文化馆（参照首都博物馆/中国科技馆）。设计意图：中轴作为京张铁路遗产的文化叙事主轴与城市通风廊道，双翼镜像保证城市服务均衡与天际线对称，建筑体块真实可信、高度与层高符合北京北五环外城市肌理。
...
| 居住 0701 | 板式高层住宅 | 55×14m，11-18 层/33-54m | 融泽嘉园(18层/54m)、天通苑(16层/48m)、望京新城(11层/33m) | **全部板楼**，南高北低排布，间距 ≥1.2×楼高满足日照（见 4.2） |
...
**高度梯度与北京天际线锚点**：全方案最高建筑 80m（科研办公制高点），仅为北京最高楼中国尊（528m）的 15%；高度梯度为 办公(27-80m) > 住宅(33-54m) > 商业(24-36m) > 文化(30-36m) > 底商裙房(≤12m)——办公楼低于中国尊、其他类型建筑均低于办公楼，符合北京北五环外（上地/中关村软件园一带）真实城市肌理高度。**层高标准**：科研办公 3.6-4.2m/层、住宅板楼 2.8-3.0m/层、商业 4.2-5.5m/层、文化展示大空间 6-10m/层、教学楼 3.6-4.2m/层，全部符合北京各类型建筑普遍层高。
...
- **天际线「两端高、中间低」对称**：南北科研地块设 80m 制高点办公楼（参考上地信息产业基地地标）+ 27-70m 塔群（参考上地/中关村软件园），镜像成对；中段居住为 33-54m 板楼群、商业为 24-36m 综合体（参考清河万象汇），形成「两端高、中间低缓」的对称天际线；沿中轴自北向南高度曲线左右完全一致（[depth:urban_character_skyline]）。
- **高度上限锚定**：全方案最高建筑 80m，仅为北京最高楼中国尊（528m）的 15%，办公楼不超中国尊、其他类型建筑均低于办公楼——符合北京北五环外（上地/中关村软件园）真实城市肌理。
- **高度换覆盖率**：大基底点式办公楼以 4.6% 的建筑密度支撑 FAR 0.37（V2 为密度 12.2%/FAR 0.56），建筑占地减少约 62%，腾出大量地面空间用于绿地、广场与慢行系统——"用高度换面积、满足容积率"策略，同时保持高度与层高合理性。
- **建筑排布**：科研地块每翼 10 栋大基底点式写字楼（56-75m 见方，单层 3000-5500㎡ 超中国尊级，27-80m，层高 3.6-4.2m）+ 研发裙房；文化地块每翼 2 座大型文化馆 + 商业配套；居住地块每翼 30 栋板楼**均匀分布全地块**（6 排 zigzag 错位铺满 1.6km 纵深，楼栋长 45-65m 交错，南高北低）+ 点式住宅 + 中小学 + 沿街底商；商业地块每翼综合体 + 副楼 + 底商裙房。全部镜像排布（[data:geometry/buildings.geojson]）。
...
- 建筑动作：双翼各 10 栋大基底点式写字楼（56-75m 见方/单层 3000-5500㎡，参考中国尊底部 78m 见方/正大中心 50m 见方/国贸三期 48×50m 的单层面积，27-80m，层高 3.6-4.2m）+ 3 层研发裙房（参照中关村软件园办公楼），北端 80m 制高点塔镜像成对（[depth:key_area_building_typology]）
...
- **日照专项**：居住地块**全部采用板式住宅**（楼栋长 45-65m/进深 14m/11-18 层/33-54m，层高 3.0m，参照融泽嘉园/天通苑/望京新城），**均匀分布整个地块**（6 排 zigzag 错位铺满 1.6km 纵深，模拟北京真实高层社区——万柳书院/使馆壹号院式点板结合），严格执行 4.2 节间距校核（南排18层→68m、中排16层→60m、北排11层→42m），保证大寒日 ≥2h（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）
- 建筑动作：双翼各 30 栋板楼均匀分布全地块（6 排铺满 1.6km 纵深，南高北低）+ 点式住宅 + 配建小学（参照中关村三小）+ 配建中学（参照北京四中）+ 沿街底商（≤2层，参照社区商业街）
...
**建筑规模**（[metric:total_floor_area_sqm]）：概念总建筑面积约 422 万 m²，FAR 约 0.37（[metric:floor_area_ratio]），建筑密度约 4.3%（[metric:building_density]），建筑 132 栋（镜像对称，[metric:building_count]）。**高度换覆盖率策略**：大基底点式写字楼以 4.3% 低密度支撑 0.37 FAR（对比 V2 密度 12.2%/FAR 0.56，建筑占地减少约 65%），释放大量地面空间。层数构成：科研大基底点式写字楼 11-20 层（45-80m，单层 3000-5500㎡ 超中国尊级，层高 3.6-4.2m，参照中国尊/正大中心/国贸三期单层面积）、文化馆 3-4 层（30-36m，参照首博/科技馆）、居住板楼 11-18 层（33-54m，层高 3.0m，参照融泽嘉园/天通苑/望京新城，6 排均匀分布全地块）、商业综合体 5-8 层（24-36m，参照清河万象汇）、底商与裙房 ≤3 层（9-12m）。**高度上限**：全方案最高 80m，仅为北京最高楼中国尊（528m）的 15%。
...
**风貌控制**（[depth:blue_green_public_space]，[depth:urban_character_skyline]）：中轴两侧建筑高度对称渐变（南北两端 80m 制高点办公楼群 → 中段板楼 33-54m/综合体 24-36m），色彩双翼对称（蓝/紫/金/珊瑚在轴两侧镜像使用），形成「中轴绿廊 + 双翼城市」的对称城市意象。**数据缺口**：现状树木、水体与历史建筑清单待补充。
