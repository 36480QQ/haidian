...
summary: "以京张遗址公园带为城市中轴（x=0），土地性质与地块划分重大调整：12个建设用地6对镜像对称双翼+3段中轴绿带。居住地块全部采用板式住宅（错落组团排布，楼栋长45-65m/进深14m/11-18层，参照融泽嘉园/天通苑/望京新城），排距≥1.2倍楼高满足大寒日≥2h日照；科研地块采用大基底点式办公楼（27-80m，参照上地信息产业基地/中关村软件园，最高仅为中国尊528m的15%），以4.6%低密度支撑0.37容积率（高度换面积），层高3.6-4.2m符合北京办公标准；商业综合体参照清河万象汇（8层/36m），底商≤3层；文化馆参照首都博物馆/中国科技馆。所有建筑体块均有北京真实案例支撑，非凭空体块。"
...
**V3 方案核心转向**：在 V2「中轴对称」基础上，本版对**土地性质、地块划分与建筑体块**做重大调整——继续以城市中轴线（x=0，京张遗址公园带）为对称轴、东西双翼镜像成对；**建筑体块全部对应北京真实案例，高度锚定中国尊上限、层高符合北京标准**：居住地块全部采用板式住宅（错落组团排布，参照融泽嘉园/天通苑/望京新城）并严格满足大寒日≥2h日照，科研地块采用大基底点式办公楼（27-80m，参照上地信息产业基地/中关村软件园，最高仅为中国尊528m的15%，层高3.6-4.2m）以高度换容积率、大幅降低土地覆盖率，商业地块采用综合体（参照清河万象汇/西红门荟聚）与≤3层底商，文化地块采用大型文化馆（参照首都博物馆/中国科技馆）。设计意图：中轴作为京张铁路遗产的文化叙事主轴与城市通风廊道，双翼镜像保证城市服务均衡与天际线对称，建筑体块真实可信、高度与层高符合北京北五环外城市肌理。
...
|------|---------|---------|-----------------|---------|
| 科研 0802 | 大基底点式办公楼群 | 38-66m 见方，27-80m，7-25 层（层高3.6-4.2m） | 上地信息产业基地(80m地标/60-70m/48-54m)、中关村软件园二期(55-60m)、软件园办公楼(30-45m) | 大基底点式塔楼，高度不超过北京最高楼中国尊(528m)的 15%，以密度补容积率、降低土地覆盖率（[depth:building_typology_highrise]） |
...
- **建筑排布**：科研地块每翼 20 栋大基底点式办公楼（27-80m，层高 3.6-4.2m）+ 研发裙房；文化地块每翼 2 座大型文化馆 + 商业配套；居住地块每翼 16 栋板楼错落组团（3 排 zigzag 错位，楼栋长 45-65m 交错，南高北低）+ 中小学 + 沿街底商；商业地块每翼综合体 + 副楼 + 底商裙房。全部镜像排布（[data:geometry/buildings.geojson]）。
...
- 建筑动作：双翼各 20 栋大基底点式办公楼（27-80m，层高 3.6-4.2m，参照上地信息产业基地/中关村软件园写字楼）+ 3 层研发裙房（参照中关村软件园办公楼），北端 80m 制高点塔镜像成对（[depth:key_area_building_typology]）
...
- **日照专项**：居住地块**全部采用板式住宅**（楼栋长 45-65m/进深 14m/11-18 层/33-54m，层高 3.0m，参照融泽嘉园/天通苑/望京新城），**错落组团排布**（3 排 zigzag 错位、楼栋长度交错），严格执行 4.2 节间距校核（南排18层→68m、中排16层→60m、北排11层→42m），保证大寒日 ≥2h（[standard:RESIDENTIAL-SUNLIGHT-STANDARD]）
- 建筑动作：双翼各 16 栋板楼错落组团（南高北低）+ 配建小学（参照中关村三小）+ 配建中学（参照北京四中）+ 沿街底商（≤2层，参照社区商业街）
...
**建筑规模**（[metric:total_floor_area_sqm]）：概念总建筑面积约 421 万 m²，FAR 约 0.37（[metric:floor_area_ratio]），建筑密度约 4.6%（[metric:building_density]），建筑 140 栋（镜像对称，[metric:building_count]）。**高度换覆盖率策略**：大基底点式办公楼以 4.6% 低密度支撑 0.37 FAR（对比 V2 密度 12.2%/FAR 0.56，建筑占地减少约 62%），释放大量地面空间。层数构成：科研大基底点式办公楼 7-25 层（27-80m，层高 3.6-4.2m，参照上地信息产业基地/中关村软件园）、文化馆 3-4 层（30-36m，参照首博/科技馆）、居住板楼 11-18 层（33-54m，层高 3.0m，参照融泽嘉园/天通苑/望京新城，错落组团排布）、商业综合体 5-8 层（24-36m，参照清河万象汇）、底商与裙房 ≤3 层（9-12m）。**高度上限**：全方案最高 80m，仅为北京最高楼中国尊（528m）的 15%。
