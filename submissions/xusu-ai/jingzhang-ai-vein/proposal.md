...
summary: "以京张遗址公园带为城市中轴（x=0），土地性质与地块划分重大调整：12个建设用地6对镜像对称双翼+3段中轴绿带，**全部建筑以中轴x=0左右镜像排布（两翼楼栋严格对称）**。居住地块纯住宅：统一60×14m板楼5排南低北高（10-15层，北京阳光自南射入，南排30m矮、北排45m高、每排+3m，任何一排不被遮挡，参照万柳书院/使馆壹号院/融创北京壹号院；每排栋数按两翼边界较窄者自适应、外端离边界5m贴紧，无点式塔楼/教育/底商），排距380m≈8.4倍最高楼高满足大寒日≥2h日照；科研地块采用大基底点式写字楼（56-75m见方/单层3000-5500㎡，对标中国尊/正大中心/国贸三期单层面积，45-80m，最高仅为中国尊528m的15%），以4.0%低密度支撑0.35容积率（高度换面积），层高3.6-4.2m符合北京办公标准；商业综合体参照清河万象汇（8层/36m），底商≤3层；文化馆参照首都博物馆/中国科技馆。所有建筑体块均有北京真实案例支撑，非凭空体块。"
...
- **建筑排布**：科研地块每翼 10 栋大基底点式写字楼（56-75m 见方，单层 3000-5500㎡ 超中国尊级，45-80m，层高 3.6-4.2m）+ 研发裙房；文化地块每翼 2 座大型文化馆 + 商业配套；居住地块为**纯住宅、统一 60×14m 板楼**（每翼 5 排南低北高 zigzag 错位铺满 1.6km 纵深，南排 30m → 北排 45m 每排 +3m；每排栋数按两翼边界较窄者自适应、外端离边界 5m 贴紧，无点式塔楼/教育/底商）；商业地块每翼综合体 + 副楼 + 底商裙房。**全部 6 对地块建筑以中轴 x=0 严格左右镜像**（[data:geometry/buildings.geojson]）。
