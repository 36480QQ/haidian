...
summary: "以京张遗址公园带为城市中轴（x=0），土地性质与地块划分重大调整：12个建设用地6对镜像对称双翼+3段中轴绿带。居住地块全部采用板式住宅（55×14m/11-18层，参照融泽嘉园/天通苑/望京新城），排距≥1.2倍楼高满足大寒日≥2h日照；科研地块采用大基底点式办公楼（60-120m，参照中关村西区/上地信息产业基地，最高仅为中国尊528m的23%），以3.0%低密度支撑0.32容积率（高度换面积）；商业综合体参照清河万象汇（8层/36m），底商≤3层；文化馆参照首都博物馆/中国科技馆。所有建筑体块均有北京真实案例支撑，非凭空体块。"
...
**V3 方案核心转向**：在 V2「中轴对称」基础上，本版对**土地性质、地块划分与建筑体块**做重大调整——继续以城市中轴线（x=0，京张遗址公园带）为对称轴、东西双翼镜像成对；**建筑体块全部对应北京真实案例且高度锚定中国尊上限**：居住地块全部采用板式住宅（55×14m/11-18层，参照融泽嘉园/天通苑/望京新城）并严格满足大寒日≥2h日照，科研地块采用大基底点式办公楼（60-120m，参照中关村西区/上地信息产业基地，最高仅为中国尊528m的23%）以高度换容积率、大幅降低土地覆盖率，商业地块采用综合体（参照清河万象汇/西红门荟聚）与≤3层底商，文化地块采用大型文化馆（参照首都博物馆/中国科技馆）。设计意图：中轴作为京张铁路遗产的文化叙事主轴与城市通风廊道，双翼镜像保证城市服务均衡与天际线对称，建筑体块真实可信、高度符合北京北五环外城市肌理。
...
|------|---------|---------|-----------------|---------|
| 科研 0802 | 大基底点式办公楼群 | 42-52m 见方，60-120m，20-40 层 | 中关村西区写字楼(100-120m)、上地信息产业基地(80-100m)、五道口/学院路(80-90m)、中关村软件园二期(70-80m) | 大基底点式塔楼，高度不超过北京最高楼中国尊(528m)的 23%，以密度补容积率、降低土地覆盖率（[depth:building_typology_highrise]） |
...
**高度梯度与北京天际线锚点**：全方案最高建筑 120m（科研办公制高点），仅为北京最高楼中国尊（528m）的 23%；高度梯度为 办公(60-120m) > 住宅(33-54m) > 商业(24-36m) > 文化(30-36m) > 底商裙房(≤12m)——办公楼低于中国尊、其他类型建筑均低于办公楼，符合北京北五环外（上地/中关村软件园一带）真实城市肌理高度。
...
- **天际线「两端高、中间低」对称**：南北科研地块设 120m 制高点办公楼（参考中关村西区写字楼）+ 60-100m 塔群（参考上地/中关村软件园），镜像成对；中段居住为 33-54m 板楼群、商业为 24-36m 综合体（参考清河万象汇），形成「两端高、中间低缓」的对称天际线；沿中轴自北向南高度曲线左右完全一致（[depth:urban_character_skyline]）。
- **高度上限锚定**：全方案最高建筑 120m，仅为北京最高楼中国尊（528m）的 23%，办公楼不超中国尊、其他类型建筑均低于办公楼——符合北京北五环外真实城市肌理。
- **高度换覆盖率**：大基底点式办公楼以 3.0% 的建筑密度支撑 FAR 0.32（V2 为密度 12.2%/FAR 0.56），建筑占地减少约 75%，腾出大量地面空间用于绿地、广场与慢行系统——"用高度换面积、满足容积率"策略，同时保持高度合理性。
- **建筑排布**：科研地块每翼 10 栋大基底点式办公楼（60-120m）+ 研发裙房；文化地块每翼 2 座大型文化馆 + 商业配套；居住地块每翼 15 栋板楼（3 排×5 栋，南高北低）+ 中小学 + 沿街底商；商业地块每翼综合体 + 副楼 + 底商裙房。全部镜像排布（[data:geometry/buildings.geojson]）。
...
- 建筑动作：双翼各 10 栋大基底点式办公楼（60-120m，参照中关村西区/上地信息产业基地写字楼）+ 3 层研发裙房（参照中关村软件园办公楼），北端 120m 制高点塔镜像成对（[depth:key_area_building_typology]）
...
**建筑规模**（[metric:total_floor_area_sqm]）：概念总建筑面积约 365 万 m²，FAR 约 0.32（[metric:floor_area_ratio]），建筑密度约 3.0%（[metric:building_density]），建筑 96 栋（镜像对称，[metric:building_count]）。**高度换覆盖率策略**：大基底点式办公楼以 3.0% 低密度支撑 0.32 FAR（对比 V2 密度 12.2%/FAR 0.56，建筑占地减少约 75%），释放大量地面空间。层数构成：科研大基底点式办公楼 20-40 层（60-120m，参照中关村西区/上地信息产业基地）、文化馆 3-4 层（30-36m，参照首博/科技馆）、居住板楼 11-18 层（33-54m，参照融泽嘉园/天通苑/望京新城）、商业综合体 5-8 层（24-36m，参照清河万象汇）、底商与裙房 ≤3 层（9-12m）。**高度上限**：全方案最高 120m，仅为北京最高楼中国尊（528m）的 23%。
...
**风貌控制**（[depth:blue_green_public_space]，[depth:urban_character_skyline]）：中轴两侧建筑高度对称渐变（南北两端 120m 制高点办公楼群 → 中段板楼 33-54m/综合体 24-36m），色彩双翼对称（蓝/紫/金/珊瑚在轴两侧镜像使用），形成「中轴绿廊 + 双翼城市」的对称城市意象。**数据缺口**：现状树木、水体与历史建筑清单待补充。
