...
**方案版本 v0.3（2026-08-08）**：本版强化了时态城市设计协议、重点区可逆场景与跨图纸证据一致性。
...
文本、结构化数据和本地生成图由 Codex 在公开或清权资料基础上生成；不使用商业地图截图、未经授权字体、人物肖像、企业标识或其他投稿图件。外部案例仅作方法研究并保留来源。本方案采用 COMMUNITY-DISPLAY-ONLY，与主办方和仓库条款共同适用。
