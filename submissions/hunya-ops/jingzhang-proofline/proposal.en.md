---
title: "Jing-Zhang Proofline: An AI Innovation Urban Commons for Public Verification"
...
![Land-use structure showing six topology-sharing conceptual bands and intentionally blank controls](assets/figures/land-use-structure.en.png)
...
![Key-area diagram showing the different roles of Technical Proof, Open Translation, and Civic Experience](assets/figures/key-areas.en.png)
...
![Mobility and blue-green diagram showing the spine, cycle route, cross-connections, and four public rules](assets/figures/mobility-bluegreen.en.png)
