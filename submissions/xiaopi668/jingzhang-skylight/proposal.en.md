...
On the cultural narrative, the Skylight Line fuses "the centennial Jing-Zhang heritage, Zhongguancun culture, and the new AI culture" into one thread: railway maintenance history provides the institutional prototype, Zhongguancun innovation history provides the spiritual prototype, and the AI maintenance log constitutes the contemporary narrative - all sharing the common motif of "being able to stop" [agent.5]. The primary name is proposed as "**京张天窗带 / JINGZHANG SKYLIGHT LINE**", with the English name emphasizing the double meaning of "skylight" - an architectural light aperture and a maintenance/management "window". The naming system has three layers [source:SRC-2026-0518-AGENT-OPEN-CALL-TASKBOOK]:
...
| Gate | Name | Passing condition | Stage |
|---|---|---|---|
| C0 | Concept review | Scenario aligns with the three protocol tracks and public interest | Pre-application |
| C1 | Data declaration | Complete declaration of data boundaries, anonymization, and aggregation rules [standard:GENERATIVE-AI-INTERIM-MEASURES] | Application |
| C2 | Risk grading | Green/yellow/red grading with maintenance window and takeover plan | Assessment |
| C3 | Pilot application | Accepted by a Test/Commons/Service window; clear pilot scope and term | Pilot |
| C4 | Public notice | Three-color status, operating hours, and maintenance windows publicized ≥14 days | Notice |
| C5 | Trial run | Limited trial with at least 1 completed maintenance inspection and public review | Trial |
| C6 | Go-live | 2 consecutive passed inspection reviews and takeover drills | Launch |
| C7 | Periodic re-review | Quarterly re-check of data declaration, risk grading, and maintenance logs | Operations |
...
- **Accessibility and digital inclusion**: every AI scenario retains non-digital fallback (human counters, phone service, signage); shutdown notices are published in multiple languages, large-print, and broadcast; mobility and public-space design follows accessibility standards [standard:WUBA-2012-ACCESSIBILITY];
- **Grievance and appeals**: a "Skylight Hotline" and offline desks; responses within 48h, outcome within 7 working days; major complaints enter human review.
