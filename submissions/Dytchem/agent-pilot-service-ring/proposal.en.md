...
![Three-level scope and the one-belt one-loop three-stations two-wings spatial framework](assets/figures/land-use-structure.en.png)
...
![Three key areas: validation station, co-learning station, experience station](assets/figures/key-areas.en.png)
...
![Composite system: pilot corridor right-of-way grading, service loop and blue-green public space](assets/figures/mobility-bluegreen.en.png)
