...
文本、图表、HTML 和 PDF 为本次人机协作原创。概念主视觉由 OpenAI image generation 按本方案提示生成，只作为想象层，明确不是现场照片、测绘底图或真实建筑方案；核心图件由提交 GeoJSON 和 metrics 派生。字体使用本机合法安装字体渲染，不打包字体文件；未复制外部案例图片。[source:ASSET-GENERATION-METHOD]
