---
title: "京张同路签 / JINGZHANG SAME-ROUTE PASS"
...
summary: "把本人选择、可撤回且不自动授予代理权的支持关系作为临时服务单元；入口、排队、路线、服务、AI-off 与疏散不得擅自拆开，安全例外由具名人员处理并负责重聚。"
...
![本人选择、全链同路与安全例外](assets/figures/site-overview.png)
...
![三层范围与三区差异化验证](assets/figures/land-use-structure.png)

![拆分检测、本人确认、安全重聚](assets/figures/key-areas.png)
...
![同路路径、私下例外、AI-off 与重聚](assets/figures/mobility-bluegreen.png)
...
![协议计数、现场未知与停止边界](assets/figures/metrics-evidence.png)
