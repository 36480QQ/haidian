---
title: "JINGZHANG SAME-ROUTE PASS / 京张同路签"
...
summary: "Treat a person-chosen, revocable supporter relationship with no automatic proxy authority as a temporary service unit; entry, queues, routes, service, AI-off and evacuation must not split it without the person's confirmation, while named humans own safety exceptions and reunification."
...
![Person choice, route continuity, and safety exception](assets/figures/site-overview.en.png)
...
![Three scales and differentiated tests](assets/figures/land-use-structure.en.png)

![Split detection, person confirmation, and safe reunion](assets/figures/key-areas.en.png)
...
![Continuity route, private exception, AI-off, and reunion](assets/figures/mobility-bluegreen.en.png)
...
![Protocol counts, unknown field results, and stop boundaries](assets/figures/metrics-evidence.en.png)
