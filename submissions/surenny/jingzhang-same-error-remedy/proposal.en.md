---
title: "JINGZHANG ONE ERROR, EQUAL REMEDY / 京张同错同补"
...
summary: "After a named human confirms one systemic error in a public AI rule, model, dataset, or interface version, the responsible body proactively finds potentially co-affected people, humans decide inclusion or exclusion, and authorized staff offer remedy without repeated proof; silence is not waiver."
...
![Overall chain from the first confirmed error to equal remedy](assets/figures/site-overview.en.png)
...
![Four civic tasks within provisional scopes](assets/figures/land-use-structure.en.png)
...
![Dedicated accountability in the three key areas](assets/figures/key-areas.en.png)
...
![Ordinary service, human review, and blue-green continuity](assets/figures/mobility-bluegreen.en.png)
