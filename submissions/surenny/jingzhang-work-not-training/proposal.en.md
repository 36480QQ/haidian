---
title: "JINGZHANG WORK, NOT TRAINING / 京张不跟班"
...
summary: "Separate ordinary work from voluntary AI demonstration as two spatial and rights tracks: refusing, pausing or withdrawing training contribution cannot reduce wages, shifts, workplace access, tools or basic facilities, while disputed derivatives remain disabled."
...
![Ordinary-work line and voluntary-demonstration pocket](assets/figures/site-overview.en.png)
...
![Four spatial roles within a provisional extent](assets/figures/land-use-structure.en.png)
...
![Agent.1 identity and spatial structure](assets/figures/agent-1-identity.en.png)
...
![Distinct responsibilities of three key areas](assets/figures/key-areas.en.png)
...
![Agent.3 scenarios, personas and tests](assets/figures/agent-3-scenarios.en.png)
...
![Ordinary work, sensor-free green edge and optional pockets](assets/figures/mobility-bluegreen.en.png)
...
![Agent.5 narrative and terminology](assets/figures/agent-5-culture.en.png)
...
![Metrics, gates and unknown boundary](assets/figures/metrics-evidence.en.png)
