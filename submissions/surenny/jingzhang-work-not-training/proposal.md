---
title: "京张不跟班 / JINGZHANG WORK, NOT TRAINING"
...
summary: "把正常履职与自愿 AI 示教拆成两条空间和权利链：劳动者拒绝、暂停或撤回训练贡献时，工资、班次、工作通行、工具与基本设施不得受损，争议派生产物保持禁用。"
...
![普通作业线与自愿示教口袋](assets/figures/site-overview.png)
...
![四类空间角色与临时范围](assets/figures/land-use-structure.png)
...
![Agent.1 识别与三区两翼](assets/figures/agent-1-identity.png)
...
![Agent.2 案例与产业—空间要素](assets/figures/agent-2-ecosystem.png)
...
![三处重点区域的不同责任](assets/figures/key-areas.png)
...
![Agent.3 场景、画像与四项测试](assets/figures/agent-3-scenarios.png)
...
![普通作业、无传感绿边与示教口袋](assets/figures/mobility-bluegreen.png)
...
![Agent.4 责任地标与组件](assets/figures/agent-4-landmarks.png)
...
![Agent.5 文化叙事与国际术语](assets/figures/agent-5-culture.png)
...
![Agent.6 年度运营与退出](assets/figures/agent-6-operations.png)
...
![指标、门禁与 unknown 边界](assets/figures/metrics-evidence.png)
