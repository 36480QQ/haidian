---
title: "JINGZHANG HIDDEN HELP ROOM"
author_github: "surenny"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "A conceptual reference scheme where a person can start public service without a notification trail, receive named human referral, and leave without a destination written to a shared system."
...
> Decline optional biometrics without losing the same way home. Start without an account or notification, let a named professional control any referral, and leave with no destination written back to a shared system.
...
The proposal places the hidden-help chain in ordinary public-service space rather than a visibly labelled refuge. A multi-use frontage, non-identifying paper ticket, acoustic buffer, private consultation room, human referral desk, and safe-exit checklist form the minimum spatial sequence. The same rooms can serve legal, health, employment, and general civic consultations, so the queue does not reveal the reason for arrival. Exact siting, accessibility, fire, security, worker safety, and lawful record retention remain for affected-person representatives and qualified professionals to confirm. [source:AGENT-TASKBOOK] [depth:three_key_area_detailed_design]
...
![Hidden help room evidence figure](assets/figures/site-overview.en.png)

## Coordinated Research Area: Industry and Future City Research

HIDDEN HELP ROOM is a cross-sector urban capability, not one vendor’s access product. Upstream are local credentials, mechanical opening, accessible components, minimal logs, and revocable interfaces. Midstream are housing/tenancy rights, privacy/records, property operations, fire/security, and labour-capacity review. Downstream are unloaded scenarios, de-identified failure receipts, procurement-exit clauses, and voluntary adoption assessment. The Zhongguancun wing outputs cleared specifications; the Xiaoyuehe wing tests non-identifying arrival and accessible thresholds only. Any collaboration remains for authorised actors to decide. [depth:ai_ecosystem_case_studies] [source:PRC-PIPL-2021]

Future-city value is not measured by detecting a survivor or collecting a risk score. It is measured by whether the person can start without an account, avoid notifications and shared history, choose whether to leave contact details, receive a named professional referral, and stop safely. AI may translate public options, check whether a screen will write to shared history, and clear a local session after human confirmation; it must not identify a perpetrator, predict lethal risk, choose a shelter, infer a legal relationship, alert a contact, or send a destination. Industry outputs must include interfaces, accountability, human rights, failure conditions, and exit evidence; without any one of them they remain research material only.
...
![Second Key evidence figure](assets/figures/land-use-structure.en.png)
...
![Second Key evidence figure](assets/figures/key-areas.en.png)
...
![Second Key evidence figure](assets/figures/mobility-bluegreen.en.png)
...
![Second Key evidence figure](assets/figures/metrics-evidence.en.png)
