---
title: "JINGZHANG RIGHTS HANDOVER STATION / 京张换手站"
...
summary: "When delegated AI participation reaches a point for the person to act independently, freeze new personalization, display, and derived use before named human verification and personal choice; ordinary learning and public service continue during disputes."
tracks: ["youth-friendly-public-space", "enterprise-services-ecosystem", "civic-agent-governance"]
...
![Transfer of control: from delegated participation to personal choice and downstream reconciliation](assets/figures/site-overview.en.png)
...
![Three levels, seven states, and reachable handover carriers](assets/figures/land-use-structure.en.png)

![Three key areas: false-trigger testing, personal choice, and downstream reconciliation](assets/figures/key-areas.en.png)
...
![Ordinary access, camera-free nodes, and removable blue-green space](assets/figures/mobility-bluegreen.en.png)
...
![Known protocol counts, unknown field outcomes, and six stop gates](assets/figures/metrics-evidence.en.png)
