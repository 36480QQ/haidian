---
title: "京张换手站 / JINGZHANG RIGHTS HANDOVER STATION"
...
summary: "当监护或机构代行的 AI 参与关系进入应由本人重新行权的节点，先冻结新的个性化、公开展示和派生利用，再由具名人员核验并让本人选择；争议时普通学习与公共服务继续。"
...
![权利主体转换：从代行参与到本人选择与下游同步](assets/figures/site-overview.png)
...
![三层范围、七状态与可到达的换手载体](assets/figures/land-use-structure.png)

![三处重点区：误触测试、本人选择、下游同步](assets/figures/key-areas.png)
...
![普通可达路径、无摄像节点与可撤蓝绿空间](assets/figures/mobility-bluegreen.png)
...
![已知协议计数、未知现场结果与六道停止门](assets/figures/metrics-evidence.png)
