...
- 建筑基底总面积 618,413 平方米、建筑密度 5.4%，作为概念空间供给基数 [metric:building_footprint_area_sqm]。
...
- **道路等级**：建议形成"快速路-主干路-次干路-支路-慢行绿道"五级网络；提交边界内概念道路总长 51,642 米 [metric:road_length_m]，其中慢行绿道 15,354 米 [metric:greenway_length_m]。
