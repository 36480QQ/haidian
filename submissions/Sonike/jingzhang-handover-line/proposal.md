...
> **图中虚线是临时范围，不是设计主角。** 红色南北线承担责任交接，蓝色横线缝合两侧城市生活；三个彩色交接场分别把研制、开源和公共服务放在不同的责任位置。四个菱形地标让贡献、停用、维修和人工接管能在公共空间被看见。走廊内部的浅色底图是同一批提交几何：用地分区（分类见下一节的用地图）、沿轴的蓝绿基底与二十个更新单元，用来说明这条线穿过的是一段有功能混合的城市，而不是一条画在空地上的轴。
