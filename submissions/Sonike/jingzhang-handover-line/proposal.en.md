...
| --- | --- | --- | --- | --- | --- |
| Raster figures, 26 | The package participants | Rendered programmatically from `geometry/*.geojson` and `metrics.json` | `visual/assets/governance/rights-and-licence.json#license.author_grant_en` | None (glyphs rasterised to pixels under OFL; no font file ships) | Compare `manifest.json#files[].sha256` file by file |
