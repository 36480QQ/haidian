...
- **Roofscape**: podium roofs along the spine are **accessible flat roofs**, with plant grouped and screened by louvres; the roof of Zhongzhiyuan's closed test court carries an observation deck, so "testing is visible but not enterable" holds in section as well as in plan.
