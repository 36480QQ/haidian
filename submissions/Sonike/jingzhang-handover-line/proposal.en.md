...
Dazhongsi tests whether a capability can enter ordinary life. A civic handover hall carries translation, care, maintenance and cultural services. The Century Logbook publishes launch, shutdown, complaint, repair and version-change records. Takeover Booth Zero keeps fixed wayfinding, a paper directory, human help and a physical stop entrance visible. When a service exits, its space returns to ordinary public use instead of retaining dedicated equipment with no maintainer.

Dazhongsi was originally Juesheng Temple, built by imperial order in the eleventh year of Yongzheng (1733) and named after the Yongle Bell it houses. That bell carries Buddhist scripture cast over its body in both Chinese and Sanskrit — more than 230,000 characters in all. The temple became the Dazhongsi Ancient Bell Museum in 1985, and Juesheng Temple was listed as a national key cultural relic protection unit in 1996 [source:SRC-DAZHONGSI-BELL]. **A bell that carries 230,000 characters cast into its own body is itself a record that cannot be quietly rewritten.** The Handover Bell, one of the four landmarks, stands here and inherits exactly that: at every public handover both duty holders confirm version, boundary and shutdown state together, and the record can only be appended to and corrected, never erased. This proposal proposes no change to the heritage fabric itself, and landmark siting follows heritage and public-space procedure.
...
The blue-green system performs three practical jobs. It gives continuous walking shade and rest, offers reversible points for rain and soil observation, and forms a speed buffer between human service and machine testing. Rest strips have no spending threshold. Vegetation, movable separation and the safety steward’s duty together separate a test lane from the walk; a screen warning alone is insufficient.
...
| Package | Pilot space | Responsible organisation types | Cost class | Entry gate | Urban state after rollback |
| --- | --- | --- | --- | --- | --- |
| P0 Public Handover Table | Candidate sheltered interface/ground floor in AI Origin | Site manager, service operator and independent reviewer | S | Six authority gates | Ordinary table, fixed wayfinding and staffed service |
| P1 Continuous civic handover base | ROAD-001 and eight link intersections | Public-space manager and transport/accessibility professionals | M | Surveyed route audit | Fixed wayfinding, steady light and human help |
| P2 Northern validation handover | SCN-01–03 | Test safety and energy/fire professionals | M | Site, safety, insurance and independent metering | Closed yard or ordinary equipment position |
| P3 Central open translation | SCN-04–07 | Civic service, legal/licensing and university-translation types | S/M | Rights, recall and staffed counter established | Ordinary information and presentation space |
