...
**三大定位 × 五大功能 × 三区两翼的显式映射（agent.1）**：任务书给出的五大功能——AI全栈自主创新体系、世界级AI创新生态、AI+场景赋能新范式、智能化AI活力城市、AI治理全球话语权——逐项落位到三区两翼与三大定位，避免功能与空间两张皮：

| 任务书五大功能 | 主要承载区 | 对应定位 | 关键机制 |
| --- | --- | --- | --- |
...
| AI 治理全球话语权 | 大钟寺AI产业聚集区 | 百年京张文化带×AI融合创新带 | 国际路演、标准治理、数据要素、全球发布 |
