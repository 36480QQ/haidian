...
summary: "The proposal uses the Jing-Zhang heritage park as a public-intelligence spine and connects Zhongzhiyuan, the Beijing AI Origin Community, and Dazhongsi into a traceable, recalculable and operable AI innovation commons."
...
Zhongzhiyuan is a garden-like full-stack innovation district; the AI Origin Community is a near-campus transfer and talent community; Dazhongsi is an urban intelligent-economy and international exchange district. ![Key area index showing roles, scenarios and risks](assets/figures/key-areas.en.png)
...
The transport strategy focuses on rail access, walking gaps, cross-road continuity and stayable public spaces. Municipal and public-service proposals combine traditional utilities, new infrastructure, talent services and edge-compute explainers, pending official engineering data. ![Mobility and blue-green network diagram](assets/figures/mobility-bluegreen.en.png)
...
Metrics are divided into recalculable spatial metrics, missing regulatory metrics and future operating metrics. `metrics.json`, `compliance_matrix.json`, `standard_matrix.json` and `design_depth_matrix.json` keep the package auditable. ![Metric evidence diagram showing known and unknown indicators](assets/figures/metrics-evidence.en.png)
