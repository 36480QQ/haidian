---
title: "JingZhang Open Way | The Open Ground"
...
![One civic spine, three forms of open ground and two functional wings](assets/figures/site-overview.en.png)
...
![Concept land-use relations organised by keep, stitch, insert and yield](assets/figures/land-use-structure.en.png)
...
![Open Testbed, Translation Commons and Urban Gateway prototypes](assets/figures/key-areas.en.png)
...
![Concept mobility, blue-green care and three-path service continuity](assets/figures/mobility-bluegreen.en.png)
...
![Five-stage 100-day evidence route, provisional QA metrics and six gates](assets/figures/metrics-evidence.en.png)
