...
summary: "围绕三区域、两翼、十项可逆场景和六道证据门组织的双语概念研究候选；仅供评审讨论，不构成专业审查、采购或实施批准。"
iteration: "v0.6.1-review-fix"
---

# 京张开放之路 R006.1

当前状态为 `CONCEPT_RESEARCH_CANDIDATE`。本文件与结构化几何、指标、来源、假设、双语 A0／A3 图册、离线网页、六组智能体交付登记、权利台账及审查登记共同构成证据有界的评审材料。它不改变证据等级：所有 `E`、`I`、`U` 状态、暂定数值、阻断条件和 `official_boundary=false` 均继续有效；图面可用于讨论，不可替代官方底图、现地量测、工程设计、独立专业审查或批准。

本次 R006.1 修订只解决参与者可控制的问题：双语错配、主题图重复、状态过期、交付结构不足和权利登记不完整。X1–X6 所需的官方资料、现地量测、真实使用者、具名运行权威、成本／退出证据和独立专业审查没有被补造，仍明确 `BLOCKED`。
...
约 100 天的证据取得路径已细化为五阶段：权威与基线、现地与真实使用、共创与方案比较、成本／采购／退出、独立审查与决策。每一阶段均给出角色责任、依赖、ROM 费用区间、验收和停止条件，详见 `deliverables/agent-deliverables.zh.md`。角色目前未具名，费用只是误差可达 -50%/+100% 的概念规划区间，不是报价或预算批准。

## 六组智能体交付物

本轮新增可审查的六组具体成果：

1. 品牌规则及“北／中／南三区域＋知识协作／城市生活两翼”总图；
2. 六类案例比较框架与六类角色生态图谱；
3. 十张场景卡、三个产业测试场景与五个研究型人物原型；
4. 公共空间网络、三处概念地标、公共价值荣誉体系与六类组件；
5. “铁路记忆—当代日常—未来开放”文化导视及国际传播边界；
6. 四季年度活动、开发者社区、分级场景开放及吸引—验证—转化机制。

完整中英文登记分别见 `deliverables/agent-deliverables.zh.md` 与 `deliverables/agent-deliverables.en.md`。这些成果把“要做什么、为何做、如何停”写清楚，但不把桌面研究描述为真实案例、真实用户或实施承诺。
...
版权层面只分发本候选已清权或允许内部审查的派生图面，并保留来源登记；OSM 要素继续标为社群开放数据，官方摘录仅按登记的有限审查用途使用。`report/rights_ledger.json` 已逐项登记身份、AI 辅助、字体、图形、符号、暂定几何、OSM、官方材料、标准、代码和照片状态；`COMMUNITY-DISPLAY-ONLY` 不扩大任何上游许可。任何未来公开发布都应重新核对许可、署名、隐私、人物和现场照片。[depth:existing_conditions_diagnosis]

参与者可控的双语、哈希、状态、静态键盘结构、色彩和权利清单检查，与需要外部主体的规划、交通、景观、市政、资料治理、PDF/UA、屏幕阅读器、A0 实印及成本退出审查，已在 `report/assurance_register.md` 分开记录。任何 `BLOCKED` 项都不视为通过。
