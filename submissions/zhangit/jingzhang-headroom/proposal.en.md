---
title: "JING-ZHANG HEADROOM: An AI Innovation Belt That Makes Room for Uncertainty"
author_github: "zhangit"
language: "en"
proposal_format_version: "2"
bilingual_contract_version: "1"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "A spatial, temporal, governance, and ecological headroom system for an AI innovation belt that can be calibrated, handed back to people, and retired; all spatial proposals use provisional boundaries and must be recalculated when official data arrives."
...
![Overall concept and evidence status](assets/figures/site-overview.en.png)
...
![Land use and three-scale transmission](assets/figures/land-use-structure.en.png)
...
![Mobility and blue-green headroom network](assets/figures/mobility-bluegreen.en.png)
