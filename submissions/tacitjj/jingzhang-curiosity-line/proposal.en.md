---
title: "THE CURIOSITY LINE: Public Acceptance Tests for an AI City"
...
summary: "A one-metre public acceptance framework linking three Question Yards, two wings, twelve stops, accountable trials, and long-term review."
...
![Scope, zones, wings, and collaboration interfaces](assets/figures/site-overview.en.png)
...
![Place index, spatial structure, and functional transmission](assets/figures/land-use-structure.en.png)
...
![Six-part design and delivery dependencies](assets/figures/key-areas.en.png)
...
![Mobility, blue-green network, and one-metre components](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, delivery gates, and evidence chain](assets/figures/metrics-evidence.en.png)

## Risk, Copyright, and Compliance

Risks include provisional boundaries being mistaken for redlines, false precision without controls, unvalidated inclusion claims, AI error or bias, excessive data, failed override, interrupted maintenance, and unclear rights. Controls are persistent caveats, unknown metrics, target-group co-review, limited pilots, minimum fields, physical fallback, stop gates, and an asset register. AI assists organization, drawing, and consistency checks but does not replace planning, architecture, transport, utilities, fire, legal, medical, or child-protection responsibility. [depth:risk_missing_data] [source:SOURCE-REGISTRY] [data:geometry/constraints.geojson#CONSTRAINTS]

Visible assets are generated by the entrant with local code and submitted structured data. The package contains no external image, map tile, company logo, portrait, remote font, tracking, or API call. System fonts are rasterized locally or represented with PDF CID glyphs; font files are not distributed. Original package content uses COMMUNITY-DISPLAY-ONLY, while citations do not transfer third-party rights. No real child, caregiver, disabled person, older resident, operator, or research team has participated yet, so this remains a concept proposal requiring co-design validation.
