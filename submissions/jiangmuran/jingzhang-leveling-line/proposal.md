...
| 用地 | 代码 | 落位依据 |
|---|---|---|
| 文化用地 | 0803 [data:geometry/land_use.geojson#LU-001,LU-B01,LU-B02,LU-B03] | 水准原点标石与公共证据厅所在，BM-0 核心 |
| AI研发与科研用地 | 0802 [data:geometry/land_use.geojson#LU-002,LU-B04] | 众智园一等水准点范围 |
| 社区服务与人才配套 | 0702 [data:geometry/land_use.geojson#LU-003] | AI原点社区范围 |
| 产业服务与商业服务 | 05 [data:geometry/land_use.geojson#LU-004,LU-B05] | 大钟寺高频读数点范围 |
| 公园绿地与开敞空间 | 1401 [data:geometry/land_use.geojson#LU-005] | 主脊绿廊 |
| 城镇村道路用地 | 1207 [data:geometry/land_use.geojson#LU-B06] | 站—点合一的轨道站厅接入段 |
| **本方案留白范围** | **16** [data:geometry/land_use.geojson#LU-006,LU-007,LU-008,LU-009,LU-010,LU-011,LU-012,LU-013,LU-014,LU-015,LU-016] | 上述之外的现状城市建成区 |
...
**FIG.21 量了走到水准点的路，本包却没量过走完自己证据的路。** 「跑这五个脚本、读这几份文件」是一句话，跑一遍要多久是没人问过的问题——现在问了：五个随包校验器全部零退出，合计 **0.71 秒**；另有 9 份文件、1150 KB、1,807 条要读，逐条读数随包提交于 `visual/assets/review_route.json`。计时界定的是**工作量**而不是难度。
