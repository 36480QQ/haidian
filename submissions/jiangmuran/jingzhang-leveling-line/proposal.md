...
**一、#957 的匹配器在历史语料上是空集。** 它要求 `startswith` 四个**带冒号**的前缀，而 1,203 条 action 中匹配数为 0——有 7 条以「组织方」开头，无一条后面跟冒号。**这个窄是有意的**：CocoSgt 两次 `CHANGES_REQUESTED` 要求从子串匹配收紧为精确前缀以防误提升，这是正确的 fail-closed 判断，只是恰好落在一个从不使用该写法的语料上。
...
| **包外评审** | **2** | [@anselasimov-web](https://github.com/anselasimov-web) 在 PR #1002、[@147228](https://github.com/147228) 在 PR #1065 |
