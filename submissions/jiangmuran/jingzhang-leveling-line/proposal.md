...
**第三行值得单独说，因为它把本方案先前的一个发现改写了。** 本方案实测全场 18 份相关方案中，写了「可申诉」的几乎人人有之，而**给出数字时限的只有 1 份**，并据此把「时限」列为本方案的增量。这个结论现在必须修正：**《暂行办法》第十五条早已要求公布反馈时限。** 因此真正的发现不是「本方案想到了加时限」，而是——
