...
316 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 27 | Run against the shipped package, not a draft |
| The author | 209 | Found while working |
| This package's own gate | 22 | Caught at build time, which is what a gate is for |
...
| Reading a rival's package | 22 | Seen elsewhere, absent here |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.72 s**; 9 files, 1166 KB, 1,809 entries left to read, per item in `visual/assets/review_route.json`.
