...
**FIG.21 measured the walk to a benchmark; nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.73 s**; 9 files, 974 KB and 1,613 entries remain to read, per item in `visual/assets/review_route.json`. Timings bound effort, not difficulty.
