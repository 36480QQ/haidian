...
385 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 41 | Run against the shipped package, not a draft |
| The author | 253 | Found while working |
...
| FIG.23 | Finding the nearest benchmark: which way, and how far | Markers appear only where FIG.21 fails: 18 at 150 m, on the existing KIT-04, nothing new built. The face answers four things: direction, distance, P5 time, id. **And states what signage cannot do — it does not make 1,111 m near; mitigation, not a fix** |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.72 s**; 9 files none of which the reviewer receives, 1233 KB, 1,850 entries left to read, per item in `visual/assets/review_route.json`.
