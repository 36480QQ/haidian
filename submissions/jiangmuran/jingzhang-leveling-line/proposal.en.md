...
390 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 43 | Run against the shipped package, not a draft |
| The author | 255 | Found while working |
| This package's own gate | 27 | Caught at build time, which is what a gate is for |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.71 s**; 9 files none of which the reviewer receives, 1233 KB, 1,849 entries left to read, per item in `visual/assets/review_route.json`.
