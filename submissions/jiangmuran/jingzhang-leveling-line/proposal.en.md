...
241 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 26 | Run against the shipped package, not a draft |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.72 s**; 9 files, 1027 KB, 1,734 entries left to read, per item in `visual/assets/review_route.json`.
