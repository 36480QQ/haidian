...
346 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 40 | Run against the shipped package, not a draft |
| The author | 221 | Found while working |
| This package's own gate | 25 | Caught at build time, which is what a gate is for |
...
| No file behind it | 7 |
| Answered in our own words, not theirs | 5 |
| Outlived a corpus | 4 |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.74 s**; 9 files none of which the reviewer receives, 1191 KB, 1,824 entries left to read, per item in `visual/assets/review_route.json`.
