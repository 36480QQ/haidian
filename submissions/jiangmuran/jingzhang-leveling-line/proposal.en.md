...
418 entries [metric:errata_entry_count]. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 45 | Run against the shipped package, not a draft |
| The author | 279 | Found while working |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.73 s**; 9 files none of which the reviewer receives, 1328 KB, 2,023 entries left to read, per item in `visual/assets/review_route.json`.
