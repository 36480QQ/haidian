...
| Reading a rival's package | 8 | Seen elsewhere, absent here |
...
| Uncheckable | 19 |
| Nothing fails it | 14 |
| Recorded where found | 10 |
| Outlived its line | 9 |
| A reference did not resolve | 9 |
| Not itself | 9 |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.71 s**; 9 files, 1053 KB, 1,750 entries left to read, per item in `visual/assets/review_route.json`.
