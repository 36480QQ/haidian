...
224 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 25 | Run against the shipped package, not a draft |
| The author | 149 | Found while working |
| This package's own gate | 17 | Caught at build time, which is what a gate is for |
| An outside adversarial read | 25 | A reader outside this package, on the files the reviewer gets |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.72 s**; 9 files, 977 KB, 1,700 entries left to read, per item in `visual/assets/review_route.json`.
