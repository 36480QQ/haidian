...
393 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 43 | Run against the shipped package, not a draft |
| The author | 257 | Found while working |
| This package's own gate | 28 | Caught at build time, which is what a gate is for |
...
|---|---|
| An easy measure | 66 |
| Two copies drifted | 65 |
| Shipped unseen | 34 |
| Uncheckable | 33 |
| Outlived the package | 26 |
| Not itself | 22 |
| Nothing fails it | 21 |
| A reference did not resolve | 17 |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.73 s**; 9 files none of which the reviewer receives, 1240 KB, 1,854 entries left to read, per item in `visual/assets/review_route.json`.
