...
231 entries. By finder:

| Found by | Count | What it says |
|---|---|---|
| Independent audit | 25 | Run against the shipped package, not a draft |
| The author | 152 | Found while working |
| This package's own gate | 17 | Caught at build time, which is what a gate is for |
| An outside adversarial read | 27 | A reader outside this package, on the files the reviewer gets |
...
**Nothing had measured the walk through this package's own evidence.** The five verifiers exit 0 in **0.7 s**; 9 files, 997 KB, 1,714 entries left to read, per item in `visual/assets/review_route.json`.
