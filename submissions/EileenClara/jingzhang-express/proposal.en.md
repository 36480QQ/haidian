...
- Risks: must not present internal data or unverified policies as facts
...
The urban renewal projects are organized under the principle of "auditable, dependency-aware, risk-aware". This proposal gives 10 conceptual projects with their main dependencies noted (the complete machine index is in `compliance_matrix.json`):

| No. | Project Name | Type | Main Dependencies |
| --- | --- | --- | --- |
| JZ-01 | Jing-Zhang Heritage Park slow-mobility gap stitching | Public space / transport | Road planning boundaries, under-bridge space, traffic-organization review |
| JZ-02 | Zhongzhiyuan Qinghe innovation interface | Blue-green space / industry showcase | River blue line, ecological and flood-control conditions |
| JZ-03 | Origin Community campus-adjacent achievement-transformation street | Urban renewal / industry services | Campus boundaries, ownership, ground-floor formats |
| JZ-04 | Dazhongsi station four-quadrant pedestrian connectivity | Transit-station integration / slow mobility | Rail station, road intersections, municipal pipelines |
| JZ-05 | Open test ground for model training and evaluation | New infrastructure / industry | Computing power, data authorization, safety, operating entity |
| JZ-06 | Open-source achievement showcase gallery and contribution honor wall | Operation / brand | Public-space permits, copyright rights-clearing, operating mechanism |
| JZ-07 | Xiaoyue River low-speed robot delivery pilot | Scenario / operation | Traffic rules, pilot authorization, liability allocation |
| JZ-08 | AI life-services model street | Urban renewal / public services | Community-service facilities, accessibility and age-friendliness conditions |
| JZ-09 | Edge-computing and distributed-energy stations | New infrastructure / municipal | Energy, computing, safety, and municipal conditions |
| JZ-10 | Global AI innovation events public route | Operation / brand | Public-space permits, event safety, copyright rights-clearing |

The renewal projects all correspond to the phasing layers in `geometry/phasing.geojson`. The project list is a conceptual recommendation; any item without ownership, funding, implementation entity, or approval path is listed as an implementation risk rather than a commitment [depth:renewal_project_list].
