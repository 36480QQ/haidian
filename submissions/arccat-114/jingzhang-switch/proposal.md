...
上一轮已经把“信号灯”做成了场景生命周期，但长期质量不能只看场景是否上线。本轮再增加五项慢变量：它们不预设未经测量的目标值，而是先锁定基线、频率、责任人和公开证据；任何变量恶化都先进入复核，不以一次活动数据掩盖长期损耗。

| 慢变量 | 首次基线与观察频率 | 公开证据 | 触发动作 |
|---|---|---|---|
| SV-01 可达连续性 | 绿廊、站点、无障碍断点建档；每季度复核 | 断点清单、人工通行记录 | 断点未修复则暂停新增装置 |
| SV-02 绿荫与停留舒适 | 按南/中/北三段建立季节观察；春夏秋冬各一次 | 遮荫、座椅、雨天可用性记录 | 舒适度下降则先补公共服务，不扩展活动 |
| SV-03 人工服务可得性 | 三场服务窗口和线下替代路径挂牌；每月抽查 | 值守时段、响应记录、无障碍反馈 | 无人工兜底则场景不得升为绿灯 |
| SV-04 在地生活连续性 | 居民、商户、清洁与运营人员共同记录；每季度 | 影响清单、商户/居民反馈、调整单 | 受影响群体可发起红牌和重新设计 |
| SV-05 公共信任与遗产可读性 | 现场问答、文保核验和公开解释；每季度 | 反馈原件、文保前置清单、退役清单 | 争议未闭合则冻结传播和地标深化 |

四道复核门把慢变量接回现有联锁协议：G1 数据与安全边界，G2 人工服务与可达性，G3 受影响群体复核，G4 慢变量年度健康度。T0–T5 仍负责单个场景的申请、审查、试点、评估与退出；G1–G4 负责“这条城市轨道是否还值得继续运行”。
