---
title: "京张工具房 JINGZHANG TOOLROOM：可借、可懂、可归还的 AI 公共工具系统"
...
summary: "把 AI 从只能被展示或被动消费的黑箱，转译为可借用、可理解、可归还、可暂停的公共工具系统；以三处概念节点组织检验、共学和反馈。"
...
> **一句话**：不再把 AI 当成一排只能观看的展品；把它变成公众能借走、能问明白、能退回来、也能随时停止使用的城市工具。
...
**京张工具房 / JINGZHANG TOOLROOM** 不是新增一座建筑，也不是指定的运营机构。它是一套可布置在现有公共界面、园区首层、开敞空间和活动场地的“借—懂—还”协议：

1. **借**：公众、学生、创业团队或来访者获得一项清楚写明用途、数据边界和人工支持的工具或方法；
2. **懂**：工具必须提供普通语言说明、实际操作演示和不用 AI 的替代流程；
3. **还**：试用结果以可处理的反馈、维修记录或公开问题归还给运营者，而不是默认永久保存个人行为数据；
4. **停**：出现误导、歧视、超出用途、无障碍障碍或运营失守时，任何场景可暂停、复核、修订或退出。
...
标志方向是一个**开口的方形工具框**：橙色代表检验，青绿色代表共学，赭黄色代表归还；缺口指向“工具必须留出人工进入和退出的位置”。图形不使用企业 Logo、真实 UI、人物肖像或未清权素材。命名体系包括：工具检验台、方法借阅室、归还反馈台、工具护照、公共说明卡、暂停按钮。它们都是可供专业团队深化研究的品牌与空间语言，不是既定政府品牌。
...
| 重点区域 | 以三种不同功能原型验证公共工具的全生命周期 | 北检验、中借阅、南归还，形成而非复制的接力关系 | 三处 polygon 为临时粗略范围，只表达关系不落定地块 |
