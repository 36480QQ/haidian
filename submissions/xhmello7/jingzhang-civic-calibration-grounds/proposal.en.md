...
summary: "The Civic Calibration Grounds form the public operating layer of a complete Jingzhang AI Innovation Belt: research, open source and prototypes move from Zhongzhiyuan and AI Origin to bounded first use at Dazhongsi, then remain subject to civic verification, correction and public retirement records along Jingzhang."
...
![Jingzhang AI Innovation Belt masterplan](assets/figures/site-overview.en.png)
...
![Innovation belt, three rhythms, two wings and renewal structure](assets/figures/land-use-structure.en.png)
...
![Three urban interfaces: indicative, indicative and conflict-checked](assets/figures/key-areas.en.png)
...
![From research to public life: ecosystem, calibration and scenarios](assets/figures/metrics-evidence.en.png)
...
![Movement, blue-green network, culture route and everyday public realm](assets/figures/mobility-bluegreen.en.png)
