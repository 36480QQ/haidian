...
**符号原型：京张铁路青龙桥人字形展线**——中国自主修建的第一条铁路上的标志性工程创新：火车以「人」字折返换向，翻越八达岭。它把“技术自主”转译成可以被当代城市继续使用的空间语法。
...
本轮将“一个符号草案”收束为可落地的双层品牌系统：**B「人字转向」是正式主标**，用于小尺寸、印章、导视、单色与反白；**Hero「人字轨」是叙事型主视觉**，用于方案首屏、展陈、发布会、影片和城市入口。两者不是两个品牌，而是同一套空间语法的不同密度。

| 资产 | 文件 | 语义与用途 |
|---|---|---|
| 正式主标 B | `assets/figures/alt-b-mark.svg` | 开放环形 + 人形负形：技术从封闭系统转向真实的人；适合印章、头像、导视节点和小尺寸 |
| 叙事主视觉 Hero | `assets/figures/hero-mark.svg` | 红色人形外弧 + 炭黑双轨 + 暖金轨枕：国家基础设施与个人伙伴并行，在原点为人汇合 |
| 标准组合 | `hero-logo-horizontal.svg` / `hero-logo-vertical.svg` | 中英文标准字组合；中文版本用于本地公共场景，英文配对用于国际传播 |
| 单色与反白 | `monochrome-black.svg` / `monochrome-white.svg` | 印刷、压印、深色背景和低彩度应用；反白版必须置于深色底 |

## 4. 图形与空间语法

- **分叉**：国家基础设施 / 个人伙伴两条轨道开始各自承担责任。
- **并轨**：Agent 代理、人类数字界面、线下人工服务三条路径并行，任何人都不因不用 AI 而失去完整公共服务。
- **交汇**：Human-Agent Commons / AI 原点，是服务、记忆授权和公共讨论发生的地方。
- **折返**：人工接管、申诉、停止、回滚；它不是装饰动作，而是治理边界的可视化。
- **成长线**：遇见 AI → 与 AI 成长 → 创造 AI → 公共参与；一带、三核、一原点和导视系统共同复用这条语法。

## 5. 最小使用规范

| 要素 | 规则 |
|---|---|
| 公共深红 | `#821E1E`，主标与关键结构色，表达公共性和行动方向 |
| 基建炭黑 | `#1F1F1F`，轨道、正文、结构线和深色底 |
| 温度暖金 | `#C9A66B`，轨枕、节点和基础设施节奏；不承担小字号正文 |
| 公共米白 | `#F7F5F2`，页面、纸张和低对比背景 |
| 字体 | 中文优先思源黑体 / Source Han Sans；英文使用 Source Sans 3 或系统无衬线回退 |
| 安全留白 | B 主标四周至少保留人头圆点直径 1X；横版组合左右至少 1.5X；与合作方标识至少 2X |
| 最小尺寸 | B 主标数字端 24 px / 印刷端 7 mm；Hero 完整图形数字端 48 px / 印刷端 13 mm；更小尺寸切换极简图标 |
| 禁用 | 不拉伸、不旋转、不加芯片/机器人脸/渐变/3D，不交换红黑金语义，不在复杂摄影上直接使用彩色版 |

**色彩语义**：深红是公共行动，炭黑是基础设施，暖金是可感知的建设节奏，米白保留人的呼吸。视觉上克制，制度上不退让。
