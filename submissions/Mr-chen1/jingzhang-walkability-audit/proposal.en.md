---
title: "JING-ZHANG WALKABILITY AUDIT: Connection Research and Reversible Micro-Renewal"
...
![Evidence before design: from data intake to an exit condition](assets/figures/site-overview.en.png)
...
![Known, unknown, and to-be-surveyed layers: no proposed land-use allocation](assets/figures/land-use-structure.en.png)
...
![Three key areas: assignment, evidence gap, and next action](assets/figures/key-areas.en.png)
...
![Transport, blue-green, and facilities: survey before engineering lines](assets/figures/mobility-bluegreen.en.png)
