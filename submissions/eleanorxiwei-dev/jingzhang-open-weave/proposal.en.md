---
title: "Jing-Zhang Open Weave: A Verifiable Public Prototyping Belt for the AI City"
author_github: "eleanorxiwei-dev"
language: "en"
license: "CC-BY-SA-4.0"
summary: "A public innovation framework that links railway heritage, three verification communities, open interfaces, scenario permits, contributor recognition, human review, and appeal into an auditable urban prototype."
version: "0.9.0"
...
![Concept, evidence boundary, and open weave](assets/figures/site-overview.en.png)
...
![Nine weave zones and scope transmission](assets/figures/land-use-structure.en.png)
...
![Three verification communities](assets/figures/key-areas.en.png)
...
![Mobility, blue-green, public-space, and scenario network](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, evidence chain, and self-check](assets/figures/metrics-evidence.en.png)
