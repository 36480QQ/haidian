...
bilingual_layout: "single-file"
english_full_text: "included"
english_full_text_anchor: "# English Full Text"
---
...
![Evidence chain from narrative to metrics to geometry to sources](assets/figures/metrics-evidence.png)
...
![Three-tier scope and overall spatial structure](assets/figures/site-overview.png)
...
![Land-use structure and development intensity](assets/figures/land-use-structure.png)
...
![Mobility organisation and blue-green public space](assets/figures/mobility-bluegreen.png)
