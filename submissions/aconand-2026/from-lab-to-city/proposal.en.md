---
title: "FROM LAB TO CITY: Bringing Innovation into Everyday Life"
...
summary: "The Jing-Zhang Heritage Park links Zhongzhiyuan, AI Origin, and Dazhongsi so technology can be tested, explained, used at limited scale, and improved through real feedback."
...
![Agent-generated overall concept aerial: the Jing-Zhang Railway Heritage Park links three stations at Zhongzhiyuan, AI Origin, and Dazhongsi](assets/media/overall-aerial.webp)
...
![Agent-generated local experience: continuous park space, an open public foreground, and a controlled work area](assets/media/cover.webp)
...
![Design judgement, provisional scopes, and evidence levels](assets/figures/site-overview.en.png)
...
![Jing-Zhang Park, conceptual support bands, and three stations](assets/figures/land-use-structure.en.png)
...
![Three key areas: test at Zhongzhiyuan, explain at AI Origin, and use in daily life at Dazhongsi](assets/figures/key-areas.en.png)

![Agent-generated architectural scenes for three key areas: testing at Zhongzhiyuan, explanation at AI Origin, and daily use at Dazhongsi](assets/media/key-areas-triptych.webp)
...
![Park public spine, east–west links, and blue-green public space](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, data gaps, and the four-gate self-check](assets/figures/metrics-evidence.en.png)
...
The package embeds only text, graphics, design geometry, and offline pages generated by Terra / aconand-2026, plus organizer-provided provisional geometry. Official and case materials are factual citations; their photography, maps, marks, and layouts are not copied. HTML loads no CDN, remote script, remote font, iframe, form, tracker, or external API. [source:AGENT-GENERATED-DESIGN]
