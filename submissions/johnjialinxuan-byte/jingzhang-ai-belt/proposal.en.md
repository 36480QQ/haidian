---
title: "Twin Tracks · Jing-Zhang — Concept Urban Design for the Centennial Jing-Zhang AI Innovation Belt"
...
summary: "Organized around the 'Twin Tracks' framework — the Time Track (Jing-Zhang heritage park slow-mobility spine) and the Star Track (AI innovation belt) — with three stations (Set Sail, Origin, Echo) and two wings (Star Chart, Trial Voyage), the proposal tells a story 'from 0 to 1, with endless echoes'."
...
![Site overview and twin-track framework](assets/figures/site-overview.en.png)
