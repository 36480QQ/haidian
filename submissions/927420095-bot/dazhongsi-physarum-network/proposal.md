...
| 算法维度 | 场外仿真参数（真实运行） | 转译规则 | 场内概念设计 | 状态 |
| --- | --- | --- | --- | --- |
...
2. 场内「主静脉—支脉—慢行环—绿廊」是依据相同算法逻辑，结合场地 provisional 边界、人口密度、轨道站点与现有道路骨架人工校准后的概念设计，不是算法输出的直接复制粘贴。
