...
> **普通路径永远先行，AI 只做可撤回、可停止、可回退的增益。**

## 执行摘要

百年京张 AI 创新带以建设**全球人工智能产业高地与朝圣地**为目标，是海淀「中关村科学城」科技创新走廊的旗舰载体。本方案作为其三大重点片区之一——**大钟寺 AI 产业集聚区**的详细设计，把这一带级愿景落到可实施的城市更新：以「百年京张文化带 / 都市 AI 生活体验带 / AI 融合创新带」三大定位为统领，「AI 全栈自主创新体系 / 世界级 AI 创新生态 / AI+ 场景赋能新范式 / 智能化 AI 活力城市 / AI 治理全球话语权」五大功能为框架，对齐「三区两翼」协同布局。

大钟寺片区面临**慢行系统断裂、遗产保护与开发矛盾、轨道站点覆盖不足**三大更新问题。本方案以**生物黏菌自适应网络（Physarum polycephalum，Tero et al. 2010）+ NSGA-II 多目标优化（Deb et al. 2002）**为方法工具，把「从养分锚点生长出高效、抗毁、低穿越网络」的自然原理转译为路网更新策略，提出「一核·三区·一界面·一衔接」空间结构与六项更新项目（JZ-01..06）。
...
**可实施性**：路网市政造价 2965.5 万元（附投资口径分层，明确排除管线迁改/轨道土建/拆迁）；分期实施路线图（近期试点 → 中期推进 → 长期治理，每期含可度量里程碑与验收指标）；审批流程（8 类真实主管部门）；参与主体职责（8 类）；经济可行性（土地增值 → 税收增量 → 就业带动示意）；指标体系（12 项可复算指标：场地 1141.3 公顷、绿地率 12.34%、公共空间率 7.33%、建筑基底 31.1 公顷、重点区 3 处）；风险矩阵（R-01..06）。
...
以上为对**现状**的定性诊断；现状断头路数量、慢行覆盖率等量化值待官方现状调查实测，本方案不预设。**提交几何（临时边界，可经 `self_check_submission.py` 复算）**：设计范围 1141.3 公顷、建筑基底 31.1 公顷、绿地率 12.34%、公共空间率 7.33%、重点区 3 处（详见「指标体系、面积复算与合规矩阵」）。
...
上表「现状」列为基于公开资料的定性判断，现状量化指标待官方现状调查后实测、本方案不预设；**提交几何的可复算事实**（设计范围 1141.3 公顷、绿地率 12.34%、公共空间率 7.33% 等）已在「指标体系、面积复算与合规矩阵」以 known 值给出。
