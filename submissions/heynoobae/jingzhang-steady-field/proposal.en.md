---
title: "JINGZHANG STEADY FIELD / 京张稳场"
...
summary: "A D-T-S event chain × E0-E3 evidence model puts Physical AI commissioning into one place, four logical points and six human dispositions; three areas provide three separate services, not a product journey."
...
![Overall concept: one spectrum, three fields and an uninterrupted ordinary path](assets/figures/site-overview.en.png)
...
![Three-level scope and performance overlay](assets/figures/land-use-structure.en.png)
...
![Three non-interchangeable plan-section-operation prototypes](assets/figures/key-areas.en.png)
...
![Ordinary paths, dynamic sources and maintenance routes](assets/figures/mobility-bluegreen.en.png)
...
![Evidence levels, 90-day gates and five public readings](assets/figures/metrics-evidence.en.png)
