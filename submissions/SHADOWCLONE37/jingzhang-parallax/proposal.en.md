---
title: "PARALLAX JING-ZHANG: Turning Disagreement into a Public Design Resource"
...
license: "CC-BY-4.0"
summary: "Instead of asking one model to answer for the city, the project makes model outputs, professional judgment, operating feedback, and lived experience visibly comparable through two parallel lines, three plural-futures yards, five comparison windows, and twelve same-question/different-view scenarios."
...
![Parallax Jing-Zhang overview](assets/figures/site-overview.en.png)
...
![Three scopes and land-use structure](assets/figures/land-use-structure.en.png)
...
![Three plural-futures yards](assets/figures/key-areas.en.png)
...
All authored text, programmatic figures, bilingual pages, and PDFs are original for this submission and licensed CC BY 4.0. External official and institutional sources support facts and methods; their logos, page design, and restricted images are not copied. An AI-generated hero is included as a clearly labelled conceptual spatial visualization; it communicates atmosphere only and is not evidence of existing conditions, approval, public opinion, or recomputable planning facts. Its method, prompt boundaries, and limitations are recorded in `report/copyright_statement.md`. The offline pages load no remote fonts, map tiles, trackers, or APIs. Professional planning, architecture, transport, utilities, landscape, legal, and accessibility review remains required.
