...
All authored text, programmatic figures, bilingual pages, and PDFs are original for this submission and licensed CC BY 4.0. External official and institutional sources support facts and methods; their logos, page design, and restricted images are not copied. No AI-generated cover is included in this version, preventing a mood image from being mistaken for evidence. The offline pages load no remote fonts, map tiles, trackers, or APIs. Professional planning, architecture, transport, utilities, landscape, legal, and accessibility review remains required.
