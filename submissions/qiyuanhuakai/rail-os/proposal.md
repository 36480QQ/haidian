...
summary: "以百年京张为公共骨架，以源—试—享循环组织AI研发、验证、公众评议与长期运营的城市共同能力。"
...
方案以官方资格预审公告、面向智能体任务书、场地包与专业标准本地快照为主要依据。官方公开且可确认的空间数字为：统筹研究范围约 43.6 km²、总体设计范围约 11.4 km²、三处重点区域合计 368.4 ha，其中众智园 192.1 ha、北京 AI 原点社区 104.3 ha、大钟寺 72.0 ha。[source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [standard:PROJECT-OFFICIAL-ANNOUNCEMENT]
...
![图01 场地总览、创新生态与区域协同接口](assets/figures/site-overview.png)
...
- **六类共智站**：学习、移动、照护、气候、生产、文化与协商。每个“站”是空间、服务和运营组合，可嵌入既有建筑、院落、街角和绿地。
...
![图02 用地与空间结构](assets/figures/land-use-structure.png)
...
京张遗址公园先形成“断点台账”，分别核对南端、北端、上跨环路、轨道站点四象限和小月河横向联系；只有现场测绘、权属、交通和无障碍审查通过后，才把概念连线转为步道或骑行实施方案。图 04 用断点、缝合线、A—A′遗址公园断面和 B—B′小月河断面表达核查顺序，三个公共锚点对应南北贯通、东西连通和公众评议，不代表已确定景观工程位置。[source:OFFICIAL-ANNOUNCEMENT] [data:geometry/roads.geojson#ROAD-002] [depth:traffic_rail_slow_parking]
...
![图03 三区精读：源、试、享](assets/figures/key-areas.png)
...
| 07 | 低空巡检沙盒；公园与小月河 | **产业验证** | 隔离试飞走廊、地面观察点、临时程序 | 影像限定目标并打码；关注高危作业替代；争议时退回桌面仿真 |
...
概念用地结构由 AI 研发创新、公园绿地与开敞空间、产业与商业服务、社区服务与配套四类组成，全部在提交临时边界内闭合。其作用是检验“创新、公共空间和生活服务必须并存”，不是提出法定用地调整。[data:geometry/land_use.geojson#LU-001] [metric:site_area_sqm] [depth:land_use_layout]
...
交通策略以“先步行、再接驳、后数字”为序：修补遗址公园与小月河慢行断点，改善轨道站点四象限步行联系，形成连续无障碍路径、骑行与停放系统，再叠加匿名计数、可解释导航和活动疏导。具体线位仍需道路红线、交通组织和现场测绘确认。[data:geometry/roads.geojson#ROAD-001] [depth:traffic_rail_slow_parking]
...
空间复核明确标出三类待测断点：遗址公园南端与北端连续性、上跨环路处的安全连接、东西向高校/园区/社区到遗址公园和小月河的可达性。标志节点依次为北端“失败可见台”、中段“开源贡献墙”、南端“三时共议钟”；图 01 以“待现场核位”的示意点标出清华园火车站、清河、小月河与北影文化接口，使其进入“史料核验—空间标识—双语内容—公众更正”流程，不以生成图替代遗产调查。[source:OFFICIAL-ANNOUNCEMENT] [depth:traffic_rail_slow_parking]
...
![图05 指标与证据链](assets/figures/metrics-evidence.png)

## 风险、版权与合规说明

主要风险及控制为：精确几何缺失时不定点；遗产叙事只用可核实史料；AI 设施不先于基础公共改善；数据最小化并默认不依赖身份识别；三区共享工具和评估避免重复建设；无运营预算不部署；所有公共服务保留非数字渠道；更新项目评估租金、排斥和本地经营影响。[source:SOURCE-REGISTRY] [depth:risk_missing_data]
