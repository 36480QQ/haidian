...
summary: "Designing the Centennial Jing-Zhang AI Innovation Belt as an experienceable public trust infrastructure: one mainline, three trust fields, two wings, twelve stations - turning AI governance from policy language into visitable, testable, reviewable urban space."
...
![Overall concept: Jing-Zhang Trust Line](assets/figures/site-overview.en.png)
...
![Overall land-use structure and three-level conduction](assets/figures/land-use-structure.en.png)
...
![Three key areas: differentiated trust functions](assets/figures/key-areas.en.png)
...
![Slow mobility and blue-green public space network](assets/figures/mobility-bluegreen.en.png)
