---
title: "JING-ZHANG: ROOM FOR ERROR"
...
summary: "Five urban margins—room in space, time, routes, compute and human authority—turn the Jing-Zhang heritage corridor into a public buffer spine that can be tested, paused, taken over by people and recalculated when official data changes."
...
This proposal starts from a restrained position: an AI city is not measured by the percentage of life it automates, but by whether space, time, routes, compute and human authority remain available when a system fails, its evidence changes, or a resident refuses it. The official call and agent taskbook set the assignment; local standards constrain the urban-design vocabulary; and the repository site package and source registry separate formal bases, background references and provisional material [source:OFFICIAL-ANNOUNCEMENT] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK].

No official overall or key-area polygons are available in the repository. This package retains `PROV-SITE-001` and the three provisional key areas solely for concept generation, communication and intake checks. Their dashed outlines are not road redlines, parcels or approval limits [data:geometry/site_boundary.geojson#SITE-001] [source:BOUNDARY-SOURCE]. Issue #846 records a 412.5 m nearest gap between the provisional overall scope and an OSM-mapped Jing-Zhang Railway Heritage Park feature; maintainers found both data paths insufficient to justify changing the provisional boundary. The issue is therefore a recalculation trigger, not a formal spatial basis.

Six international precedents contribute mechanisms rather than forms: one-north combines work, life, learning and a living lab; STATION F colocates multiple programmes; Kendall Square couples proximity with a cross-sector association; MaRS supports ventures through their lifecycle; High Tech Campus Eindhoven shares facilities for open innovation; and Barcelona 22@ illustrates industrial-district renewal. None determines this project's boundary, building scale or statutory metrics [source:CASE-ONE-NORTH] [source:CASE-KENDALL].

![Proposal overview: five urban margins and the public buffer spine](assets/figures/site-overview.en.png)

## Three-Level Scope Framework

At 43.6 km², the coordinated research area asks how an innovation ecosystem can preserve choices through exchange across three zones and two wings. At 11.4 km², the overall design area asks how one public buffer spine, three margin yards and transverse fallback routes can contain experimentation without shifting risk onto everyday life. At the three provisional key areas, the package becomes a set of prototypes that a professional team can inherit: a technology sandbox, a campus-city translation yard and a market trial yard [standard:PROJECT-OFFICIAL-ANNOUNCEMENT] [depth:three_level_scope_framework].

One evidence chain links all levels. Research defines the five margins and operating gates; overall design maps them to a complete land-use partition, blue-green public space, slow-mobility network and phasing; key-area design gives every AI scenario an entry condition, human review, no-AI equivalent and exit condition. The structured partition covers the present provisional site, but every derived area must be recomputed when official polygons arrive [data:geometry/land_use.geojson#LU-001] [metric:site_area_sqm].

![Three scopes and the one-spine, three-yard, two-wing structure](assets/figures/land-use-structure.en.png)

The identity is an open square bracket. Its left edge represents known constraints; its unclosed right edge leaves room for public challenge, professional review and future evidence. Railway Ink signals engineering restraint, Margin Teal marks blue-green space and public rights, and Warning Orange appears only for unconfirmed states. The logo is an original concept sketch using no institutional mark, portrait or corporate trademark.

## Coordinated Research Area: Industry and Future City Research

The five margins are: room in space for reversible and mixed use; room in time to test, evaluate and pause; room in routes for accessible alternatives; room in compute for edge, shared and degraded modes; and room in human authority for notice, refusal, appeal and takeover. Together they translate full-stack innovation, a world-class ecosystem, AI+ scenarios, an active AI city and governance influence into a spatial-operating commons [source:AGENT-TASKBOOK] [depth:overall_spatial_structure].

The precedents transfer six lessons. one-north connects work, living, landscape and testing; STATION F shows that co-located programmes can serve multiple venture stages; Kendall Square uses an association to work on transport, housing, energy and vitality; MaRS links space, public purpose, venture support and adoption; Eindhoven lowers fixed costs through shared research facilities; and 22@ warns that industrial renewal must coordinate housing, public space, existing communities and phasing. Jing-Zhang answers with small, bookable and reversible margin yards rather than a copied megacampus [source:CASE-STATION-F] [source:CASE-MARS].

Three zones and two wings make a learning loop. Zhongzhiyuan provides full-stack testing and governance interfaces; AI Origin translates university research into open, legible outcomes; Dazhongsi hosts limited market trials of agents, devices and content; the Zhongguancun technology-services wing supports intellectual property, finance, law and international exchange; and the Xiaoyue River wing hosts public experience and low-risk scenarios. Every transfer returns evidence, complaints, energy use and exit records.

## Overall Design Area: Urban Renewal and Regulatory-Plan-Level Urban Design

The structure is one spine, three margin yards, five margins, twelve scenario nodes and eight renewal packages. The public buffer spine carries continuous green space, slow mobility and public frontage; the yards occupy the provisional key areas; transverse walking and cycling links provide route margin; adaptable ground floors, courtyards and trial plots provide space margin; operating windows and reversible installations provide time margin. This is a calibration model, not a survey of existing roads, buildings or heritage limits [data:geometry/roads.geojson#ROAD-001] [depth:blue_green_public_space].

Land-use cells are generated in projected coordinates from shared cut lines, so they cover the submission boundary without overlaps or gaps. Research, education, housing, community service, commerce, culture, green space and plazas form small mixed units for a borrow-evaluate-fix sequence. Conceptual building footprints express possible carriers for renewal but do not decide which buildings to retain, renovate or demolish. FAR, height, density and setbacks remain unknown until regulatory plans, surveys and ownership data are supplied [standard:MNR-LAND-USE-CLASSIFICATION-GUIDE] [depth:development_intensity_controls].

Mobility repairs transverse access and preserves alternatives. The spine carries continuous walking and cycling; four cross-links serve northern innovation, campus translation, central public life and southern interchange. Static signs and routes without smart devices remain available. Road redlines, junction engineering, structures, parking, fire access and utilities are unknown; the layer is a conceptual centreline and public-interface model only [standard:MOHURD-CONTROL-DETAILED-PLANNING] [depth:traffic_rail_slow_parking].
...
![Three key areas: technology, translation and market margin yards](assets/figures/key-areas.en.png)

## AI Innovation Ecosystem, Personas, and AI+ Scenarios

Six personas are service-design hypotheses, not a profiling database: open-source developers need trusted collaboration; startups need affordable trials and compliance support; corporate researchers and visitors need demonstration and recruitment; students and faculty need translation and inter-campus links; neighbours need low-disturbance services they may refuse; and children, older people and disabled users need accessibility, visible human help and a no-AI equivalent. Operational data must be minimised, de-identified and purpose-bound [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] [metric:persona_count].
...
S01–S03 are industry testing scenarios and may operate only after isolation, insurance, human takeover and professional approval. S04–S12 are public-service and experience concepts, not claims of technical maturity or permission. Nodes are recorded as independent Point features and counted in metrics [data:geometry/constraints.geojson#SCENARIO-01] [metric:testing_validation_scenario_count].

## Land Use, Building Scale, and Retain-Renovate-Demolish Strategy

The complete model treats space margin as the ability to convert between mixed cells, not as a new statutory land class. Research, education and commercial cells support the three yards; housing and community-service cells support daily life; green and plaza cells form the public buffer. Every cell still uses a subset of the national land-use classification. It tests relationships and continuity, not approved parcel use [data:geometry/land_use.geojson#LU-001] [metric:land_use_feature_count].
...
![Slow mobility, blue-green network and no-AI fallback routes](assets/figures/mobility-bluegreen.en.png)

## Blue-Green Network, Public Space, and Urban Character

The buffer spine is everyday blue-green public space, not a technology showroom. A continuous green belt, six public margin courts and four cross-links support walking, cycling, rest, exercise, quiet use and small trials. Events require capacity, noise, lighting and exit rules; a quiet path always remains. Green and public-space ratios come from geometry unions and are conceptual design metrics, not statutory green-space ratios [data:geometry/green_space.geojson#GREEN-001] [metric:green_ratio].
...
The cultural narrative joins the railway's operational need for passing, maintenance and scheduling slack to Zhongguancun's tradition of iteration and the AI era's duty to explain and correct. Wayfinding uses mileage, brackets and margin gauges; it avoids portraits, corporate marks and uncleared imagery. Historical claims rely on official or rights-cleared material, and generated content is labelled.

## Renewal Projects, Implementation Policy, and Phasing

Eight packages are minimum actionable units: P01 buffer-spine continuity audit; P02 Zhongzhiyuan technology court; P03 AI Origin open-source translation street; P04 Dazhongsi market trial hall; P05 four transverse fallback routes; P06 four public landmarks; P07 no-AI equivalent component library; and P08 the Margin Ledger and annual programme. Each starts with evidence checks and public discussion, then a low-cost pilot, independent evaluation and an explicit decision whether to remove or retain it [data:geometry/phasing.geojson#PHASE-001] [metric:renewal_project_count].
...
![Core metrics, evidence chain and pending inputs](assets/figures/metrics-evidence.en.png)

The compliance matrix maps official clauses 1.3, 1.4 and 1.5 plus agent.1–agent.6. The standards matrix distinguishes standards addressed from missing official building-depth documents. The depth matrix ties context, scope, structure, land use, intensity, character, retain-renovate-demolish, mobility, utilities, blue-green space, key areas, projects, phasing, recalculation and risk to prose, geometry, metrics, figures, sources, assumptions and checks.

## Risk, Copyright, and Compliance

The leading risks are misreading provisional lines, extracting conceptual figures as controls, allowing pilots to lose their exit, crowding everyday public space and leaving human takeover only in prose. Controls are visible provisional labels, unknown statutory metrics, a no-AI equivalent and human takeover for every scenario, everyday-first public space, and full-package recalculation when official polygons arrive [source:ISSUE-846] [depth:risk_missing_data].
