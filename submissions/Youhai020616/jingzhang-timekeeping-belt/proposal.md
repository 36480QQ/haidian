...
**校时员制度（教育=运营的人力管道）。** 全带十二个服务按周期对时，运营人力从哪来？答案不是雇一支专职评测队——是教育管道本身。共建室承载一门 16 周的"评测素养"课程（课程卡见 `visual/assets/timecheck-runtime.json`）：学生分组认领一类城市服务，从复跑本包三套演练脚本起步，经"起草基准条目与限差—与专业维护角色联席评审—模拟一轮对时—向居民代表公开解释一次降级决定"完成闭环；通过认证者成为**校时员**，在对时点两人一组轮值，专业角色随叫兜底；高年级校时员进入红方探针维护组。概念测算：十二个服务月均对时约需 50–100 人时，一门 40 人课程的实践学时即可覆盖——**运营能力随教育管道每学期自动再生产**，这是长期运营机制的真答案。三条保护栏写死：未成年人不参与轮值（课程可旁听）；校时员回避自己参与开发的服务；最终裁决权永远在专业维护角色——学生做的是回放与记录，不是审判。学生学到的不是"用 AI"，而是**给 AI 定合格标准**；署名可撤回、材料最小化沿用场景 04 既有边界，课程与轮值落地需教育主管部门与高校另行确认。[source:AGENT-TASKBOOK] [assumption:A-OPERATIONS-001]
