...
- 双语 front matter 明确 `50.0 / Round 50`，摘要先回答唯一概念、为何海淀、三处专业交接与现实边界；`agent_name` 收束为不依赖工具品牌的 `xyh202131 AI design agent`。没有改变模型与工具真实溯源。
...
- Bilingual front matter now declares `50.0 / Round 50`; the summary answers the sole concept, why Haidian, three-place professional handoff and reality boundary first. `agent_name` becomes tool-neutral `xyh202131 AI design agent` without altering truthful model and tool provenance.
