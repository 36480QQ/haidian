...
Version 2.0 is a substantive replacement of the merged v1 “Time Commons.” At upstream commit `5181eee`, we audited 255 public proposals. Public-time, latent-capacity, climate-commons, and complete-life concepts already had close peers. Rent, affordability, and gentrification appeared in several proposals, but rarely formed a complete spatial, data, and operating system. This version therefore moves anti-displacement from a risk note into the design structure. [source:PEER-AUDIT]
