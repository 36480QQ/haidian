...
**三区两翼空间布局**是百年京张AI创新带的核心空间骨架。根据2026年中关村论坛年会正式发布的规划，创新带以全线长约9公里的京张铁路遗址公园为”创新链路”，形成南北东西中总面积约37平方公里的”三区两翼”格局：北部学北园AI自主创新加速区（以中关村东升科技园学北园为锚点，聚焦AI全栈自主创新，从芯片到应用的底层攻关）、中部AI原点社区（立足五道口核心区，环绕清华大学、北京大学、中国科学院，打造高校一公里”近校创新生态圈”）、南部大钟寺AI产业集聚区（面向领军企业、智能体、智能终端和内容消费，形成产业集聚）；西侧中关村科技服务翼（联动中关村大街沿线科技服务资源，提供知识产权、投融资、法律等专业服务）、东侧小月河场景赋能翼（以小月河生态廊道为纽带，布局AI+交通、AI+医疗、AI+教育等场景测试和应用示范）。[source:OFFICIAL-ANNOUNCEMENT]

**三区两翼的协同回路**体现在三个方面。第一，南北纵轴串联三区：从北部的自主创新加速（底层技术攻关），经中部的近校孵化转化（人才和成果策源），到南部的产业集聚放大（市场化和国际化），形成”技术研发→成果转化→产业放大”的完整创新链空间落位。第二，东西两翼横向赋能：西翼提供科技服务支撑（中关村大街的资本、法律、知识产权服务），东翼提供场景应用验证（小月河沿线的AI+场景测试），两翼与三区形成”核心功能区+专业服务环”的互补关系。第三，京张铁路遗址公园作为创新链路核心廊道，在南北方向上串联三区的同时，在东西方向上通过慢行绿道连接两翼，实现”一带串三区、两翼联东西”的整体空间结构。本方案的三处重点区域与三区一一对应，两翼的空间策略在总体设计范围的交通、市政和公共服务设施规划中体现。[source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
...
| 老年人与残障人士 | 无障碍通行、语音交互、大字标识、离线替代 | 慢行系统无障碍通道、语音导览、触觉导向标识、人工服务窗口 | 符合 GB 50763 无障碍设计规范；不采集健康数据 |
...
方案还应覆盖弱势群体、老年人、儿童、残障人士、低收入劳动者和非数字用户的独立需求分析。无障碍设计应遵循国家标准 GB 50763-2012《无障碍设计规范》，涵盖缘石坡道、盲道、无障碍出入口、轮椅坡道、无障碍电梯、扶手、低位服务设施、无障碍标识系统及信息无障碍等要求。京张遗址公园慢行系统应设置连续的盲道和轮椅通道，公共空间节点的导视系统应包含盲文标识和语音导览，AI场景的交互终端应提供大字模式、语音输入和人工替代通道。数字包容方面，AI公共服务场景应保留离线办理和人工窗口，避免"必须使用数字终端"的排他性设计，确保非数字用户也能获得同等服务。公平性审计应纳入年度运营报告，审计内容包括各类用户群体的服务覆盖率和满意度差异。[standard:MOHURD-URBAN-DESIGN-MEASURES]
...
| 项目编号 | 项目名称 | 类型 | 牵头/协同主体 | 前置数据 | 审批接口 | 阶段 | KPI | 维护责任 | 风险/退出条件 | 证据引用 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| JZ-01 | 京张遗址公园慢行断点缝合 | 公共空间/交通 | 海淀区园林绿化局、街道办牵头；交通委协同 | 道路红线、桥下空间、交通组织复核 | 城市更新审批、道路占用许可 | 近期试点 | 慢行连通率、无障碍达标率 | 街道办+运营方 | 交通组织未批则暂停 | [data:geometry/roads.geojson#ROAD-001] |
| JZ-02 | 众智园清河创新界面 | 蓝绿空间/产业展示 | 众智园运营管理机构、水务部门牵头 | 河道蓝线、生态和防洪条件 | 水务、防洪、生态审批 | 中期更新 | 蓝绿空间开敞率、雨洪调蓄量 | 园区运营方+水务 | 防洪条件未明则降级 | [data:geometry/green_space.geojson#GREEN-001] |
| JZ-03 | 原点社区近校成果转化街 | 城市更新/产业服务 | 街道办、高校后勤、产业运营方牵头 | 校区边界、权属、首层业态 | 城市更新、规划许可 | 近期试点 | 转化项目数、首层利用率 | 产业运营方 | 权属未清则部分启动 | [data:geometry/buildings.geojson#BLDG-001] |
| JZ-04 | 大钟寺站四象限步行连通 | 轨道一体化/慢行 | 轨道集团、交通委牵头；街区运营方协同 | 轨道站点、道路交叉口、市政管线 | 轨道一体化、市政审批 | 中期更新 | 换乘效率、四象限连通率 | 轨道集团+街区运营方 | 管线迁改复杂则分期 | [data:geometry/public_space.geojson#PUBLIC-001] |
| JZ-05 | AI公共服务与端侧算力节点 | 新基建/公共服务 | 区科信局、算力运营方牵头 | 能源、算力、安全和运营主体 | 新基建、能源、安全审批 | 近期试点 | 日服务人次、端侧算力利用率 | 算力运营方 | 安全未达标则停用 | [data:geometry/constraints.geojson#CONSTRAINTS] |
| JZ-06 | 全球AI活动周公共路线 | 运营/品牌 | 活动主办方、运营方牵头；公安、文旅协同 | 公共空间许可、活动安全、版权清权 | 大型活动安保、公共空间许可 | 长期治理 | 活动参与人次、国际传播量 | 活动运营方 | 安全或版权风险则取消 | [data:geometry/phasing.geojson#PHASE-001] |
