...
| **林下办公** | 公园内设专用共用工位区：多工位、玻璃隔断、谁来谁坐；另有建筑首层林冠遮蔽 | 不设私人专属舱；不装 LED 外立面；不做网红打卡舱 |
| **锈** | 轨条和钢构件保持自然氧化，作为时间标记 | 不用 Cor-Ten 仿锈面板；不人工做旧后喷透明漆 |

**大钟寺站一体化**：从地铁站 A/B/C/D 四个出口各引一条轨径进入片区四个象限。出站即入公园——锈轨引导进入京张叙事下的公园廊道，不是楼旁绿化带。

**商业服务**：沿轨径分布，不集中做商业综合体。智能体和智能终端企业的展厅在首层，面向轨径开放，不需要单独入口。数据要素和数字资产服务以合规、授权、可审计为前提运营。

**公园复合利用**：轨径落在公园里——修剪草坪、疏林、软铺慢行；林下共用工位是公园里的专用区，不是写字楼大厅搬家。
