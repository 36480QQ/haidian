---
title: "Jingzhang New Track: AI Open Creation City"
...
summary: "A rail-heritage-led AI innovation district that links three key areas through open-source scenarios, public space, and long-term civic operation."
...
![Overview of the provisional corridor, heritage spine, three key areas, and two coordinating wings](assets/figures/site-overview.en.png)
...
![Positioning, spatial moves, and scenario nodes for the three key areas](assets/figures/key-areas.en.png)
...
![Composite mobility, rail access, blue-green infrastructure, and public-service network](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, compliance coverage, and audit evidence chain](assets/figures/metrics-evidence.en.png)
