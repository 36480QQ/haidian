---
title: "Jing-Zhang Epoch Rail: Centennial Jing-Zhang AI Innovation Belt Urban Design Concept (v2 Heritage-Derived)"
author_github: "dragan2023"
language: "en"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "An AI-native urban design concept rebuilt on the Jing-Zhang railway 'ren'-line: one heritage rail with three epoch stations, two turnout wings, and five block sections, supported by brand assets, an ecosystem map, a scenario matrix and an annual operation system."
...
![Overall concept: ren-line, epoch stations, turnout wings and block sections](assets/figures/site-overview.png)
...
![Three epoch stations: positioning, spatial moves and local design](assets/figures/key-areas.png)
...
![AI scenario - space - data - model - operation - review - KPI matrix](assets/figures/scenario-matrix.png)
...
![Landmarks, honor system and component library](assets/figures/landmark-honor.png)
