...
summary: "A railway-heritage civic spine supporting a one-belt, three-core, two-wing AI innovation ecosystem, ten testable urban AI scenarios, three AI pilgrimage landmarks, and a long-term operations model; all spatial areas retain provisional precision warnings."
...
![Land-use, building, and renewal structure](assets/figures/land-use-structure.en.png)
...
![Three key-area detailed-design evidence maps](assets/figures/key-areas.en.png)
...
![Mobility, slow network, blue-green and public-service structure](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, source, formula and provisional-confidence audit](assets/figures/metrics-evidence.en.png)
...
Both visual HTML files remain offline with no CDN, remote fonts, map tiles, external script/API calls, iframe, or forms. `tools/render_professional_assets.py` reads only local GeoJSON/metrics and verifies CJK glyph coverage; it aborts rather than silently generating tofu squares. Regenerated PNG/PDF outputs require manual page-by-page checks for glyphs, cropping, legend, boundaries, nodes/corridors, and provisional warnings.
