...
The A3 booklet has also been recut for standalone review. Each of its sixteen pages answers one question, carries one judgement, and provides both direct evidence and a boundary. Thirteen author-performed semantic checks compare the Chinese and English narrative, first screen, five core figures, A3 booklet, and A0 boards. The audit records that these pairs were checked; it does not replace independent translation review or public-comprehension testing.[source:V17-JUROR-PATH] [source:V17-BILINGUAL-AUDIT] [metric:bilingual_audited_pair_count]
...
An author-performed bilingual equivalence ledger records the semantic comparison. Thirteen pairs cover critical narrative sections, the offline first screen, five core figures, the sixteen-page A3 booklet, and the three A0 boards. The review compares claims, numbers, units, titles, legends, evidence boundaries, and figure positions. All thirteen authored pairs are aligned. Independent human translation review remains incomplete, so 13/13 cannot replace a translator or a target reader.[source:V17-BILINGUAL-AUDIT] [metric:bilingual_audited_pair_count]
