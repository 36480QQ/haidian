...
### Four-Gate Through-Line: 10 Scenario Card Release Status

The Jing-Zhang Four Gates constrain not only physical projects (JZ-01 through JZ-06) but also the launch rhythm of each AI scenario card. The following is the current gate-status self-assessment for all 10 scenario cards [depth:phasing_implementation]:

| Scenario card | G0 Readiness | G1 Pilot | G2 Release | G3 Retirement | Current status |
| --- | --- | --- | --- | --- | --- |
| 01 Open-Source Hall | ✓ Space + operator clear | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G1 |
| 02 Safety Sandbox | ✓ Standards consortium pending | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G0 |
| 03 Edge Compute | ✓ Operator pending competition | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G0 |
| 04 AI Walkability | ✓ Public space operator clear | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G1 |
| 05 Roadshow Lounge | ✓ Platform pending tender | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G0 |
| 06 Qinghe Low-Carbon | ✓ Zhongzhi operator clear | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G1 |
| 07 Tech Transfer Street | ✓ University partnership pending | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G0 |
| 08 Data Parlor | ✓ Third-party body pending | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G0 |
| 09 Life Service Street | ✓ Community joint ops clear | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G1 |
| 10 Global AI Week | ✓ Event committee clear | Pending pilot report | Not reached | Plan ready | `halted` → awaiting G1 |

**Reading rules**: G0 Readiness confirms operator and spatial carrier; G1 Pilot requires 90-day lightweight trial producing pilot report; G2 Release is the Go/No-Go decision point; G3 Retirement requires exit trail. All scenario cards are currently `halted` — structural completeness ≠ field pass. Performance claims without field evidence are uniformly left blank. (Assumption A-GATE-001)

**Three key areas' four-gate status**:
- Zhongzhi Park: G0 partially passed (space clear, operator pending), enters G1 to launch safety sandbox and Qinghe corridor pilots
- Origin Community: G0 partially passed (space clear, university partnership pending), enters G1 to launch open-source hall and tech transfer pilots
- Dazhongsi: G0 partially passed (space clear, operator pending tender), enters G1 to launch roadshow lounge and data parlor pilots

> Four-gate through-line means AI scenarios are not "build and deploy" — they must pass through G0→G1→G2. Any scenario card that has not passed G2 runs only as temporary facilities, operational activities, or service platforms, not as formal public deployment.
