...
summary: "以京张遗址公园为城市本象线，把众智园验证、AI 原点社区公共解释、大钟寺日常采用组织成可追溯、可签署、可撤回的城市变更链；任何高影响提议，无论来自 AI 还是人，都必须以可核对事实为前提，并由依法有权且受影响的人共同签署。"
...
**THE GROUND-TRUTH CITY** 不是再造一套“城市大脑”，而是为公众、专业团队与智能体建立共同的城市变更规则：任何改变公共空间、公共服务、他人权利或共享资源的高影响提议——无论来自 AI 还是人——都必须以可核对的事实为前提、以可撤回的方式落地，并由依法有权且受影响的人在同一公开门槛前共同签署。普通生活不生成工单，沿线保留无需 AI、无需登录和不被感知的日常空间。京张铁路曾用统一轨距、工程记录和现场验收把设计变成可运行的交通系统；百年后的“本象线”把这种工程纪律转译为城市状态的公共基础设施。

方案由 2Origin / 本象协议体系提供方法，但不要求城市采用单一厂商平台。“本象”以稳定 ID 保存对象唯一的规范记录；这份真源同时容纳证据、异议和可更新的当前裁定，不等于垄断事实解释。“引用优先”使各方持有带版本和新鲜度校验的引用，而不复制另一份真值；投影把同一对象生成居民端、规划端、施工端与 Agent 端可重建的影子；“影核”把同一语义动作路由到多个执行器，并处理前置条件、失败回退与撤销；“叠象 / Redline”公开变更前后差异、证据与验证结果；“影域”提供隔离试错空间；“本境”保存 detector、rule、adapter 和版本组成的环境指纹，回答同一事务为何能否被复现。依法有权的机构、专业人员与受影响群体被表示为稳定对象，权限是状态和约束，签署是事务证据，因此不向五概念核心新增“权威主体”。AI2Work 在本方案中是城市任务评测扩展，不冒充本象核心协议；提交编译器负责解析语义事务、检查约束、更新状态、留证并重新投影。
