...
原创主张不是再建一条“智能设施走廊”，而是建立一套**可逆公共服务回路**：AI 必须在普通服务基线已经能独立完成任务之后才进入，并且每个场景都有明确边界、人工接力、停止、申诉、撤回和恢复。它由三项相互咬合的机制构成：第一，纸质、人工、离线平台与可选 AI 的**普通基线机制**，避免把账户、扫码或模型变成公共服务门槛；第二，OPEN、PILOT、PAUSE、RESTORE 的**四态运行机制**，把空间组件、数据权限和现场责任放入同一状态体系；第三，“问题—证据—复用—交接”的**证据交换机制**，让社区、企业、高校、专业团队和区域节点共享失败与修正，而不是复制未经验证的技术模式。三核不是同质园区：众智园验证隔离与恢复，原点社区验证普通人的可达性，大钟寺验证产业展示能否成为可审计、可撤回的公共接口。这样，“回路”既是品牌命名、空间网络和视觉符号，也是可被审查的治理模式与规划创新。[metric:dazhongsi_operating_state_count]
...
概念角色是开源发布、居民反馈和跨代协作的“公共客厅”。鉴于原点社区已有覆盖 17 项高频事项、数字问答和人工帮办的人才服务流动站，本方案不另造重复窗口，而在其周边组织纸质导视、无账户入口、安静等候、人工柜台、复杂事项转介、社区工作坊与可撤回试用点。服务顺序是先让纸质说明和人工办理独立完成任务，再比较可解释 AI 导览是否真正减少理解负担；任何群体被阻挡、替代路径不可用、信息采集超出声明或申诉无法处理时，立即停止 AI 分流并恢复人工路径。居民可以拒绝 AI，不以个人行为轨迹做商业推荐。[source:AI-ORIGIN-TALENT-SERVICE-2026] [data:geometry/key_areas.geojson#PROV-KEY-002] [depth:three_key_area_detailed_design]

### 5.3 大钟寺 AI 产业集聚区：把产业展示变成公共接口

概念角色是产业服务、数据治理展示和国际交流的“公共接口”。空间上以站点到首层的连续步行、人工权利核对台、可审计案例展廊、企业服务前台和人才会客厅形成开放界面；没有 AI 时，访客仍能靠标识、人工讲解和纸质权利说明完成参观与咨询。AI 只用清权的合成数据演示授权、撤回和审计链；企业案例、商标、产品、数据和国际合作逐项清权，任何一项无法撤回、来源不明或审计记录断裂即撤下展项并转人工说明，不写成已入驻企业或招商结果。[data:geometry/key_areas.geojson#PROV-KEY-003] [depth:three_key_area_detailed_design]

#### 5.3.1 旗舰样板：大钟寺可逆公共接口

本轮把“大钟寺可逆公共接口 / Dazhongsi Reversible Civic Interface”作为全带设计深度样板，而不是把三处重点区平均铺开。四个尺度分别回答：**1:5000** 看它如何接入三核、公共脊与轨道；**1:2000** 看普通路线、首层界面与后勤分流；**1:500** 看人工权利台、可逆试点舱、证据与申诉带、安静等候、停止点和撤展路线的组件组合；**1:200** 看普通通行、AI 边界、人工接管、供电断开和整套撤除的典型断面。比例尺只表达概念审阅层级，图中不包含官方站口、道路红线、产权界或工程尺寸。[data:spatial.json#dazhongsi-ordinary-route]

![大钟寺四尺度空间样板](assets/figures/dazhongsi-four-scales.png)

空间组件用 11 个稳定编号登记，运行则由四态合同控制：**OPEN** 只运行纸质、人工和离线说明；**PILOT** 只在清权、隔离、值守、可停机的试点舱中增加 AI；**PAUSE** 在任一停止条件触发后封存日志、转人工并处理申诉；**RESTORE** 删除演示数据、撤除设备、恢复为空场地。四个状态下普通公共路线都保持开放，试点不得占用通勤和无障碍通行。[metric:dazhongsi_operating_state_count]

![大钟寺典型断面与四态运行](assets/figures/dazhongsi-section-states.png)

这套样板不是现场落点结论。正式边界、站点接口、产权、消防、无障碍、临时用电、活动运营、数据和版权七项依赖全部标为 pending；未取得书面确认时，现场工作最多停留在纸质导视、人工咨询和桌面演练。`spatial.json` 记录概念空间对象，`visual/assets/dazhongsi-operations.json` 记录尺度、组件、状态、RACI、许可、采样和交接；两者共同避免图纸与运营脱节。[metric:dazhongsi_permit_dependency_count]
...
| --- | --- | --- | --- | --- | --- |
| **T1 公共服务可达性 / AI 原点社区** | 纸质导视、人工柜台、无账户入口可独立完成事项 | 可解释导览和事项分流；只记录去标识化的任务级汇总，不留个体轨迹 | 无障碍代表与服务人员完成冷读；隐私、申诉、人工转介均可用 | 任一群体不能完成、替代路径失效或采集越界即停；人工柜台接管，删除会话并公开汇总复盘 | 三条路径的完成率、理解障碍与修正清单；不是服务绩效承诺 |
...
运营责任采用 RACI 而非模糊的“多方协同”：公共服务运营方负责普通路线、现场接待和申诉；空间资产方对场地开放与年度去留负责；AI 试点运营方只负责隔离试点单元；现场安全负责人拥有立即停止权；数据权利负责人对清权、撤回和删除验证负责；无障碍代表、使用者及交通、消防、隐私等专业人员进入咨询和阶段审查。这里的角色都是待指定责任位，不声称任何现有机构已经承诺。[metric:dazhongsi_raci_workstream_count]

测量协议先比较纸质自助、人工服务、可选 AI 辅助三条路径；建议每种路径至少取得 30 个完成试次，并按高峰/非高峰、日间/晚间、无智能手机、行动或视觉需求、中英文分层。30 是试点建议阈值，不是已完成样本或官方标准；分母包含所有进入试次，包括未完成、中止、转人工和投诉，技术失败不得删除。记录任务完成、理解核对、人工接管时延、撤回完成、公共路线中断和申诉结案；普通路线受阻、强制账户/扫码、未告知采集、撤回失败或安全事件未结案均直接触发 PAUSE，不等待样本凑满。[metric:dazhongsi_measurement_modes]
...
![从许可到交接的实施路线](assets/figures/implementation-roadmap.png)

交接包分为四类：规划设计团队接收四尺度图册、组件注册表和待补官方图层；公共服务运营方接收四态手册、RACI、事故与申诉登记；数据与权利团队接收内容清单、撤回测试和删除验证；传播团队接收双语标识、状态语言和国际简报。任何接收方未明确时，相应工作包不得从 P1 升级到 P2。
