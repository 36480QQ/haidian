---
title: "京张公共门廊 v0.3：让创新带成为可进入、可理解、可共同维护的城市公共客厅"
...
v0.3 保留“一脊、三廊、六门、十二场景”的空间骨架，但把重点从‘展示完整’转向‘实施可证’：AI 原点增加一个尚未获批、尚未现场运行的90天门廊回执试验；五个区域节点用输入、最低输出、责任类型和退出闸门连接；十二个工程包逐一记录成本档、依赖、验收和停止条件；日、月、季、年运营台账决定场景继续、修改或退役。全部空间动作均为概念建议，可供专业团队深化研究，不替代正式规划、机构授权或政府审定。
...
2. **背景层**：v0.3 从 OpenStreetMap 公共数据提取道路、轨道、水系、绿地、公共设施和重点区建筑轮廓，用于理解城市关系和提高图纸可读性；其完整性和精度不等同官方测绘。[source:OSM-CONTEXT-20260810]
...
v0.3 不再只以国际案例说明愿景，而把北京与海淀的公开政策转译成可检查的设计约束：海淀“十五五”规划将百年京张 AI 创新带、南北 AI 双核、可感可及的标杆场景、开源生态和安全可控写入区域行动框架，因此方案以“问题—验证—采用—公共回报”而非单纯招商组织三廊；海淀创新应用场景指南要求场景方、明确需求、技术指标、空间设施、伦理安全和可复制成果，因此旗舰试验先锁责任和退出，再谈技术运行。[source:HAIDIAN-15TH-FIVE-YEAR-PLAN-2026] [source:HAIDIAN-INNOVATION-SCENARIO-GUIDE-2025]
...
v0.3 不把十二个场景同时做深，而选择 AI 原点“公共学习请求”建立一个最小可复演试验。公众提出问题后，系统只使用五个合成案例演练来源检索、人工解释和证据回执；始终保留纸质问题卡、打印来源单、现场人工解释和申诉窗口。该试验状态为 **tabletop only / not authorized / not run**：它证明G0—G6决策顺序、四个停止分支和五步回滚结构可以复演，不证明现场安全、模型性能、公众接受、场地许可或政府认可。[depth:veranda_receipt_pilot]
