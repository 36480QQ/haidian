...
建筑方案表达 101 栋建筑基底，总基底面积 76,972.95 m² [metric:building_footprint_area_sqm]。建筑功能以科研（28 栋）、商业办公（24 栋）和住宅（11 栋）为主，辅以文化、教育、医疗和交通枢纽功能 [data:geometry/buildings.geojson]。建筑层数的设置遵循以下原则：沿京张绿廊的建筑高度不超过 24 m（约 6—8 层），以保持遗产走廊的视觉开敞；重点区核心地块可适度提高至 60—80 m（15—22 层）；交通枢纽和文化设施控制在 3 层以内 [depth:height_massing_character]。以上均为概念建议/参考方案，非审定控规条件 [assumption:A-DESIGN-001]。
...
交通方案围绕"一轴两环多联"组织 [depth:traffic_rail_slow_parking]。"一轴"即京张智脉主轴（arterial 级，6 车道），从南（39.939）到北（40.0265）贯穿整个设计范围，是机动车交通的南北主通道 [data:geometry/roads.geojson#RD-0001]。"两环"即东侧科技大道（secondary 级）和西侧创新街（secondary 级），分担主轴压力，同时服务东西两侧地块 [data:geometry/roads.geojson#RD-0002/0003]。"多联"即 9 条东西向连接线，包括北五环连接线、清华东路西延、知春路西段、大钟寺连接线和西直门外大街 5 条 arterial 级道路，以及清河生态横街、中关村科技横街、小月河场景横街和学院南路西段 4 条 secondary 级道路 [data:geometry/roads.geojson#RD-0004—0012]。
...
轨道交通依托现状地铁 13 号线（五道口站、大钟寺站）和规划线路。大钟寺站一体化是本方案交通设计的重点——以交通枢纽建筑（50 m × 35 m 基底）整合地铁、公交、骑行和步行换乘，并通过枢纽广场组织四象限的地下和地面连通。五道口站和清华东路西口站服务于 AI 原点社区，通过清华东路西延和东侧科技大道实现站城一体 [assumption:A-INFRA-001]。
...
公共服务设施按 15 分钟生活圈配置：每个重点区设置一处社区服务中心（含医疗、文化、体育功能），学院南路生活配套区设置教育和医疗设施，沿京张绿廊设置公共卫生间、饮水点和 AI 信息导览终端。具体设施标准和选址需在控规确认后确定 [assumption:A-DESIGN-001]。

![交通慢行与蓝绿公共空间复合系统图](assets/figures/mobility-bluegreen.png)

## 蓝绿空间、公共空间与城市风貌

蓝绿空间方案以京张遗址公园活力带为骨架，形成"一带三园多点"的绿色基础设施网络 [depth:blue_green_public_space]。"一带"即京张文化绿廊，沿京张铁路遗址南北贯穿（约 116.344—116.347 经度带），总绿地面积约 3,621,689 m²，绿地率 29.57% [metric:green_ratio] [data:geometry/green_space.geojson]。"三园"即清河生态公园（北部，约 40.004—40.009 纬度带）、原点社区中心公园（中部，约 39.988—39.991）和小月河滨水绿地（南部，约 39.973—39.982）。"多点"包括 5 处社区公园和 2 处防护绿地 [data:geometry/green_space.geojson]。
...
城市风貌控制遵循"京张为脉、创新为魂、古今对话"的原则 [standard:MOHURD-URBAN-DESIGN-MEASURES]。沿京张文化绿廊的建筑高度控制在 24 m 以内，保持遗产走廊的视觉开敞和人行尺度；三处重点区的核心地块可适度提高至 60—80 m，塑造天际线节点；整体建筑色彩以海淀特有的灰白基调为底，以 AI 主题公共艺术和数字媒体界面为亮色点缀 [depth:height_massing_character]。风貌控制分为三个层级：强制控制（京张绿廊退线和高度）、引导控制（建筑色彩和材质）和建议控制（公共艺术和标识系统）。所有控制均为概念建议/参考方案，不得解释为审定控规条件 [assumption:A-DESIGN-001]。
...
更新项目清单识别 6 个重点项目，覆盖公共空间、交通、产业、新基建和运营五个维度 [depth:renewal_project_list]：

| 编号 | 项目名称 | 类型 | 阶段 | 主要依赖 |
| --- | --- | --- | --- | --- |
| JZ-01 | 京张文化绿廊慢行断点缝合 | 公共空间/交通 | Phase 1 | 桥下空间改造许可、道路红线 |
| JZ-02 | 众智园清河创新界面与生态公园 | 蓝绿空间/产业展示 | Phase 1—2 | 河道蓝线、防洪条件 |
| JZ-03 | 原点社区近校成果转化街区 | 城市更新/产业服务 | Phase 1 | 校区边界协商、首层业态更新 |
| JZ-04 | 大钟寺站四象限步行连通与枢纽一体化 | 轨道一体化/慢行 | Phase 1—2 | 轨道部门协调、地下空间权属 |
| JZ-05 | 五大分布式端侧算力服务节点 | 新基建/公共服务 | Phase 2 | 能源配套、安全认证、运营主体 |
| JZ-06 | 全球 AI 创新活动周公共路线与品牌体系 | 运营/品牌 | Phase 2—3 | 公共空间使用许可、活动安全、版权清权 |
