...
场景意象图：视点位于五道口段上空约 500 米朝南，远景地标（中国尊与国贸三期、中央电视塔、北京北站与西直门塔群、大钟寺、中关村塔群、西山）按真实坐标推算的方位与距离布置；地标形体与城市肌理为 AI 图像生成的概念意象，非测绘复原，生成方式与权利登记见 `report/copyright_statement.md`。
