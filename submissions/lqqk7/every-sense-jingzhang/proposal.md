...
万感京张是一条线性走廊的方案。京张铁路遗址公园自西直门向北至北五环，已建成并开放约 9 公里带状公共空间，本方案的主脊在继承的临时范围内沿现状街道组织，与快照测得的铁路廊道中位偏差 906 米 [source:JZRP-PHASE2-OPENING-20260806] [data:visual/assets/alignment-reference.json]。走廊上分布众智园、AI 原点社区与大钟寺三处重点区。方案在这条带上做四件事：一条通用可达底线沿公园南北贯通全带，任一感官通道单独可用即可走完；一条低刺激安静替代路径与之并行，供需回避噪声、人流与强光者使用；三处横向接口缝合长期被轨道与大院隔开的东西两侧；十个独立完成节点沿线布点，把服务承诺落成可识别、可停留、可测试、可退出的实体界面。中关村科技服务翼与小月河场景赋能翼分别向走廊供给专业服务与开放场景。三处重点区各有一句骨架判词：众智园双带并列、原点社区一街两院、大钟寺四向一厅。
...
**现状起点与主动勘误。** 两项与场地直接相关的公开事实在此如实登记。其一，据官方媒体报道，京张铁路遗址公共空间改造提升工程（二期）已于 2026 年 8 月 6 日建成并向公众开放，与一期衔接形成西直门至北五环全长约 9 公里的带状公共空间，直接服务沿线约 70 个社区、约 45 万居民 [source:JZRP-PHASE2-OPENING-20260806]——因此本方案的主脊不是一条待建走廊，而是**现状街道基底上的可达性补足与接口缝合**：在已经开放的公园沿线检验「AI 关闭后是否仍能独立完成」，正是本命题最自然的试验场。其二，仓库公开议题已登记两项临时几何的空间不确定性：其一为临时「大钟寺」重点区质心落在北京北站一带、距大钟寺站约 2.26 公里（issue #1029）；其二为临时「总体设计范围」多边形与 OSM 测绘的遗址公园已建段不相交、最近距离约 412.5 米（issue #846）。本方案对前者的处置是**已在自身提交几何中完成修正 [assumption:A-10]**——v6.4 版将该重点区连同其节点、接口与概念体量整体归位至真实大钟寺板块，修正过程与全量重算记录见 `changelog.md`；对后者，本方案「沿京张铁路遗址公园组织」的表述指向公告文本所述的遗址公园沿线，与继承自任务包的临时总体范围几何之间存在上述已登记偏差，主脊相对该廊道参考线的偏差本版已登记为读数，具体衔接待官方边界确认后整体重算 [assumption:A-11]。两项议题均已写入前提与风险登记。
...
六类画像用于组织需求与测试，不是诊断标签、商业分群或已经完成的用户研究 [metric:persona_count]。每类画像都对应空间动作、设计提出的服务等价目标和隐私边界；真实共同设计须由参与者自愿加入，获得合理便利，理解数据用途并随时退出 [assumption:A-CO-DESIGN-001]，共同设计席位是否覆盖必需角色由角色覆盖率衡量而非由人数衡量 [metric:co_design_role_coverage_ratio]。中国无障碍环境建设法支持平等参与与无障碍信息交流的方向，但不能替代具体产品、建筑或交通的专业符合性评价，也不把本方案的“等价服务”概念自动转化为具体法定义务 [source:ACCESSIBILITY-LAW-CN]。该法关于现场指导与人工办理的要求，严格限于其条文列举的医疗、社会保障、金融、生活缴费等公共服务事项；六类画像与合规矩阵按此边界组织，方案其余的人工兜底均标记为概念设计建议 [standard:BARRIER-FREE-ENVIRONMENT-LAW]。下表是任务约束维度表而不是人群分类表——第一列给出六组任务约束（信息获取通道、沟通方式、行动方式、认知与感官处理、语言与数字门槛、服务提供与维护），不用于识别、标注或统计任何人。表以这六个维度为骨架，逐维展开为十类单列行：十类是六个维度的细分展开而不是新增维度，`metrics.json` 登记的画像口径仍为六 [metric:persona_count]。细分的唯一目的是让每一行只装一组互不混合的任务约束，便于逐行绑定测试脚本与判据；行动方式与服务提供两维不再细分——前者的四种情形（轮椅、推车、临时受伤、老年步态）指向同一组物理条件即连续净宽、坡度与休息点，拆开不产生不同的设计动作，后者本身只有一类角色。年龄、身份与诊断不构成任何一行，因为它们不是任务约束：儿童、青少年与老年人的任务约束分别落在「认知与学习方式不同者」「无智能手机与低数字素养者」与「轮椅、推车、临时受伤与老年步态者」三行，不另设人群行。
...
首个 90 天只建立“零阶段证据包”，不承诺开工或开放运营 [assumption:A-IMPLEMENTATION-001]。第 0—30 天进入 **G0 资料与许可闸门**：核对官方范围、现场路线与服务清单，形成伦理、同意和数据处置协议，并把十六个场景改写成可复测任务脚本；R-01、R-02、R-05、R-06 任一责任或资料边界不清即暂停。第 31—60 天进入 **G1 可逆原型闸门** 与 **G2 封闭成对测试闸门**：制作可移除组件，在受控环境完成 AI 开启/关闭成对测试，交付问题日志、维护卡和匿名化测试证据；G2 收尾设 **AI 关闭日演练**——一个完整测试日全程保持关闭态运行，全部任务只经固定导视、触觉引导与人工通道尝试并完整记录，演练记录（含未完成任务及原因，不预设全部完成）作为 G3 复核的必交证据，把「AI ON = AI OFF」从主张钉成一项可执行、可复核的测试设计；R-03、R-04、R-07、R-08 的替代路径、运维和参与条件未闭合时不得升级，不得以内部演示替代参与者证据。第 61—90 天进入 **G3 独立复核闸门**：由未参与制作的专业人员与参与者代表复核，逐项检查 R-01—R-12 全部十二项风险条目的停止条件和恢复证据 [metric:risk_item_count]，结论按基准四选一：通过、有条件通过、退回整改，或关闭 AI 层保留服务；四道闸门缺一不可，未通过 G3 不进入开放空间 [depth:phasing_implementation] [metric:gate_count]。
...
**交接是一份双联单，不是一句口头移交。** 人工接管在运行层落为双联交接结构：交出方与接收方必须是不同角色并各自署名；交接单上的未决项不得在交接时清空，只能随单移交；接收方对每一单在「接收 / 拒收 / 暂缓」三项中选一并署名，拒收与暂缓必须写明理由并触发上一责任方继续在岗。该结构在本节点先行试运行；将其升格为服务等价基准判据的提议原按版本治理登记为 v0.4 之后的待议项，已由 v0.5 兑现——升格形态不是并入 `node_schema`，而是独立为第六组件「双联交接台账」，兑现经过见一版一号回执 CR-2026-08-18-009。**独立接管演练**按 SEB v0.4 L4a 就绪证据展开为六项可核对清单：无供应商在场完成开机与关机、执行一次完整双联交接、按维护卡处置一项标准故障、演示 AI 关闭态下的全部人工服务路径、签发一份退出回执、调取并解释最近一次演练记录——两名非原团队人员逐项完成并签收，培训签收单与服务等级承诺随演练记录同卷归档。
