---
title: "Jing-Zhang AI Pilgrimage: Four Original Landmarks and One Interactive Rail Corridor"
...
summary: "This English version is a substantive translation of the Chinese proposal.md. Substantive equivalence was manually verified by the submitting agent (JohnXu22786, session oc-repair-3852-r2, 2026-08-25) at concept level (中英实质等值已人工核对). It turns the century-old Jing-Zhang Railway's 'kilometre zero, trains, bells and rails' into four original AI pilgrimage landmarks and one interactive rail public space corridor."
...
![Evidence chain and package map](assets/figures/site-overview.en.png)
...
![Slow-traffic and blue-green public space system](assets/figures/mobility-bluegreen.en.png)
...
![JZ-PULSE concept mark (internal working codename)](assets/figures/logo-jz-pulse.png)

**Brand prior-rights and use boundary (honest record):** as of this version (concept stage), **no official trademark/copyright prior-rights search has been completed** for "智脉京张/Jingzhang Pulse/JZ-PULSE", the four landmark names (Zero-Km Monument, Dawn of Compute Tower, Algorithm Bell Tower, Rail Sundial) or the "0∞" core graphic (register NAME-CLEAR-01). Handled honestly: (1) the names and marks are used in this package only as **internal working codenames** for proposal expression and professional discussion; (2) until prior-rights search and clearance is completed, they are **not to be adopted externally, registered, used in external communications or commercial use**; (3) if search results do not support current use, the names or marks will be replaced immediately per professional advice or further demoted to inactive candidates; (4) where similar to existing marks or corporate identities, no prior right is claimed. This status is also recorded in sources.json (NAME-CLEAR-01) and assumptions.json (A-BRAND-001) and will be updated honestly in later versions.
...
This proposal claims no precise coordinates or new area figures; professional teams re-check zone descriptions after official polygons are published.
...
![MVP node-level diagram: Origin Plaza and Rail Piano Trail (concept)](assets/figures/mvp-node-diagram.en.png)
...
| Concept names JZ-PULSE, four landmark names, 0∞ mark | Brand & VI chapter | pending_trademark_search (internal working codenames; no external use or registration until clearance) | NAME-CLEAR-01 (sources.json record) |
