...
五类场景均为概念验证意向，不表述为已批准运营；数据底线统一为匿名聚合 + 人工复核，不进行个体识别式追踪，禁止过度监控。
...
公共空间与设施组件按**全龄友好**原则配置：为长者与银龄人群提供适老座椅与大字版说明，为儿童与亲子家庭提供可触摸的科普互动，残疾人等弱势群体全程无障碍可达；居民、游客、青年与从业者共用同一动线，包容性设计是绿能智环的默认属性而非附加项。
...
参与主体表服务于指标体系中的"零碳公约参与主体数"概念计数口径，不涉及编制、预算或法定程序。
...
面向任务书 agent.6 长期运营要求，以年度为节奏组织概念活动体系：零碳科普周（周）、绿电开放日（日）、碳积分兑换季（季）作为三个年度品牌活动，可视主题联动低碳生活节（节）与亲子节能月（月）等时段，围绕示范园、连廊与驿站构成可参与、可展示、可复算的年度公共界面。全部活动为概念设想与品牌意向，不构成已确定安排；排期、预算与场地使用待运营团队与社区议事后确定。
