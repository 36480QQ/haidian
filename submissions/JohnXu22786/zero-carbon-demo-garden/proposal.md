...
| 对标案例 | 公开渠道机制概述 | 本方案转译 | 来源登记（发布者/URL/许可） |
| --- | --- | --- | --- |
| 雄安新区绿色低碳公开实践 | 绿色建筑、绿电与近零碳园区方向 | 零碳示范园"实践集群+公开示范"组织方式 | sources.json CASE-XIONGAN |
| 深圳国际低碳城 | 低碳技术展示与产业集群结合 | 认证展示与社区化界面设计 | sources.json CASE-SHENZHEN-LOWCARBON |
| 哥本哈根碳中和目标 | 公开目标与定期披露机制 | 年度碳效公示机制 | sources.json CASE-COPENHAGEN |
| 弗莱堡沃邦社区 | 居民参与式低碳街区 | 零碳公约的社区共诺意向 | sources.json CASE-FREIBURG-VAUBAN |
| 杭州亚运村低碳实践 | 大型活动设施的低碳建设与赛后利用 | 驿站式社区服务与赛事遗产衔接 | sources.json CASE-HANGZHOU-GAMES |
| 新加坡榜鹅数字园区 | 园区级集中供冷与能源即服务 | 能源设施公共界面化的对照案例 | sources.json CASE-SINGAPORE-PUNGGOL |

六个案例仅按公开渠道信息概述机制，发布者、页面 URL、访问日期、许可与允许用途逐项登记于 sources.json，不构成对本场地空间、指标或成效的证据；全部细节以正式公开资料为准。
