---
title: "PAR-JZ: Public Participation and Continuous Collaboration Mechanism (Concept)"
...
![Overall design concept overview (provisional geometry)](assets/figures/site-overview.en.png)

![Conceptual land-use structure (single recompute caliber)](assets/figures/land-use-structure.en.png)
...
![Three-node concept index and design task diagram](assets/figures/key-areas.en.png)
...
![Slow mobility and blue-green network concept analysis](assets/figures/mobility-bluegreen.en.png)

![Brand identity concept (logo direction)](assets/figures/logo-parjz.png)
...
![Core metric evidence chain](assets/figures/metrics-evidence.en.png)
