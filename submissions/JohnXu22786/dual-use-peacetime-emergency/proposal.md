...
为使定位不止停留在口号，本包把五大功能落实为可交付物：**文化叙事**输出京张百年墙/双城叙事带的公开史料审核清单；**日常生活服务**输出三节点人工服务台、无障碍路线与预约轮换规则；**AI创新转化**输出 C01–C06 案例转译表、S01–S12 场景卡与 T01–T03 测试协议；**平急韧性保障**输出转换清单、物资台账、疏散桌面测试和手工预案；**区域协同治理**输出三区两翼问题—能力—节点—公示—联审回路、RACI 与季度证据摘要。上述为建议性工作包，不代表已有机构、资金或系统。
...
AI生态图谱（agent.2，概念级）：沿京张AI创新带组织**土地、空间、产业、资金、人才、算力、数据、场景**八类支撑机制，形成"高校研发—企业转化—社区应用—政府治理"闭环；六个全球 AI 生态/公共 AI 案例以 C01–C06 登记于 `sources.json`，并作为 `global_case_count=6` 的唯一计数来源。案例只提供机制转译，不主张合作、采购、资金、系统接入或本地成效；每例记录发布者、URL、时间、引用/许可边界、可核查页面事实、转译机制和不可照搬条件。图谱见 `assets/figures/ai-ecosystem.png`。
...
六个 AI 生态案例的逐条证据与许可边界见 `sources.json`；现阶段仅凭公开页面摘要和链接，不把页面上的机构、人数、计划或许可延伸为京张项目事实。
