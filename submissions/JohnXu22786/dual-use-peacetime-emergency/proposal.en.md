...
The concept ecosystem connects eight support conditions: land, space, industry, finance, talent, compute, data and test scenarios. Its proposed chain is university research -> enterprise transfer -> community service -> public governance. Six station/space precedents are kept as a separate reference group: Japanese disaster-prevention parks; Tokyo Metropolitan Area Outer Underground Discharge Channel; Singapore Civil Defence shelters; China's dual-use policy pilots; Beijing Pinggu dual-use practice exchange; and the Netherlands Room for the River programme. They are not global AI ecosystem cases. The six global AI/public-AI cases are C01-C06 in `sources.json`, each with publisher, URL, date status, rights boundary, verifiable fact, translation mechanism and non-copy condition. None implies local partnership, funding, procurement or deployment.
