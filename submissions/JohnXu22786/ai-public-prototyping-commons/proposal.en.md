...
| 2050 Conference | `SRC-GLOBAL-2050`: official site 2050.org, accessed 2026-08-29; page title needs verification | Recurring cross-disciplinary exchange | No event-effect or brand-license claim |
| BLOCK71 | `SRC-GLOBAL-BLOCK71`: original URL returned 404 in this check | Research question: university/startup support interface | Excluded from formal case evidence |
...
![Structure: learn—prototype—review—return (concept)](assets/figures/site-overview.en.png)
![Three nodes and spatial actions (concept)](assets/figures/key-areas.en.png)
