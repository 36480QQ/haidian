...
**英文名：PROTO·JZ Public Prototyping Commons**。本方案提出一条“学会—做出—小范围试用—复盘归档”的公共原型链：把 AI 学习、可逆设施、社区服务和产业测试组织成可被公众看见、可以人工叫停、能够撤回的空间网络。它不是创客园区招商方案，也不是已批准的建设方案；全部点位、数值和运营安排均为概念建议，待官方资料、现场踏勘和专业审查后复算或调整。[source:AGENT-TASKBOOK]
...
命名体系为：主名 PROTO·JZ；三类空间锚点为“原型学堂 Z1 / 可逆试验场 Z2 / 服务回路站 Z3”；运行状态为“学习 / 原型 / 影子试验 / 人工复核 / 公示 / 撤回”。Logo 概念以“开合的方框 + 京张轨枕节奏”表达可拆、可复用的原型模块，不使用任何既有企业或政府标识，定稿前需完成商标和在先权利核查。[source:PACKAGE-GEOMETRY]
...
PROTO·JZ 把产业、空间和公共利益放进同一条“问题—原型—证据—复用”链，而不是把 AI 作为装饰。八类要素的接口分别是：土地/空间提供可逆试验容器；产业提供需求与维护能力；资本仅作为待核验的潜在资源；人才由学生、工程师、居民、照护者和运营者共同组成；算力采用“资源条件待核验”的共享接口；数据只允许公开或经授权的匿名聚合；场景由三节点和测试走廊承载；知识以版本化档案向公众返回。任何具体企业、融资额、产值、算力规模和供应商均不做事实判断。
...
![PROTO·JZ 视觉标识方向（概念）](assets/figures/logo-protojz.png)
...
组织方官方 polygon、法定控制、权属、文保/绿蓝线、站点条件、现状无障碍、运营人力、样本框、预算和模型合规意见全部 `unknown/to_verify`。在这些资料到位前，PROTO·JZ 不给出精确地块、工程量、投资回报、审批结论或已建成/已运营表述。
