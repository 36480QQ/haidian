...
本方案按任务书三大定位（百年京张文化带、都市AI生活体验带、AI融合创新带）与五大功能（AI全栈自主创新体系、世界级AI创新生态、AI+场景赋能新范式、智能化AI活力城市、AI治理全球话语权）中的低空经济相关方向展开，作为「AI+场景赋能新范式」的功能载体之一，与感知、调度、测试等能力结合（概念映射）。
...
## AI 创新生态、人才画像与 AI+ 场景
方案构建"AI+低空"创新生态，联合园区企业与高校共建联合实验室、数据开放平台与测试验证基地，围绕低空巡检与遥感、无人机配送、通勤接驳、应急联动、试飞服务等低空经济工作主题开展场景共创（均为概念建议，不构成对具体企业或运营商的承诺）。六类用户画像：①低空产业工程师（高频巡检、试飞验证与数据调试）；②园区通勤者（通勤接驳与即时配送）；③企业管理者（运行监管与成本优化）；④应急管理者（应急投放与联动指挥）；⑤周边居民（噪声与安全关注、公共空间与年度活动共享）；⑥学生访客与亲子研学家庭（科普展廊、模拟驾驶与体验培训）。

AI+ 场景卡（要点式，概念建议）：
- 卡① 通勤接驳：落位上地环岛接驳站与智慧灯杆起降点；与地铁13号线、昌平线错峰衔接；应急时转为联动节点。
- 卡② 外卖快递配送：示范楼宇—站点—路径三级配送体系；柜机交接、静音航线（意向性概念表述）。
- 卡③ 观光导览：观景台与低空视角导览；实行预约制、分时开放。
- 卡④ 低空巡检与遥感：园区安防巡检与低空遥感航测（含设施体检、现状测绘辅助）；AI 图像识别仅用于匿名聚合分析，遥感成果不作个体识别用途。
- 卡⑤ 应急投放：应急物资投放、平急两用；与应急管理平台联动，每次任务执行前人工复核。
- 卡⑥ 午间咖啡配送：分时错峰，与地面外卖形成互补。
- 卡⑦ 智慧灯杆共享起降：灯杆起降点共享电力与通信，动态分配机位。
- 卡⑧ 空域数据可视化大屏：运控大屏呈现匿名聚合空域态势，支撑运行监管与成本优化。
- 卡⑨ 科普研学模拟驾驶：模拟驾驶舱与科普展廊；面向学生访客与亲子研学家庭预约开放。
- 卡⑩ 试飞服务：试飞体验培训与测试验证；持证合规运行，纳入常态化测试计划。

场景卡分为三组：日常通勤组（通勤接驳、外卖快递配送、观光导览）、园区服务组（低空巡检与遥感、应急投放、午间咖啡配送、智慧灯杆共享起降）、数据与科普组（空域数据可视化大屏、科普研学模拟驾驶、试飞服务）；并设三个测试验证场景：航线冲突避障、人机共存行人保护、恶劣天气返航备降，纳入常态化测试计划形成安全数据基线。场景节点共 10 处（概念），指标见 metrics.json 的 scenario_node_count。

AI 场景与空间运营映射表（概念建议；"人工复核点"均为方案自设的运行治理设计，非监管要求）：

| AI 场景 | 落位空间 | 运营机制 | 人工复核点 |
| --- | --- | --- | --- |
| 无人机配送（卡②⑥） | 中央配送枢纽、屋顶起降场、配送柜机 | 试点运营、分时错峰派单；"统一建设、多元运营" | 配送路线变更、柜机点位增设 |
| 低空巡检与遥感（卡④） | 园区巡检航线、运维中心 | 与园区物业共建、按计划巡检；成果匿名聚合 | 异常告警处置、遥感成果对外发布 |
| 通勤接驳（卡①） | 环岛接驳站、智慧灯杆起降点 | 预约接驳、班次公示 | 班次调整、应急联动触发 |
| 应急投放（卡⑤） | 应急物资库、运控大屏 | 平急两用预案、定期联动演练 | 每次应急任务执行前人工确认 |
| 科普研学与试飞服务（卡⑨⑩） | 遗址公园科普展廊、试飞体验场 | 预约制排期、开放日与体验周活动 | 培训排期与飞行安全确认 |
| 空域态势可视化（卡⑧） | 运控中心大屏 | 匿名聚合数据、按年度公示 | 对外发布数据人工复核 |

方案自设 AI 治理边界（概念承诺，以正式法律法规与监管要求为准）：所有 AI 场景仅处理匿名聚合数据；关键决策一律人工复核；禁止过度监控——不进行个体识别式追踪、不建立大规模行为画像。

> **证据锚点**：[metric:scenario_node_count]、[data:PACKAGE-GEOMETRY]。

| 场景卡 | 落位空间 | 运营机制 | 人工复核点 |
| --- | --- | --- | --- |
| 低空巡检AI | 轨道沿线与园区巡检走廊 | 分时飞行许可与任务单审核 | 巡检结论人工复核后归档 |
| 无人机配送AI | 社区配送接驳点位 | 预约配送与时段管控 | 异常配送人工介入 |
| 低空遥感AI | 试飞服务与遥感作业区 | 任务备案与成果匿名化 | 遥感成果人工校验 |
| 飞行调度AI | 上地起降场概念节点 | 起降时序调度与冲突预警 | 调度指令人工确认 |
| 空域感知AI | 净空感知廊带 | 匿名聚合感知与分级预警 | 预警处置人工决策 |
...
换乘组织以地面集散为主、低空接驳为辅，依托地铁13号线、昌平线与公交走廊；起降点与道路衔接关系见 geometry/roads.geojson（road_class 已按允许枚举归一）。市政接入以共享为原则：智慧灯杆共享电力通信、配送枢纽接入园区能源系统；公共服务集成运行、应急、体验三类功能并错时共享。本节涉及的换乘分担比例、接驳设施规模、市政管线容量与公共服务配置量均为 provisional 概念边界下的估算（意愿性概念建议）；复算触发条件：官方发布现状交通流量调查、轨道客流统计、市政管线普查或控规图则等正式数据后，对上述各项指标整体复算，并以复算结果为准。
...
## 更新项目清单、实施政策与分期计划
更新项目清单共21项（概念），含枢纽类4项、设施类8项、公共空间类6项、运营机制类3项，逐项明确责任主体、投资估算与实施时序。实施政策建议：出台低空设施配建指引与净空管理办法，探索"统一建设、多元运营"模式，给予示范企业运营补贴与测试豁免；上述均为意向性政策建议，不构成对任何补贴或豁免的承诺。运营机制类3项为居民意见通道与公众参与设计（概念建议）：居民议事与意见征集公开答复机制（含居民议事会、意见征集与公开答复渠道）、年度运营与服务公示机制、年度开放日与体验周活动机制（开放日、体验周等概念活动，与配送展示、科普研学、试飞服务主题匹配）。


更新项目清单 21 项（概念）：枢纽类 4 项（中央配送枢纽、屋顶起降场与运维中心、环岛接驳站、运控大屏）、设施类 8 项（智慧灯杆起降点、配送柜机、机巢、净空护栏等）、公共空间类 6 项（科普展廊、模拟驾驶舱、试飞体验场、观景台、静音隔离带、慢行联系）、运营机制类 3 项（居民议事与意见征集答复机制、年度运营与服务公示机制、开放日与体验周活动机制）。分期计划为概念节奏，非官方承诺：近期（1-3年）试点示范——完成配送枢纽与科普走廊试点，启动分时配送与预约制体验，设立居民议事点并开展开放日试点；中期（3-5年）扩面成网——建成接驳与应急体系，试行年度运营与服务公示，常态化开展居民意见征集与公开答复；远期（5-10年）全域常态化——形成完整低空生活圈，年度开放日与体验周等概念活动常态化，运行与服务按年度公示并接受居民监督。


> **证据锚点**：[source:DATA-SRC-AGENT-TASKBOOK-20260518]。

## 指标体系、面积复算与合规矩阵
建立"空间—运行—安全"三维指标体系：空间类含设施覆盖率、净空达标率、绿地率；运行类含日均架次、准点率、配送时效；安全类含避障成功率、应急响应时间与事故率。上述运行与安全类数值均为概念建议口径（意愿性指标目标，非实测值）。面积复算以现状测绘与控规图则为底，对各地块建筑面积、容积率、开敞空间逐项校核。合规矩阵对照空域管理、民航、消防、园林等法规逐条映射设计动作，形成可自查、可审查、可追溯的合规清单，确保方案各环节有据可依。

![核心指标证据图](assets/figures/metrics-evidence.png)

空间—运行—安全三维指标体系共 17 项（metrics.json）；面积复算基于 provisional 几何：site_area_sqm≈11412825.4 平方米（约 11.41 平方公里），官方红线发布后逐项复算。整体复算触发条件（概念约定）：①官方正式红线或控规图则数据发布；②官方交通、轨道客流或市政普查数据发布；③官方用地分类与权籍数据更新。任一条件触发时，对全部面积、容积率、开敞空间、设施规模及相关运行指标进行整体复算，并以复算结果为准，本方案 provisional 数值仅作概念参考。合规矩阵覆盖公告 1.3-1.5 与 agent 征集 1-6 共 23 项任务，标准矩阵 5 项、设计深度矩阵 15 项（见对应 JSON）。


> **证据锚点**：[metric:site_area_sqm]、[data:PACKAGE-GEOMETRY]。

## 风险、版权与合规说明
本方案为概念研究性设计，主要风险包括：空域政策与运行标准变化、技术成熟度不足、公众接受度与噪声投诉、投资回报不确定等，均配套应对策略并保留弹性接口。方案自设 AI 治理边界（概念承诺，以正式法律法规与监管要求为准）：所有 AI 场景仅处理匿名聚合数据；关键决策一律人工复核；禁止过度监控——不进行个体识别式追踪、不建立大规模行为画像。公众沟通配置以居民议事、意见征集与公开答复、年度运营与服务公示、开放日与体验周等活动作为矛盾化解与共治渠道（概念建议）。方案涉及的企业数据、图纸与模型素材均来自公开渠道或有授权来源，未使用任何未授权版权材料；成果署名、引用与传播须遵守相关协议。本方案不构成行政审批依据，正式实施前须完成法定程序、算法备案、数据合规评估与公众参与等专项评估。
