...
场景之间不是平铺的“功能菜单”。S04、S09、S02分别构成交通、公共服务和安全治理三条旗舰验证链；S01、S05、S08负责把知识、成果和权利解释给公众；S03、S06提供算力与生态基础；S07、S10验证转化和年度运营。所有场景共享同一套知情、拒绝、人工接管、更正、申诉和退出权，但根据风险等级采用不同许可、日志与停止条件。
