---
title: "京张节律场 / Jing-Zhang Civic Rhythm"
...
summary: "以京张遗址公园为公共主脊，用五种时间协议连接三处AI创新锚点的可切换城市基础设施；临时边界仅用于概念生成与复核。"
tracks: ["ai-traffic-walkability", "enterprise-services-ecosystem", "civic-agent-governance"]
scenarios: ["ai-traffic-walkability", "enterprise-service-copilot", "public-safety-operations-review"]
---

# 京张节律场 / Jing-Zhang Civic Rhythm
...
本方案在官方 `SITE_BOUNDARY` 或三处 `KEY_AREA` 尚未取得时，使用 `brief/site-package/geometry/provisional_boundaries.geojson` 生成临时 formal 包。提交包中的 `geometry/site_boundary.geojson` 与 `geometry/key_areas.geojson` 均标注为 `provisional_constraint`、`official_boundary=false`，只用于方案生成、自检、可视化和设计讨论，不能作为 official redline、审批依据、精确面积依据或法定控制结论。是否符合征集资格及如何评分由维护者和评审依据当前规则独立判断；替换 official polygons 后，site boundary、key areas、land use、roads、green space、public space、buildings、phasing 和 metrics 均需重算。

本方案当前的事实状态为：**采用临时边界，保留精度警示，并待正式数据发布后复算**。正文中的空间结构、场景、项目和指标均按“可讨论、可复核、可替换官方边界后重算”的原则写入；当官方边界和重点区 polygon 更新后，agent 必须重新生成并校验全部受影响的空间、指标、图纸和 HTML 成果，不能只替换单个文件。
...
“京张节律场”不把 AI 创新理解为一组封闭园区或技术展柜，而把它组织成一套可日常使用、可周期切换、可逐步验证的市民基础设施。京张遗址公园是连续公共主脊，三处重点区是功能不同的节律锚点：众智园负责测试与标准化，北京 AI 原点社区负责开放协作与成果转化，大钟寺负责城市展示、消费体验和国际交往。空间在五种时间协议之间切换：工作日通勤、午间交流、夜间社区、季度测试、年度全球活动。它们复用同一套慢行、蓝绿、公共服务和轻量数字基础设施，避免为大型活动建设低频专用空间 [data:geometry/roads.geojson#ROAD-001] [data:geometry/public_space.geojson#PUBLIC-001] [depth:overall_spatial_structure]。

这一命题延续京张铁路“以时间组织城市”的历史意义：过去列车时刻把区域连接起来，今天公共空间的开放时段、服务强度和事件频率重新把高校、企业、社区与访客编织在一起。设计重点因此不是制造一个静态地标，而是建立一套谁在何时使用、空间如何转换、数据怎样最小化、人工服务如何兜底的运营剖面。临时边界只作为低精度约束；节律主脊、节点关系和运营协议才是本方案的设计主体 [source:BOUNDARY-SOURCE] [assumption:A-RHYTHM-001]。

| 时间协议 | 主要使用者 | 空间状态 | 核心服务 | 评估方式 |
| --- | --- | --- | --- | --- |
| 工作日通勤 | 居民、学生、研发人员 | 快速连续、低干扰 | 换乘、骑行、无障碍导航 | 断点与绕行时间 |
| 午间交流 | 园区团队、创业者、访客 | 小尺度开放、短时停留 | 路演、共享餐桌、咨询 | 停留与跨机构交流 |
| 夜间社区 | 周边居民、青年人才 | 安静照明、可分区关闭 | 运动、学习、生活服务 | 噪声、照度、居民反馈 |
| 季度测试 | 企业、高校、监管与公众 | 预约分区、人工复核 | 交通/终端/模型验证 | 安全、可解释与退出率 |
| 年度全球活动 | 国际开发者、城市访客 | 路线化、弹性扩容 | 展示、论坛、文化叙事 | 承载力与活动后复用 |
...
本方案建议的总体概念为“京张节律场”：以京张遗址公园为历史与公共空间主轴，以众智园、北京AI原点社区、大钟寺三处重点片区为创新锚点，以高校、企业、社区和轨道站点为日常网络，形成“一带三核、多点场景、蓝绿慢行复合环”的空间组织。这里的“一带”不是额外画出的新红线，而是把公告中的三层范围转译为工作方法；“三核”对应三处重点区域；“多点场景”对应AI+公共服务、产业服务和城市生活的可运营节点；“复合环”对应慢行、绿地、公共空间和活动路线的联动。
...
AI 场景必须落到空间和治理边界：公共空间场景引用 [data:geometry/public_space.geojson#PUBLIC-001]，慢行与交通场景引用 [data:geometry/roads.geojson#ROAD-001]，开放空间场景引用 [data:geometry/green_space.geojson#GREEN-001] 和 [metric:public_space_ratio]、[metric:green_ratio]。这些引用让评审者知道场景不是口号，而是位于具体图层和指标中的设计对象。面向智能体任务书要求不少于10张AI场景卡、不少于3个产业测试验证场景和不少于5类用户画像；本方案给出可深化的结构，正式参赛者必须把场景卡、画像表、隐私边界、人工复核和运营主体写入正文、HTML、A3/A0 和合规矩阵。
