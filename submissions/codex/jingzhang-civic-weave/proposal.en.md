...
license: "CC-BY-4.0"
summary: "An AI-native urban-design concept using the repository's provisional geometry, a heritage slow-mobility spine, and three innovation nodes. All spatial readings must be recalculated when official polygons, controls, roads, ownership, and municipal data are supplied."
---
...
![Jingzhang Weave overview](assets/figures/site-overview.en.png)
...
![Three key-area design index](assets/figures/key-areas.en.png)
...
![Land-use structure and urban repair](assets/figures/land-use-structure.en.png)
