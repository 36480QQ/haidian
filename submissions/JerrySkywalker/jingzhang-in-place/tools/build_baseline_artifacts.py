...
def receipt():
    ...
    data={"schema_version":"0.1.0","generator":"tools/build_baseline_artifacts.py","runtime":"Python 3.12; Pillow 12.3.0; ReportLab project local","fonts":{"zh":"Microsoft YaHei system font; not redistributed","en":"Arial system font; not redistributed"},"offline":True,"outputs":outputs}
    (ROOT/"artifact-receipt.json").write_text(json.dumps(data,ensure_ascii=False,indent=2)+"\n",encoding="utf-8",newline="\n")
