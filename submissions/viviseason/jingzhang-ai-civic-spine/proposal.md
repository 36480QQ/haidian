...
summary: "以 Jacobs 的日常多样性、Newman 的低汽车依赖和 Gehl 的公共生活观察构成三重人本检验；先用合规开放数据建立网络、形态、服务和蓝绿代理基线，再由本地独立观察验证真实公共生活，且不把代理数据冒充现场事实。"
...
本方案的总体概念为“京张AI新篇章：人—城—伟业”：以京张遗址公园为历史与公共空间主轴，以众智园、北京AI原点社区、大钟寺三处重点片区为创新锚点，以高校、企业、社区和轨道站点为日常网络，形成“一条公共生活链、三处人本验证站、多点可退出场景”的空间组织。“新篇章”不是额外画出的新红线，也不是把 AI 设备铺满走廊；它要求每一段空间连接同时经受多样性、公共生活和低汽车依赖检验，并把未通过检验的场景留在研究或沙盒阶段。
...
三种方法在本方案中不是审美标签，而是三道可否决的检验：没有用途与时段多样性，不启动仅服务单一企业的公共空间项目；没有真实步行网络和站点接驳数据，不声称形成连续慢行廊道；没有匿名公共生活观察，不声称空间已经安全、舒适或有活力。由于参赛者无法到场，本轮采用两级证据：先以 OSM、官方公开目录和开放遥感建立网络、形态、服务与蓝绿空间代理基线，并逐项保存许可、查询、原始哈希、坐标系和处理局限；后续再由本地专业团队或清权社区伙伴执行匿名观察。2026-08-17 已取得并裁剪 OSM mobility 与 buildings 原始快照，但 POI 请求连续返回 HTTP 429 后仅留下空文件，green/water 尚未下载；本轮仅将 mobility/buildings 作为低对比度静态背景代理绘入五组双语图，未将任何 OSM 派生数值写入投稿 GeoJSON 或指标，混合度、公共生活与蓝绿性能继续保持 `unknown`。背景图层不是官方边界、现状红线或现场观察的替代物。第一层可以支持选点和设计诊断，但不能替代第二层。完整契约见 `visual/assets/people-first-research.json`。
...
面积比例只能说明分配，不能证明空间好用。开放网络与遥感数据先用于筛选 12 个未来观察点、识别断点、屏障、站口、服务空白和潜在遮阴不足；它们不产生真实行走、骑行、停留、座椅使用或舒适度结论。后续本地独立调查须按四个时段记录匿名聚合数据；在该调查完成前，方案不声称现场已经具有活力、安全感或舒适度。Gehl 式观察负责回答“人是否愿意停留”，Jacobs 式界面与用途调查负责回答“日常活动是否在不同时间持续发生” [source:GEHL-2010-CITIES-FOR-PEOPLE] [source:JACOBS-1961-DEATH-LIFE]。
...
本轮新增用地混合熵、步行路口密度、街区长度、活跃界面率、公共生活观察、无障碍连续率、站点步行覆盖、路径直接度、高频公交可达和遮阴覆盖十项人本指标。它们目前全部为 `unknown`：先公开公式和所需证据，再把可复算的开放数据结果标为“代理基线”，把必须现场验证的 Gehl 式观察继续保留为未知，最终由本地独立观察和专业复核闭环，不用推测值换取表面完整。
