...
本方案的总体概念为“京张AI新篇章：人—城—伟业”：以京张遗址公园为历史与公共空间主轴，以众智园、北京AI原点社区、大钟寺三处重点片区为创新锚点，以高校、企业、社区和轨道站点为日常网络，形成“一条公共生活链、三处重点区及其公共节点、多点可退出场景”的空间组织。“新篇章”不是额外画出的新红线，也不是把 AI 设备铺满走廊；它要求先以空间动作组织公共生活，再以三项人本空间检验决定场景是否可以推进。图 02、图 03、图 04 分别解释混合更新界面、重点区公共生活节点和慢行—蓝绿系统；图 05 与 A0 展板以“混合更新 / 可达网络 / 公共生活”把三类动作重新指回同一张总体图。不同图中的颜色、线型和编号只在该图的图例内生效，不跨图承担同一含义。
...
三项检验把已登记的城市设计研究转译成空间决定，而不是把研究者姓名变成图例。第一项是**混合与渐进更新**：用不同主导用途、可选择的短路径、可逐步改善的首层界面支撑全天候日常活动；图 02 的 M 指向沿真实街路纹理组织的概念介入场。第二项是**低碳可达网络**：站点、步行、骑行和公共交通的连续性先于智慧交通界面；图 04 的 A 只表示沿开放街路形态提出的慢行与公共服务候选联系片段，必须经站口、过街和屏障数据核对后才能延展为连续廊道。第三项是**可停留、可观察、可调整的公共生活**：先理解人们如何走、停、坐、交谈和取得非数字服务，再决定空间构件和 AI 场景；图 03 的 01–03 是未来观察与调整的空间落点。[source:JACOBS-1961-DEATH-LIFE] [source:NEWMAN-KENWORTHY-1999-SUSTAINABILITY-CITIES] [source:GEHL-2010-CITIES-FOR-PEOPLE]
