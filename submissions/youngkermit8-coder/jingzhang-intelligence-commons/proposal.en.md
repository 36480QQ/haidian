---
title: "Jing-Zhang Intelligence Commons: Spatial-First Urban Design V5"
...
iteration: "v5.0"
summary: "V5 closes the formal-review loop: it keeps the spatial-first masterplan, three key-area deepening drawings, algorithm overlays, edge evidence metrics, bilingual companions, and a stricter 97+ participant self-audit under current public/provisional data limits."
tracks: ["ai-traffic-walkability", "enterprise-services-ecosystem", "civic-agent-governance"]
scenarios: ["ai-traffic-walkability", "enterprise-service-copilot", "public-safety-operations-review"]
---

# Jing-Zhang Intelligence Commons: Spatial-First Urban Design V5

> V5 keeps the review sequence spatial-first. A reviewer should first read the urban structure from the masterplan, then inspect computation, provenance, public-value commitments, and stop conditions at the edge of each drawing. Cards, indicators, passports, and algorithmic rules are evidence layers; they do not replace urban design.
...
![Overall urban design masterplan: spatial priority and algorithm overlay](assets/figures/site-overview.en.png)
...
![Case transfer and digital rule matrix](assets/figures/case-transfer-evidence.en.png)
...
![Land-use structure and the one-spine three-court two-wing system](assets/figures/land-use-structure.en.png)
...
![Three key-area plans, sections, ground-floor interfaces, and operating sequences](assets/figures/key-areas.en.png)
...
V5 turns scenario cards into spatial operating rules. Each card records purpose, users, prohibited uses, data contract, offline evaluation, launch threshold, human fallback, incident response, and retirement condition. These rules are attached to public ground, slow-mobility nodes, and operating gates instead of occupying the center of the boards. [source:NIST-AI-RMF]

![AI scenario and governance cards attached to spatial nodes](assets/figures/ai-governance.en.png)
...
![Climate engineering, shade, sponge city, and public health layers](assets/figures/climate-engineering.en.png)
...
![Implementation route, operating gates, and stop conditions](assets/figures/implementation-roadmap.en.png)
...
The metrics figure moves from the center to the edge. Urban design must first prove spatial structure and public interface; metrics then explain assumptions and recalculation. If indicators dominate, the work reads as a dashboard rather than a city design. If indicators disappear, the open-source review loses auditability. V5 keeps both by using a primary drawing plus evidence rail. [depth:metrics_recalculation]
...
![Public value passport attached directly to spatial objects](assets/figures/public-value-protocol.en.png)
...
- Professional standard indexes: `SRC-2017-MOHURD-URBAN-DESIGN-MEASURES` and `SRC-MOHURD-CONTROL-DETAILED-PLANNING`, used for urban design management, regulatory-plan expression, and implementation boundaries; see `standard_matrix.json`. [standard:MOHURD-CONTROL-DETAILED-PLANNING]
