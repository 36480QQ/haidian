---
title: "Jingzhang AI Pulse: A Three-Core, Two-Wing Framework for AI Industry Acceleration and a Smart-Native City"
author_github: "fly9i"
language: "en"
...
summary: "A conceptual urban design that turns the century-old Jing-Zhang railway heritage park into a north-south AI public-space spine, linking three key cores — Zhongzhiyuan Acceleration, AI-Origin Community, and Dazhongsi Industry — supported by the Zhongguancun technology-service wing and the Xiaoyuehe scenario-empowerment wing."
...
This section implements land layout, building scale, and retain-renovate-demolish classification [standard:MNR-LAND-USE-CLASSIFICATION-GUIDE]. The overall design area is partitioned into 69 seamless cells: about 4.07 km² residential, 3.51 km² road, 2.22 km² park green (including the Jingzhang spine), 1.11 km² education, 0.93 km² commercial-service, 0.37 km² R&D, 0.37 km² community service, and 0.18 km² culture [metric:land_use_partition_area_sqm]. Codes use the verifiable national classification, with shared coordinates and no gaps [depth:land_use_layout].
