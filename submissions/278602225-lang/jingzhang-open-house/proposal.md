...
中文名“京张开放之家”，英文名“JINGZHANG OPEN HOUSE”。“家”表达可进入、可共处、可长期归属；“开放”把它从房地产命名转为制度承诺。Logo 采用**门框 + 京张轨迹 + 开放端口**三笔结构：门框是城市公共性，折线是百年京张与创新转化路径，节点是参与者留下的贡献。主色不是单一科技蓝，而是铁路墨黑、信号珊瑚红、公共绿、协作黄与基础蓝，分别对应历史、行动、公共利益、共同建设与基础设施 [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]。
