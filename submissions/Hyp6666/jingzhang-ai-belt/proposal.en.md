---
title: "Centennial Jing-Zhang - Symbiotic Intelligent Rail: AI Innovation Belt Open Urban Design Proposal"
...
Official precise polygons (three-level scopes, three key areas) not obtained as of finalization. The overall design boundary is a provisional rough fit to the announcement's textual descriptions and approximate area (`provisional_constraint`, `official_boundary=false`) — AI generation, visualization, self-check only. "Four Must-Nots": not an official planning boundary; not a basis for approval, precise area, or formal professional scoring; the gap does not block content scoring[data:geometry/site_boundary.geojson#SITE-001]. EPSG:4548 recomputation approx. 11,412,825 sqm is an order-of-magnitude check on the announced approx. 11.4 km² — a fit, not verification; wholesale replacement + recomputation once official boundaries are released[metric:site_area_sqm].
...
![Figure 2-1 Site Scope Overview (provisional boundary schematic; dashed light lines, watermark; not an official boundary; not a primary compositional element)](assets/figures/site-overview.en.png)
...
![Figure 4-1 Overall spatial structure and functional layout (agent.1 deliverable overall_structure_diagram; provisional boundary and design geometry; provisional elements; not official boundary; no boundary/metric evidence)](assets/figures/land-use-structure.en.png)
...
![Figure 5-1 Three key areas detailed design overview (provisional rough-scope sketch; positioning differences, project levers, renewal logic, main-structure links, risk conditions; not official boundary, no metric evidence)](assets/figures/key-areas.en.png)
...
![Figure 7-1 Main narrative of land-use structure (same source as Figure 4-1: conceptual structure diagram from submission layers such as land_use.geojson; provisional, not an Official Planning Boundary or indicator evidence; authoritative data: GeoJSON files and metrics.json)](assets/figures/land-use-structure.en.png)
...
![Figure 8-1 Spatial placement of walking-and-cycling, rail connection, and AI scenario nodes (shares mobility-bluegreen.png with Chapter 9; main narrative: rail connection corridor, east–west stitching walking-and-cycling, and municipal new-infrastructure node placement — see Chapter 9 for the blue-green continuity narrative; provisional boundary and design-proposal geometry, not an Official Planning Boundary, not indicator evidence)](assets/figures/mobility-bluegreen.en.png)
...
![Figure 9-1 Blue-green and walking-and-cycling continuity structure (shares mobility-bluegreen.png with Chapter 8; main narrative: blue-green network continuity and corridor interfaces — transport narrative in Chapter 8; provisional boundary diagram, not an Official Planning Boundary, not indicator evidence)](assets/figures/mobility-bluegreen.en.png)
...
![Fig. 11-1 Core metric recalculation and evidence chain (sources, recalculation relations, pending RDP metrics, self-check status; EPSG:4548-derived from geometry/*.geojson; values match metrics.json; explanatory layer, not authoritative for official areas, boundaries, metrics)](assets/figures/metrics-evidence.en.png)
