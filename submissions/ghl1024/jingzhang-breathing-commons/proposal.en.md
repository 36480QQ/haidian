---
title: "Jing-Zhang Breathing Commons: Verifiable Urban Climate and Public Wellbeing"
...
iteration: "v0.16"
summary: "One breathing spine, three differentiated urban lungs, twelve pauseable scenarios, and six public-value gates organize environmental AI, public wellbeing, industry validation, blue-green space, and human fallback into a recalculable urban-design proposal with an exit path."
...
![Overall area, three breathing lungs, and breathing spine](assets/figures/site-overview.en.png)
...
![Five conceptual land-use partitions and three lungs](assets/figures/land-use-structure.en.png)
...
![Three key areas and twelve scenario roles](assets/figures/key-areas.en.png)
...
![Movement, blue-green network, and human fallback](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, evidence, and recalculation chain](assets/figures/metrics-evidence.en.png)
