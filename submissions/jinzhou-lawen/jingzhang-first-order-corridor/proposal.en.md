...
summary: "A TEST–MAKE–BUY–LEARN sequence connects Zhongzhiyuan, AI Origin, Dazhongsi, and the Railway Heritage Park, turning AI display into accountable testing, first orders, maintenance, and exit while keeping boundaries, customers, costs, and implementation status explicit."
...
![Design Basis and Source List](assets/figures/site-overview.en.png)
...
![AI Innovation Ecosystem, Personas, and AI+ Scenarios](assets/figures/mobility-bluegreen.en.png)
