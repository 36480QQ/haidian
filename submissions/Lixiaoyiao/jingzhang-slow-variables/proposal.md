...
| 指标 | 当前值/状态 | 公式 | 设计含义 |
| --- | ---: | --- | --- |
| 临时总体设计范围面积 | 11,412,825.39 m²（11.413 km²） | EPSG:4548 polygon area | 只用于包内分母与复算 |
| 概念绿地 | 2,589,338.29 m²（258.93 ha）/ 22.69% | green area / site area | 保证百年基线连续，不是法定绿地率 |
| 概念公共空间 | 1,118,594.33 m²（111.86 ha）/ 9.80% | public area / site area | 支撑十二时标和免费停留 |
| 概念建筑基底 | 219,357.87 m²（21.94 ha） | sum conceptual modules | 表示适应模块，不等于现状或批准规模 |
