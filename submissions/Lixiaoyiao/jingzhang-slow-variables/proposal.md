...
| 公共空间 | `TIME-MARK-10..12` 形成公开基准廊、人工求助点与故障展示，不暴露个人轨迹 | 现状公共性和无障碍核验后再落点 |
...
| 公共空间 | `TIME-MARK-07..08` 承担共学客厅、人工服务、安静时段与无账户入口 | 不满足免费停留与非数字等价服务即不续期 |
...
| 公共空间 | `TIME-MARK-01` 作为免费停留、人工窗口和退役回收的方向性节点 | official polygon 与公共空间现状到位后全包重算 |
...
百年基线首先是一条可走、可停、可避暑、可求助的公共地面，其次才是技术展示。提交绿地 polygon 形成连续概念带，EPSG:4548 复算面积为 2,589,338.29 平方米（258.93 公顷），概念绿地率约 22.69%；十二处公共时标以小尺度公共空间串联三处换代场，复算面积为 1,118,594.33 平方米（111.86 公顷），概念公共空间率约 9.80%。两项均基于临时边界和概念几何，不是法定绿地率或批准公共空间指标。[metric:green_ratio] [metric:public_space_ratio]
...
| P05 大钟寺采用与维修厅 | 采用评审、维修培训、退役回收及站点步行问题清单 | 建议由片区运营与交通专业牵头；商户/运维协作 | 正确 official KEY003、站点/道路红线、产权同意 | 通勤者、商户、运维人员复核 | 位置偏移未解或维护/退役机制缺失，不形成工程结论 | 触发后深化 |
| P06 十二时标公共组件 | 12 点位组件、实体导视、人工服务与维护周期清单 | 景观/公园运营；无障碍与设施专业协作 | 现状测绘、地下管线、文保 | 逐点无障碍和免费使用审计 | 占盲道、损绿、遮挡遗产或无人维护即撤除 | 0-2 年样机，逐年复审 |
...
`phasing.geojson` 的三块 polygon 表达“概念空间实施面”，不表示三个重点区按南—中—北整片依次建设。近期 0-2 年只允许跨片区的低扰动调查、人工服务和可逆样机；中期 3-5 年只有在官方红线、控规、权属与专业论证到位后才可适应性改造；长期 6-10 年按公开评估扩展、重构或退役。P09 始终由资料触发。[data:geometry/phasing.geojson#PHASE-001] [metric:phase_1_area_sqm] [depth:phasing_implementation]
...
| 可插拔 AI 生产服务带 | 3,366,138.43 m² / 29.49% | `LU-003 / site` | 可替换生产服务容量方向，不是产业承诺 |
| 长生活社区配套带 | 3,041,726.42 m² / 26.65% | `LU-004 / site` | 居住/服务混合方向，不是住房配额 |
| 概念绿地 | 2,589,338.29 m² / 22.69% | union green / site | 百年基线连续性，非法定控制 |
| 概念公共空间 | 1,118,594.33 m² / 9.80% | union public / site | 十二时标与免费停留；可与绿地重叠 |
...
| 三个空间实施面 | 4,232,697.32 / 3,853,523.21 / 3,326,615.55 m² | `PHASE-001..003` | 概念空间分期，不等于项目试验日历 |
