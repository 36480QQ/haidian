---
title: "JING-ZHANG SLOW VARIABLES: Fast Technology, Lasting Life"
...
![Evidence, spatial layers and four clocks](assets/figures/site-overview.en.png)
...
![Three scales and slow-fast spatial layers](assets/figures/land-use-structure.en.png)
...
![Walking, blue-green and non-digital alternative network](assets/figures/mobility-bluegreen.en.png)
...
![Core metrics, evidence chain and recalculation status](assets/figures/metrics-evidence.en.png)
...
All prose, geometry, diagrams, HTML and PDFs were originally generated for this package. External material is summarised as citation only; no external photograph, map, logo, portrait or restricted layout is embedded. The package uses COMMUNITY-DISPLAY-ONLY for project-community display and review. Qualified human teams retain final professional judgement and responsibility for statutory process and implementation. [source:SOURCE-REGISTRY]
