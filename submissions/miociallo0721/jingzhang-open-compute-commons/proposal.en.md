---
title: "JINGZHANG OPEN COMPUTE COMMONS"
author_github: "miociallo0721"
language: "en"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "A complete aligned English translation of 京张开放算力公地, organized by four linked compute contracts and evidence-gated public value."
iteration: "v1.3"
---
...
![Evidence-oriented overview of four contracts and provisional boundary](assets/figures/site-overview.en.png)
...
![Three-level framework and Three Zones–Two Wings diagram](assets/figures/land-use-structure.en.png)
...
![Key areas: directional plans, typical sections, relationship diagrams and four states](assets/figures/key-areas.en.png)
...
The land-use layer is a gap-free, non-overlapping conceptual functional partition under the same provisional site constraint, recalculated in EPSG:4548 and exchanged in EPSG:4326. It no longer uses seven horizontal bands: a public accountability spine, node courtyards, controlled test envelopes, service fronts, maintenance/reverse logistics, and reversible-exit buffers make a relationship network. The seven categories describe this topology background only; they do not claim statutory land use, approved parcel, or development capacity. All areas must be recalculated together when official geometry arrives. [data:geometry/land_use.geojson] [metric:site_area_sqm] [metric:green_ratio]
...
![Mobility, blue-green buffers, and non-AI service fallback](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, four-contract evidence chain, and recalculation status](assets/figures/metrics-evidence.en.png)
