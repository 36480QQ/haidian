---
title: "Jingzhang Test City: Let Everyday Life Test the Plan"
...
summary: "Multiple AI Agents propose direct-link, public-life and time-sharing plans for S03. One hundred digital users route through four urban scenarios; weak strategies exit and useful genes recombine over three rounds into a public adaptation route and transferable urban-evolution protocol."
...
![Overall and three-level scopes: the longitudinal Jingzhang heritage spine, the S03 transverse test section and three key areas](assets/figures/site-overview.en.png)

All figures and structured artifacts share one evidence chain. The overall area is recalculated from the submitted provisional boundary, and the three key areas remain separate features. New official polygons would trigger a full recalculation of land use, roads, green space, public space, buildings and phasing. [data:geometry/site_boundary.geojson#SITE-001] [metric:site_area_sqm]
...
![Land-use structure and evolutionary cells: locked slow layer, adaptable medium layer and reversible fast interfaces](assets/figures/land-use-structure.en.png)

The spatial concept is a Jingzhang evolutionary spine crossed by public adaptation paths. The railway heritage park is a longitudinal slow layer of history, ecology and public culture. Streets, stations, campus edges, entrances and ground floors are the medium layer. Opening hours, delivery windows, events, shade, cycle parking and services form a reversible fast layer. [data:geometry/land_use.geojson#LU-001] [depth:overall_spatial_structure]
...
![Three niches: Zhongguancun autonomous innovation source, AI campus talent translation and Houchangcun urban intelligence governance](assets/figures/key-areas.en.png)
...
![Mobility and blue-green public space: the longitudinal Jingzhang spine and the transverse Chengfu Road public adaptation path](assets/figures/mobility-bluegreen.en.png)
...
![S03 Public Adaptation Route design-intent model: an at-grade, lightweight and reversible public route coexisting with the Jingzhang railway structure](assets/media/design-intent-s03.webp)
...
![Core metrics and evidence grades: parallel evaluation vectors, tested generations and uncertainty declarations](assets/figures/metrics-evidence.en.png)
