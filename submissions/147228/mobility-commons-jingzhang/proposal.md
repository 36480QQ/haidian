...
“百年京张”在本方案中不是一张装饰性海报，而是对到站、换乘、等候、维护和回家的公共记忆回应。遗址公园、站口、企业入口和社区服务点用同一套导视、遮雨、座椅、无障碍路线和人工服务台连接；人先看得懂怎么走，再决定是否使用任何智能服务 [source:OFFICIAL-ANNOUNCEMENT]。
...
这张表把交通操作系统落回城市设计的五个可见界面：站口、公共空间、建筑首层、路缘和维护点。三处重点区的体量与首层选择见后文，空间关系仍回接 provisional 图层，实施依赖与回退责任由专业团队和有权组织补齐 [depth:overall_spatial_structure] [data:geometry/key_areas.geojson#PROV-KEY-001]。
