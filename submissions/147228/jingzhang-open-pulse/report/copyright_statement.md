...
The current drawing set is the v3.2 Chinese ten-page and English nine-page landscape A3 booklet, plus bilingual three-page landscape A0 board exports (420 × 297 mm and 1189 × 841 mm). The page-count difference reflects the language-specific figure-panel layout and is intentional. v3.3 adds a machine-readable spatial-object refinement without changing the displayed area metrics; these PDFs remain presentation exports of the local evidence figures, not construction documents. The PDF metadata and page boxes record the physical sizes so a reviewer can verify the intended print scale without treating the drawings as an official survey or approval set.
