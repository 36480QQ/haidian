...
> **包版本说明：** 本包迭代为 v3.4；v3.3 仅指本包沿用的空间对象与图纸导出层。v3.4 是公开元数据中性化修订，不改变空间、指标、来源或实施边界。
...
本轮工作针对详细评审中反复出现的硬缺口：任务书逐条回读、区域协同与生态图谱、真实身份系统、节点级空间动作、具身智能组件、场景运营责任、版权清权和双语审阅。它们不是把“AI”再写长一遍，而是把每个判断绑定到一个可打开、可复算、可停止或可追责的证据位置。
