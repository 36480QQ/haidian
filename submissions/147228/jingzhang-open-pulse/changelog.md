...
- 清理正式 GeoJSON 元数据中的 scaffold 命名，改为明确的 provisional/conceptual Open Pulse 图层名；恢复英文图册的图像证据层并同步版权台账与 manifest 哈希，按当前文件回读页数（中英文 A3 各 10 页；中文 A0 3 页、英文 A0 10 页）。
