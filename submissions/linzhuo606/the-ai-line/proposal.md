...
5. **时间要宽容**：主干走廊过街处规划 9 处行人安全岛 [metric:refuge_island_count]（[data:geometry/roads.geojson#RD-02] 等主干概念走廊与南北向线路交叉点），走得慢的人绿灯结束时可在岛上从容等待下一个周期；配套手机/实体卡双通道的**可申请延长绿灯**。休息同样是时间的宽容：沿线座椅按英国交通部《Inclusive Mobility》规范布置——常用步行区间隔不超过50米，本方案取站区与重点区段≤50米、一般段≤100米，每处带扶手靠背（起身支撑）与轮椅停驻位。"走得慢也不用慌"应当是权利，不是运气。
