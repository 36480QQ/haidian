---
title: "THE SAFE CHARGE LINE: Stop-Charge Reliability Infrastructure / 京张安心充"
...
summary: "A verifiable responsibility contract connecting e-bike parking, charging or swapping, safe shutdown, human response and battery retirement. Individuals use and report; professional operators own safety; government and communities coordinate and supervise."
...
![Proposal overview: from historic-facility audit to a stop-charge responsibility contract](assets/figures/site-overview.en.png)
...
![Three scope levels and the stop-charge reliability structure](assets/figures/land-use-structure.en.png)
...
![Three key areas: validation, transparency and handover](assets/figures/key-areas.en.png)
...
![Parking, slow mobility, blue-green space and responsibility interfaces](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, unknowns, responsibility and validation gates](assets/figures/metrics-evidence.en.png)
