---
title: "THE READY AED LINE / 京张五分钟: Make a Lifesaving Device Truly Retrievable When Needed"
...
summary: "No duplicate AED map and no premature equipment procurement: service hours, no-lock/no-scan access, physical wayfinding, inspection, training-AED return drills, accountable roles and post-use reset jointly prove whether a point is ready."
...
![Three scopes and readiness network](assets/figures/land-use-structure.en.png)
...
![Distinct validation roles for three key areas](assets/figures/key-areas.en.png)
...
![Phone-free retrieval journey and public realm](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, evidence and kill gates](assets/figures/metrics-evidence.en.png)
