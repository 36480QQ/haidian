...
summary: "Turns an emergency period-care need from an awkward personal request into an identity-free, phone-free, traceable and recoverable public-service atom. AI remains only if a blind test beats a two-bin and deterministic reorder baseline."
...
![First principles, three spatial scales and the responsibility line](assets/figures/site-overview.en.png)
...
![Three scales: not repeated machines, but lab—operation—stress test](assets/figures/land-use-structure.en.png)
...
![The three areas divide lab, limited operation and stress testing](assets/figures/key-areas.en.png)
...
![Ninety-day falsification, measures and evidence chain](assets/figures/metrics-evidence.en.png)
...
![State, authority, graceful degradation and maintenance](assets/figures/mobility-bluegreen.en.png)
