...
1. **High last-mile delivery cost.** Public industry data show last-mile cost commonly at 30%-50% of total logistics cost [source:jd-smart-delivery-vehicle]. The corridor's dense campuses, parks and communities offer regular routes suitable for low-speed robot pilots; the order-density judgment is an inference to be verified by an authorized OD survey, not cited as established fact.
