...
**Privacy and human-review boundary.** Robots only navigate, deliver and alert — never diagnose, approve or enforce; the Interim Measures for Generative AI Services govern generative content services offered to the public and do not cover robot dispatch algorithms — traffic safety, product liability, insurance and data-compliance requirements for dispatch are listed as implementation preconditions to be confirmed by the competent authorities and professional legal teams [source:generative-ai-interim-measures]; no vendor is designated as necessary.
