...
1. **High last-mile delivery cost.** Academic research estimates last-mile cost at roughly 30%-50% of total logistics cost (a range estimate that cannot substitute for a local Jingzhang baseline; background reference only) [source:last-mile-delivery-cost-study]. The corridor's dense campuses, parks and communities offer regular routes suitable for low-speed robot pilots; the order-density judgment is an inference to be verified by an authorized OD survey, not cited as established fact.
...
**Privacy and human-review boundary.** Robots only navigate, deliver and alert — never diagnose, approve or enforce; the Interim Measures for Generative AI Services govern generative content services offered to the public; whether they extend to robot dispatch scenarios is for the competent authorities and professional legal teams to confirm, and this proposal makes no exclusionary judgment — four compliance tracks (generative public interaction, non-generative dispatch, traffic/product safety, data governance) are each listed as implementation preconditions pending professional confirmation [source:generative-ai-interim-measures]; no vendor is designated as necessary.
...
**Compliance boundary.** This proposal constitutes no government review conclusion or implementation commitment [source:official-announcement]. Compliance paths are split in two: generative content services (e.g., guide Q&A) follow the applicable requirements of the Interim Measures for Generative AI Services; robot navigation and dispatch fall outside that regulation's scope, and their traffic safety, product safety, road-right, insurance and data-governance requirements are listed separately as implementation preconditions requiring confirmation by the competent authorities and professional legal teams [source:generative-ai-interim-measures]; lanes do not occupy barrier-free passage. No personal privacy, classified or non-public data; no fabricated endorsement; the tabletop used zero real personal data.
