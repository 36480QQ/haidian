---
title: "Jing-Zhang Through-Belt · THE BREAKTHROUGH BELT —— Urban Design Proposal: From a Centennial Engineering Breakthrough to an AI Innovation Breakthrough"
author_github: "yahoolcj"
language: "en"
proposal_format_version: "2"
bilingual_contract_version: "1"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "Taking the breakthrough of the Badaling Tunnel on the historic Jing-Zhang Railway and the underground passage of the Jing-Zhang High-Speed Railway through the Qinghuayuan Tunnel as the cultural origin, this proposal introduces the 'Jing-Zhang Through-Belt': using 'One Tunnel, Two Corridors, Three Cores, Two Wings' to organize the heritage-park Green Tunnel, the underground AI infrastructure corridor, three key districts, and two innovation wings into a verifiable, reversible AI innovation through-belt."
...
![Index map and design tasks for the three key areas](assets/figures/key-areas.png)
...
![Traffic slow-traffic and blue-green public space composite system diagram](assets/figures/mobility-bluegreen.png)
