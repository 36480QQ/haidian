---
title: "LUNAR RAIL JINGZHANG: An AI Innovation Belt Measured by Moonlight and Valued by Permanent Memory"
...
summary: "LUNAR RAIL organizes the Jingzhang heritage park, three key areas, and two wings as one rail, three moons, and two tides, combining lunar-rhythm operations with a public memory system. All spatial judgments use provisional rough boundaries and must be recalculated when official data is released."
...
![LUNAR RAIL overall scope and structure](assets/figures/site-overview.en.png)
...
![One Rail, Three Moons, Two Tides land-use structure](assets/figures/land-use-structure.en.png)
...
![Three lunar key areas](assets/figures/key-areas.en.png)
