...
四个优先验证场景采用同一张“场景—空间—运营—证据”卡：模型安全红队测试在众智园标准工作坊进行，记录通过/停止原因和人工复核签名；无障碍慢行导航在遗址公园记忆环进行，记录可达断点、替代路线和纸面反馈；智能终端与内容消费联调在大钟寺展示客厅进行，记录设备故障、内容授权和访客反馈；人才生活管家在原点社区服务台进行，记录人工柜台转接率和用户主动撤回率。验收指标先采用“是否完成记录、是否可人工复核、是否有退出路径”三项布尔门槛，具体数值由专业团队和参与者共同确认，不把试点写成批准运营。
