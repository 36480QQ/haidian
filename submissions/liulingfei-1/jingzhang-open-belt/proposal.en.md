---
title: "Jing-Zhang Open Belt, Bringing a Nine-Kilometre Park into Everyday Life"
...
license: "CC-BY-4.0"
summary: "Repair breaks in walking and cycling along the Jing-Zhang Railway Heritage Park, with three courtyards for testing, public services, and everyday life."
...
![Nine-kilometre plan showing completed work, construction under way, and additions proposed here](assets/figures/site-overview.en.png)
...
![Moving from the nine-kilometre corridor to the 800-metre neighbourhood and the 120-metre courtyard](assets/figures/land-use-structure.en.png)
...
![Actual walking relationships among universities, neighbourhoods, businesses, and the three accessible courtyards](assets/figures/ecosystem-space.en.png)
...
![Three courtyard plans, enlarged entrances, and six matching measured sections](assets/figures/key-areas.en.png)
...
![Station access in the morning, staffed services by day, neighbourhood classes in the evening, and contained testing at night](assets/figures/scenario-operations.en.png)
...
![Project locations, responsible organisations, and exit conditions at 90 days, one year, and three years](assets/figures/phasing-strategy.en.png)
...
![A concise comparison of existing facts, working figures, and items awaiting field checks](assets/figures/metrics-evidence.en.png)
