...
**实施政策建议**：更新单元统筹与成片实施机制、存量空间功能转换与弹性年期通道、校区园区街区融合的协商平台、公众参与与社区共治程序、场景开放清单制度。公众与受影响群体的参与记录（会议纪要、意见与回应台账）应作为各条件门的验收证据之一并公开留存——本包现阶段无实际参与记录，此为机制承诺而非既成事实。均为政策研究建议，须经法定程序确认。
