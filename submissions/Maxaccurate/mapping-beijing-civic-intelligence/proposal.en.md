---
title: "All Minds Archived, A Reply from Jinghua"
...
summary: "Civic intelligence turns global knowledge, Beijing experience, public dissent and trial results into urban infrastructure that can be re-tested, exited and answered."
...
![Scope and evidence status](assets/figures/site-overview.en.png)
...
![Land use, functions and Open Courtyard interfaces](assets/figures/land-use-structure.en.png)
...
![Mobility, blue-green and Two Lines section](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, commitments and evidence status](assets/figures/metrics-evidence.en.png)
