...
| --- | --- | --- | --- |
| 倡议桌 `[data:geometry/public_space.geojson#PUBLIC-004]` | 让居民提出活动、问题或服务交换 | 纸质卡、公告夹与现场主持人 | 轮椅膝部空间、圆角、清晰通道；争议或高风险内容转人工，不公开敏感信息 |
| 共声画廊 `[data:geometry/public_space.geojson#PUBLIC-005]` | 展示经授权的声音、作品和多语说明 | 印刷大字版、触摸复制件、人工讲述 | 控制音量与眩光，提供字幕/文字稿；来源或授权不明即停止展示 |
| 慢行客厅 `[data:geometry/public_space.geojson#PUBLIC-006]` | 在连续慢行线上提供休息、会面和小型活动 | 固定座椅、纸质地图、人工问路点 | 连续无障碍路径、轮椅回转、遮阴照明与应急净空；不得阻断疏散和骑行视距 |
| 邻里平台 `[data:geometry/public_space.geojson#PUBLIC-007]` | 发布小圈活动、资源目录与人工转介 | 社区柜台、电话树与纸质日历 | 默认最小可见、活动负责人可识别；无人工负责人或退出渠道时不发布 |
...
| JZ-05 慢行客厅与四类触点 | 廊道网络；公共空间/可逆设施 | 专业设计团队、无障碍复核者、社区运营者 | 门 B：逐段现场审计通过；交付节点样板、材料维护手册和分段实施包 | 无障碍、景观、照明、树木、排水和公共安全复核 | 测绘/样板/材料/维护待专业测算；占用、施工与长期养护待授权 | 坡度、树木、排水、照明或管理责任无法闭合时停止该节点实施 | [metric:green_public_space_ratio] 保持可复算；样板通过轮椅回转、停留、夜间识读和人工维护检查 |
...
- **agent.4 AI 公共空间、智能原生新业态与朝圣地标设计**：以东西缝合、南北贯通连接三座技能地标；在大钟寺仅测试自愿的智能原生服务；荣誉展示不排名且可撤回；倡议桌、共声画廊、慢行客厅、邻里平台组件库均有非数字后备、安全与无障碍条件。
