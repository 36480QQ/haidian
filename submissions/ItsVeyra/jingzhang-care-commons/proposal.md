...
| 新加坡 Kampung Admiralty [source:CASE-KAMPUNG-ADMIRALTY-HDB] | 复合组织居住、社区、照护和公共空间 | 三核周边优先做跨服务协同与可达界面 | 2026-08-08 命令行核验官方 HDB 页面返回 HTTP 403；保留官方发布者/URL，未使用成效数字，且不能据其建筑形态推导海淀容量或控规 |
