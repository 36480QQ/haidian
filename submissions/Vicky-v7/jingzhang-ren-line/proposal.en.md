---
title: "The REN Line: A Human-AI Push-Pull Belt for the Centennial Jing-Zhang AI Innovation Belt"
...
summary: "The first-principles metaphor is Zhan Tianyou's zigzag railway and its front-and-rear locomotive traction: human and AI work as two locomotives, one pulling and one pushing — and exchanging roles visibly at the switchback — to move the city up the slope of intelligence. Spatially organised as one spine, two tracks, nine switches and three stations; all spatial suggestions are conceptual, based on a provisional boundary, and do not replace statutory planning."
...
8. OpenStreetMap existing-condition base data (© OpenStreetMap contributors, ODbL, extracted 2026-08-17) [source:OSM-BASEMAP].
