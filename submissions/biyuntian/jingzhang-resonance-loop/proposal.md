...
![京张共振环概念标识：两条线在三点形成共振，并分别生成算力花园、知识前台与站城门三类空间构件](assets/figures/resonance-mark.svg)

标识不止是一枚图形，而是三种可被辨认的空间语法：**算力花园**以树荫庭院和可移动解释形成“留白的测试”；**知识前台**以边侧服务、共享工作台和可撤回成果卡形成“面对人的转化”；**站城门**以可停留门廊、实体导向和夜间问询形成“回到日常的技术”。三类构件共享双线和三色，但不复制同一建筑、桥梁、环形节点或屏幕形态；任何实际标识、材料、尺度、安装、照明和无障碍细节仍待专业设计与相关程序确认。
...
R04-C 不以“多做几个场景”进入下一轮，而以**一处约120米的概念公共路线、4个决策点、1个无障碍服务湾和100天限定样板**聚焦深化。120米与3.0米公共路线、4.8米边侧前台仅用于同一概念模型的关系比选和后续测绘任务书，不是现状测量、施工尺寸、消防通道、许可或建设承诺 [metric:r04_pilot_corridor_length_m] [metric:r04_pilot_decision_point_count]。

五级尺度将同一 R04 编号从城市关系、片区接口、1:500概念平面、1:200公共基线/边侧前台剖面推进至1:50可拆节点；所有尺度仍受“正式资料与专项审查优先”的表达边界约束。这样，空间判断不再停留在一张服务卡：一条普通路径、一个人工交接、一个可撤回信息层和一个暂停/撤场出口可以在同一设计对象中交叉审查。

| 交接材料 / 决策 | 建议准备人或接口 | 谁拥有是否进入下一门的决定权 | 需要留存什么 | 边界说明 |
| --- | --- | --- | --- | --- |
| G0 场地、权利、开放和风险核验单 | 场地/运营接口与后续专业顾问 | 合法权利人及相应专业审查程序；本方案不代替决定 | 正式资料清单、缺口清单与不实施项 | 120米、3.0米、4.8米均为概念关系尺度，非测绘/非施工 |
| G1 公共基线服务卡 | 现场服务/无障碍/维护接口 | 场地运营责任人与无障碍、安全复核 | 路径、实体导向、人工值守、遮阴/坐憩的可用性记录 | 未通过时只保留普通服务，不叠加 AI 层 |
| G2 授权、撤回与可拆层责任卡 | 开源/权利服务与现场维护接口 | 内容权利人与现场责任人共同确认 | 授权摘要、署名、撤回入口、撤场和人工接管记录 | 不采集额外个人数据；权利不清即不展示 |
| G3 100天复核与复位纪要 | 独立复核、使用者反馈与运营接口 | 人类复核组提出保留/修订/停止建议；后续程序依法决定 | 匿名汇总、投诉/纠错、复位照片或记录、下一轮任务书 | 现场结果当前为0 / not field-run，不以图纸替代实测 |

| 100天阶段 | 进入门 | 仅在这一阶段交付什么 | 失败时怎么办 |
| --- | --- | --- | --- |
| 0—15日 | G0 场地、权利、开放时段、无障碍与风险核验 | 核验单与不实施清单 | 保持普通开放和桌面方案 |
| 16—35日 | G1 普通公共基线先行 | 连续路线、实体导向、人工咨询、坐憩遮阴 | 不进入任何可选信息层 |
| 36—70日 | G2 人工在场、授权、撤回、维护与撤场责任齐备 | 限时可撤回成果卡和检查记录 | 下架内容，回到普通服务 |
| 71—100日 | G3 人类复核 | 聚合复核、撤场复位和 adopt / revise / stop 建议 | 不自动扩容；选择 revise 或 stop |

三份测量契约只定义未来如何判断：无账号来访者能否到达人工前台、内容撤回后能否仍被解释、暂停后普通服务能否立即复位。每一契约均设定普通服务基线、可选信息层与停止条件；当前现场结果为 **0 / not field-run**，不得由设计图或合成规则替代 [metric:r04_measurement_contract_count] [metric:r04_field_result_count] [metric:r04_pilot_duration_days]。

四道门的数量与门禁逻辑另见 [metric:r04_readiness_gate_count]。
...
“三区两翼”不是对既有合作、政府承诺或实施主体的陈述，而是为后续调研、议题交换和任务书编制预留的**建议接口**。三核公共验证线承担日常公共底线；中关村科技服务翼负责研究—孵化—资本服务的可读交接；小月河场景翼承接教育、健康、能源与公园运维的低风险场景核验。北部社区、未来科学城、怀柔科学城、北京经开区与京津冀仅作为区域对照和未来研究窗口，不预设项目、资金、园区管理权或合作关系。

| 接口层级 | 建议承担的空间/服务问题 | 可交换的最小材料 | 进入下一步前仍须核验 | 不应被误读为 |
| --- | --- | --- | --- | --- |
| 三核公共验证线（众智园—AI 原点—大钟寺） | 公共慢行、人工问询、可撤回信息层与日常服务 | 问题地图、服务责任卡、暂停/复位记录 | 现状边界、无障碍、文保、消防、维护责任 | 已批准建设或同步实施 |
| 中关村科技服务翼 | 基础研究、开源贡献、孵化、知识产权与资本服务之间的空间交接 | 研究简报、授权/署名说明、场景适配和非排他资源对接记录 | 服务主体、权利边界、数据合规与场地条件 | 指定招商、融资或入驻承诺 |
| 小月河场景翼 | AI+教育、健康、能源、慢行与公园运维的公共场景 | 非数字基线、人工接管流程、匿名反馈摘要 | 行业资质、设备安全、数据授权、专业评估 | 已部署系统或实时公共服务 |
| 区域协同观察窗（北部社区、未来科学城、怀柔科学城、经开区、京津冀） | 议题对照、案例互读、人才/活动研究与后续任务书 | 公开案例卡、问题清单、年度研究议题 | 各地正式政策、主体授权和独立程序 | 跨区域政府合作或资源配置承诺 |

![三区两翼与区域协同：三核公共验证线、中关村科技服务翼、小月河场景翼及区域观察窗均为建议接口](assets/figures/land-use-structure.png)
