...
S06 同时提出按未来依法确认的 90 日试点直接成本包络研究预留 10%—15% 的退出准备金，用于动态接口停用、数据清理与访问撤销、导视校正、人工服务恢复、设备撤离、场地修复和独立退出复核。该比例是参与者提出的概念控制带，不是报价、预算批复、采购条件、资金来源或拨款承诺；实际范围和比例应在需求、场地、责任和合法程序明确后另行确定。
...
v2.1 的价值在于把“建议做什么”进一步拆成“为什么、由谁复核、缺什么不能开始、失败时如何停止、退出后留下什么”。后续深化应优先补充正式 GIS/CAD、权属与建筑调查、交通和无障碍现场核验、文保、水务、市政、消防、生态、运营、采购与全寿命成本资料；同时通过可访问的线上、线下、电话、纸质和人工渠道邀请受影响公众参与。
...
Version 2.1 separates implementation decisions into two gates that cannot substitute for each other.
...
S06 also proposes studying an exit reserve of 10–15% of a future lawfully confirmed direct-cost envelope for a 90-day pilot. It would cover dynamic-interface shutdown, data clearance and access revocation, sign correction, restoration of staffed service, equipment removal, site repair, and independent exit review. This is a participant-authored conceptual control band, not a quotation, approved budget, procurement condition, funding source, or funding commitment. The actual scope and percentage must be determined after need, site, responsibility, and lawful procedures are established.
