...
百年前，京张铁路以工程理性让速度服从山势；今天，百年京张 AI 创新带应让技术速度服从城市尺度与公共利益。**轨迹织城 / RailWeave Open City**以连续公共空间为城市经线，以清河、小月河与高校、转河三条区域协同廊道为城市纬线，以可准入、可暂停、可解编的 AI 应用为技术线程，形成“一轴三廊三核、三链协同”的总体结构。先织牢公共空间、普通服务和区域协同，再有序织入智能应用；即使 AI 暂停，城市基本服务仍可连续运行。
...
四阶段、六个决策窗口、六包 BoQ 和 E0—E6 只在后文“首个100日限定样布”完整呈现一次。当前成果已形成实施准备包；现场启动仍须由有权主体完成 G0 前置核验，下一步为 E0 场地与授权核验，合成测试不替代现场授权。[data:visual/assets/readiness_decision_receipt.json]
