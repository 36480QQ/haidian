...
- **建筑更新**（概念建议）：以产业用地和商业服务业用地为主，拆除低效批发市场和仓储建筑（现状调研后确定范围），新建AI产业综合体、智·大模型广场和AI企业加速器。建筑体量以高层为主（80-150m，概念建议），沿遗址公园形成产业天际线
...
|------|----------|---------------|-----------------|---------|---------|--------------|
| 一期（启动） | 实施主体（管委会） | 市级规划/发改部门 | 区级部门、开发企业 | 立项批复、资金到位、拆迁安置 | 遗址公园贯通、AI原点社区启动 | 资金或拆迁未达标则暂停扩面 |
