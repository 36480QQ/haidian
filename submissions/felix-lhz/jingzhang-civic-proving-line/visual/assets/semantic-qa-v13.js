...
console.log(JSON.stringify({ok:true,schema:'1.12.0',metric_count:Object.keys(metrics).length,semantic_assertions:Object.keys(required).length,bilingual:true},null,2));
