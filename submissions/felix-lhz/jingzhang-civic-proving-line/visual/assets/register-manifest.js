...
for(const [rel,role,required,language] of entries){
  if(!fs.existsSync(path.join(ROOT,rel)))throw new Error('Cannot register missing V15 file: '+rel);
...
console.log('V15 canonical files registered: '+manifest.files.length);
