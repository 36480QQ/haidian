...
if(answers.schema_version!=='1.9.0')fail('two-answers schema is not 1.9.0');
...
console.log(JSON.stringify({ok:true,schema:'1.9.0',decision_counts:counts,input_hash:decision.summary.input_hash,scenarios:12,core_figures:10,html:'static-offline-pass',browser_runtime:'user_review_required_file_url_policy',package_mib:Number((bytes/1048576).toFixed(2))},null,2));
