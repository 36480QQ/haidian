---
title: "JING-ZHANG CIVIC SUPPORT LINE — Everyday Dignity Infrastructure for Everyone"
...
summary: "A continuous public-service line for sitting, drinking, toileting, caregiving and human help; AI is limited to low-sensitivity demand forecasting, maintenance scheduling and a public service ledger."
...
![Evidence chain and support-line concept](assets/figures/site-overview.en.png)

The current `SITE-001` and three key-area polygons are provisional. They may support concept generation and content review, but not statutory redlines, development rights, construction decisions or precise station claims [data:geometry/site_boundary.geojson#SITE-001]. Repository issue #1029 reports that `PROV-KEY-003`, labelled Dazhongsi, is located near Beijing North Station. Therefore this entry does not attach station-specific actions to that geometry. All Dazhongsi ideas remain non-spatial until a corrected official polygon is issued [source:KEY-AREA-SOURCE].
...
![Walking, blue-green and support network](assets/figures/mobility-bluegreen.en.png)
...
![Metrics and recalculation chain](assets/figures/metrics-evidence.en.png)
