...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SC-01 | AI 文化导览 | 京张遗址公园走廊 8 个节点 [data:geometry/public_space.geojson#PUBLIC-001] | 公开历史资料、授权图片文字、人工策展文本（《著作权法》合理使用 + 授权） | 候选控制者：区文旅局（待主管部门确认）；候选处理者：智能体合作运营方 | 匿名停留计数 90 天，授权资料按合同 | 知情、访问、更正、删除（无个人信息采集，主体权利限于内容更正） | 文化、版权、事实核查人员复核关键叙事 | 内容错误 24h 下架；版权投诉 48h 移除 | 史实错误、素材版权不清、AI 生成内容混同事实 |
...
| SC-03 | 企业服务智能体 | 重点区企业服务中心 | 公开政策文本（《政府信息公开条例》）；企业授权申报数据（《民法典》合同编 + 企业授权） | 控制者：企业自身；处理者：智能体联合体（受托处理） | 企业数据按合同；建议数据本地化 | 企业依《民法典》合同编与《反不正当竞争法》享有合同约定的数据权利（不适用《个人信息保护法》主体权利，因不涉及个人信息处理） | 政策专家复核结论 | 数据泄露 1h 启动响应；72h 通报 | 政策解释错误、数据外泄 |
| SC-04 | AI 公共安全运营复核 | 街区智能体治理终端 [data:geometry/public_space.geojson#PUBLIC-007] | 视频结构化数据（《个人信息保护法》第 26 条公共场所例外 + 区公安审批） | 候选控制者：区公安分局（待主管部门确认）；候选处理者：街道办（受托） | **结构化元数据 7 天；原始视频不入库**（力求符合《个人信息保护法》最小必要原则，实施前需经数据合规专项复核） | 居民依《个人信息保护法》享有知情权与拒绝自动化决策权；结构化元数据若可识别个人则按个人信息处理 | 公安复核所有关键判断（≥1 人/班次） | 误判 5 分钟人工复核；事件 24h 通报 | 误判、隐私扩张（已用 PIPL 第 26 条限制） |
| SC-05 | 机器人低速配送与巡检 | 重点区 + 公园走廊 [data:geometry/roads.geojson#ROAD-GW-01] | 公开路径、限速（《道路交通安全法》）；配送地址末端编号（《民法典》合同编 + 用户授权） | 控制者：配送企业；处理者：机器人运营商 | 配送记录 30 天；地址末端编号（不含完整地址） | 用户享有完整主体权利 | 运营人员复核异常 | 安全事故 1h 现场处置；保险理赔 7 天 | 安全事故、配送冲突 |
...
| SC-07 | AI+ 医疗 | AI 原点社区 5 分钟生活圈 | 电子病历脱敏数据（《医疗机构病历管理规定》+《数据安全法》+ 患者知情同意） | 候选控制者：区卫健委 + 医院（待主管部门确认）；候选处理者：医疗 AI 公司（受托，需三级等保） | **医疗数据本地存储，加密传输；门诊数据 15 年**（依《医疗机构病历管理规定》） | 患者享有知情/访问/更正/可携带/拒绝自动化决策权；删除权受《医疗机构病历管理规定》最低保存期限限制（门诊 15 年、住院 30 年） | 医生复核所有诊断建议 | 误诊 1h 人工复核；数据泄露 1h 启动响应；24h 通报卫健委 | 误诊、数据泄露 |
| SC-08 | AI+ 法律咨询 | AI 原点社区法律援助站 | 公开法律文本、案例库（《政府信息公开条例》+ 中国裁判文书网公开数据） | 候选控制者：区司法局（待主管部门确认）；候选处理者：律所联合体（受托） | 不采集个人敏感信息；咨询记录匿名化 30 天 | 居民享有匿名咨询权 | 律师复核关键建议 | 法律解释错误 48h 修正 | 法律解释错误、责任归属 |
| SC-09 | AI 芯片与基础模型测试验证 ★ | 众智园内核 | 算力使用、模型性能（《数据安全法》+《网络安全法》+ 测试协议） | 候选控制者：国家 AI 平台（待主管部门确认）；候选处理者：企业联合体（受托） | 测试数据本地化；公开指标 5 年 | 测试参与方依合同与《反不正当竞争法》享有商业秘密保护；不适用《个人信息保护法》主体权利（无个人信息处理） | 第三方测试机构复核 | 模型泄露 1h 隔离；72h 通报 | 测试不充分、模型泄露 |
| SC-10 | AI 安全治理与红队测试 ★ | 众智园安全治理实验室 | 攻击样本、防御指标（《网络安全法》+ 国家 AI 安全中心授权） | 候选控制者：国家 AI 安全中心（待主管部门确认）；候选处理者：受认可实验室 | **攻击样本物理隔离存储**；防御指标脱敏 3 年 | 无个人信息主体权利请求 | 安全专家复核所有结论 | 样本外泄 1h 物理隔离；4h 通报 | 攻击样本外泄 |
| SC-11 | AI 标准制定与互操作验证 ★ | 众智园标准化研究院 | 标准草案、互操作测试结果（《标准化法》+ 国家标准化院授权） | 候选控制者：国家标准化院（待主管部门确认）；候选处理者：企业联合体 | 标准草案公开版本；企业测试数据本地 | 标准参与方享有知情权 | 标准化专家复核 | 互操作失败 7 天复盘 | 标准滞后、互操作失败 |
...
> 注 3：本方案不再使用「视频存储 7 天」作为公共安全场景的简化表述；SC-04 已修订为「结构化元数据 7 天、原始视频不入库」，力求符合《个人信息保护法》第 26 条公共场所例外条款的最小必要原则；该合规判断尚需经数据合规专项复核与主管部门确认，非自我认证。
...
| --- | --- | --- | --- | --- |
| 海淀居民（北下关、北太平庄等街道） | 5 分钟生活圈覆盖 1 个社区中心、1 所小学、1 个卫生服务站、1 个口袋公园 | 街道办窗口服务；12345 政务热线；社区中心人工咨询岗 | 步行 400m 内公共服务覆盖率 ≥95%；申诉响应 7 天 | 街道办季度公示；居民代表大会年度审议 |
| 既有商户（大钟寺批发市场、清河南侧工业等） | 拆改留须按《北京市城市更新条例》[source:SRC-BJ-URBAN-RENEWAL-REGULATION] 程序；安置方案须经商户书面同意 | 工作专班逐户走访；街道办法律援助 | 安置协议签署率 100%；过渡期租金补贴覆盖率 ≥80% | 商户代表列席更新决策会议；审计报告 6 个月公开 |
| 照护者（家庭照护、专业护工） | AI+ 医疗场景（SC-07）须设照护者反馈通道；社区喘息服务点 | 社区卫生服务中心线下咨询；社区喘息服务登记 | 照护者申诉响应 ≤48h；喘息服务月度供给量 | 区卫健委季度评估；服务记录 3 年存档 |
| 残障人士 | 公共空间、AI 终端、数字界面须符合《无障碍环境建设法》[standard:BARRIER-FREE-ENVIRONMENT-LAW] 无障碍设计标准 | 盲道、低位服务台、手语视频通话；AI 导览带语音与文字双通道 | 无障碍设施合规率 100%；投诉 24h 响应 | 区残联季度巡查；无障碍审计报告年度公开 |
...
**近期（2026-2028）项目清单**：①大钟寺批发市场片区更新（条件式启动：须先行完成权属核查、文保评估、《北京市城市更新条例》法定程序与利益相关方协商；建议方向为 AI 企业总部与智能终端展示带，约 30 ha，投资规模待 official 权属、企业与政府投资条件确认；本方案不预设具体数字）；②大钟寺站一体化改造（轨道接驳、四象限步行连通、站前公共空间）；③大钟寺 AI 里程碑公园建设（约 1.5 ha 概念规模）；④京张遗址公园走廊南段先导示范（约 2 公里）；⑤AI 智能体贡献荣誉墙一期建设。实施主体：建议海淀区 + 大钟寺企业联合体；政策建议：现行中关村科技创新政策 + 海淀区城市更新专项资金。
