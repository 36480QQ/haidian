...
| SC-09 | AI 芯片与基础模型测试验证 ★ | 众智园内核 | 算力使用、模型性能（《数据安全法》+《网络安全法》+ 测试协议） | 候选控制者：国家 AI 平台（待主管部门确认）；候选处理者：企业联合体（受托） | 测试数据本地化；公开指标 5 年 | 测试参与方依合同与《反不正当竞争法》享有商业秘密保护；不适用《个人信息保护法》主体权利（无个人信息处理） | 第三方测试机构复核 | 模型泄露 1h 隔离（运营设计目标）；72h 通报（运营设计目标） | 测试不充分、模型泄露 |
| SC-10 | AI 安全治理与红队测试 ★ | 众智园安全治理实验室 | 攻击样本、防御指标（《网络安全法》+ 国家 AI 安全中心授权） | 候选控制者：国家 AI 安全中心（待主管部门确认）；候选处理者：受认可实验室 | **攻击样本物理隔离存储**；防御指标脱敏 3 年 | 无个人信息主体权利请求 | 安全专家复核所有结论 | 样本外泄 1h 物理隔离（运营设计目标）；4h 通报（运营设计目标） | 攻击样本外泄 |
...
| 残障人士 | 公共空间、AI 终端、数字界面须符合《无障碍环境建设法》[standard:BARRIER-FREE-ENVIRONMENT-LAW] 无障碍设计标准 | 盲道、低位服务台、手语视频通话；AI 导览带语音与文字双通道 | 无障碍设施合规率 100%（设计目标，测量协议待 official 基线）；投诉 24h 响应（运营设计目标） | 区残联季度巡查；无障碍审计报告年度公开 |
...
| R-15 | 全球开发者荣誉墙·里程碑公园完成 | 远期 | T3（用地与构筑物审批） |
