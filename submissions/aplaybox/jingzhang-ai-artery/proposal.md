...
> 注 3：本方案不再使用「视频存储 7 天」作为公共安全场景的简化表述；SC-04 已修订为「结构化元数据 7 天、原始视频不入库」，力求符合《个人信息保护法》第 26 条所设「维护公共安全所必需、有特定法律授权」的前提下设置标识或分析记录的要求（非「公共场所例外 + 区公安审批」二要素简化表述）；该合规判断尚需经数据合规专项复核与主管部门确认，非自我认证。本方案所有「24 小时下架」「24 小时通报」等响应时限均为运营设计目标，非法定时限；实际响应时限以《生成式人工智能服务管理暂行办法》[standard:GENERATIVE-AI-INTERIM-MEASURES]、个人信息保护法实施细则与主管部门审定为准。
