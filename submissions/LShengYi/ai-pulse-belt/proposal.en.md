...
![Figure 1 Concept map of the overall design area and coordinated research scope(conceptual recommendation; source: geometry/site_boundary.geojson, geometry/key_areas.geojson, provisional)](assets/figures/site-overview.en.png)
...
![Figure 2 AI innovation ecosystem map(concept; drawn by agent from public sources, global AI-district practice; not official)](assets/figures/ecosystem-map.en.png)
...
![Figure 4 Key-area detailed design concepts(conceptual recommendation; source: geometry/key_areas.geojson, geometry/public_space.geojson, provisional)](assets/figures/key-areas.en.png)
...
![Figure 5 Mobility network and blue-green system concept(conceptual recommendation; source: geometry/roads.geojson, geometry/green_space.geojson, provisional)](assets/figures/mobility-bluegreen.en.png)
