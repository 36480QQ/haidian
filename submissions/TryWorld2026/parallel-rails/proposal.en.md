...
| Singapore One-North | Singapore | Long-cycle phasing and reserve flexibility | 16 reserve land annual activation |
...
| # | Project | Type | Location | Dependency |
|---|---------|------|----------|------------|
...
**Phasing** [depth:phasing_implementation]: near term "three stations first" [data:geometry/phasing.geojson#PHASE-001-1] approx. 4.06 million m² [metric:phase1_area_sqm] (stations and spine start together, Gauge Stele Phase I and Switch Plaza prioritised); mid term "corridor stitching" approx. 6.06 million m² [metric:phase2_area_sqm] (corridor, east-west connection, honour belt completion); long term "gateway mending" approx. 1.29 million m² [metric:phase3_area_sqm] (southern gateway and transition segments). Four implementation policies (mechanism suggestions): renewal projects bundled with scenario opening; reserve land activated by annual review; campus interface "negotiated opening + operation compensation"; public participation embedded in city-issue mechanisms throughout. Operation and maintenance: unified operator for public space and landmarks (suggestion), records public in the digital honour archive.
