...
**判断三：显式留白应对数据缺口。** 留白用地 [metric:land_use_area_16_sqm] 88,434 m²（0.8%）位于众智园南侧。留白比例不高，但它的作用是制度性的：官方边界与控规条件发布后，调整可以优先落在留白用地上，而不必推翻整套分区。配套的教育用地 [metric:land_use_area_0804_sqm] 496,648 m²、体育用地 [metric:land_use_area_0805_sqm] 651,681 m²、医疗卫生用地 [metric:land_use_area_0806_sqm] 569,419 m² 与道路用地 [metric:land_use_area_1207_sqm] 89,081 m² 共同支撑公共服务的均衡布局。
