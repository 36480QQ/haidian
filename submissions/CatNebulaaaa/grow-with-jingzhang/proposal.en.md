...
The Jingzhang railway corridor carries a century of industrial memory and links Haidian's universities, research institutes, innovation parks and established communities. It is where renewal of existing urban stock meets the district's concentration of innovation resources. Prepared in response to the open call, this proposal arranges the overall spatial structure, key-district renewal, public-service improvements and near-term projects along the corridor, with the aim of turning planning intent into deliverable, verifiable and assessable implementation.
...
The overall design area forms a spatial structure of "one spine, three districts, two collaborative interfaces and multiple supporting nodes." The structure organises near-term projects and public facilities; it does not replace statutory land use or planning conditions.

- The Jingzhang public-space corridor uses the railway heritage route to close gaps in walking, cycling, canopy, stormwater facilities, public services and cultural information.
...
- Twelve public-service nodes provide staffed consultation, rest, drinking water, charging, paper wayfinding, facility maintenance and service notices.
...
The public notice gives approximately 192.1 ha; the working polygon recalculates to 192.92 ha. The district is assigned controlled testing, public review and facility-maintenance functions. A first-stage validation field of about 1.5 ha allocates 3,200 m² to controlled testing and safety buffer, 900 m² to public review and notice, 1,200 m² to maintenance training, 2,800 m² to rain garden and ecological buffer, and 6,900 m² to the all-age test loop, fire access and logistics.
...
The public notice gives approximately 104.3 ha; the working polygon recalculates to 104.32 ha. The district supports learning and collaboration, open release, talent services and family support. The first phase activates about 3,000 m² of shared ground floor: 900 m² for learning and assembly, 600 m² for open release and short-term display, 520 m² for staffed talent and family services, 680 m² for shared work and small prototypes, and 300 m² reserved for support, accessibility and fire adjustment.
...
The public notice gives approximately 72.0 ha; the working polygon recalculates to 72.05 ha. The district supports interchange, city information, staffed services and public stay. The first study covers an approximately 2.4 ha station-city public-hall interface, improving four-way pedestrian access, adding two staffed service points, multilingual physical wayfinding and all-age stay facilities, and linking to the Innovation Spine pilot.

Delivery proceeds in sequence: passenger-flow and evacuation analysis, confirmation of rail-safety conditions, tenure and commercial operating agreements, wayfinding and paving improvement, and service-node construction. In the near term, wayfinding and staffed-service improvements come first; spatial expansion enters the later construction sequence once evacuation, passenger-flow and rail-safety conditions are secured.
...
Each public-service node is planned at 250–400 m² and uses demountable components wherever possible, so that it can adapt as needs change. A node includes 24–36 m² of staffed service space, together with shaded stay, drinking water, charging, a paper map, service notices and a rain garden. Construction is accompanied by underground-utility coordination, fire review, accessibility design, utility connection, site permitting and maintenance-plan preparation, so that basic services remain continuously available during network or power outages.
...
|---|---|---|---:|---|---|
| P-01 Jingzhang mobility pilot | About 1 km of continuous walking, two-way cycling, rain gardens, shaded rest and service stops | District coordination, subdistrict, rightsholders, transport and landscape specialists | 6–18 months | Official redlines and tenure, rail safety, transport organisation, utility and fire opinions | Public-space funds coordinated; daily maintenance shared by subdistrict and facility operators |
...
| P-03 Zhongzhiyuan R&D test field | About 1.5 ha of controlled testing, safety buffer, public briefing, maintenance training and stormwater facilities | Park operator, university and enterprise testers, independent safety evaluation | 12–24 months | Site tenure, project admission, data security, emergency response and insurance | Construction and testing costs borne by the implementing body; public and park facilities accounted separately |
| P-04 AI Origin shared ground floor | About 3,000 m² of learning and assembly, release, talent services, shared work and support space | Rightsholder, subdistrict, university community, professional operator | 9–18 months | Tenure and leases, building safety, fire review, time-sharing and charging rules | Light adaptation and operating costs estimated together; shared-use and maintenance agreements signed |
| P-05 Public-service-node prototype | 320 m² prototype with staffed service, drinking water and charging, shaded rest and rain garden | Subdistrict, community, landscape and facility operators | 6–12 months | Underground utilities, connections, site permit, fire review and maintenance duty | Capital and annual operating funds defined together; asset and maintenance handover after acceptance |
