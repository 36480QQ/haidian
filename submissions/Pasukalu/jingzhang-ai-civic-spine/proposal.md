...
| 活动 | 频率 | 时间 | 空间载体 | 运营主体 |
| --- | --- | --- | --- | --- |
| 全球AI活动周 | 年度 | 10月 | 一带公共空间全轴 | open-city.ai + 海淀区联合主办 |
...
通过全球AI活动周吸引国际团队，设置"海淀AI入驻快车道"服务窗口，对接科创政策和产业空间。转化路径：活动参与→项目路演→孵化评估→空间匹配→政策对接。不得把招引设想写成已确定承诺 [source:AGENT-TASKBOOK]。
