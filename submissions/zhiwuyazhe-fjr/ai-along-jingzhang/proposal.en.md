...
The source register also determines how far drawings may go. Official textual areas describe task scale; provisional GeoJSON supports clipping and low-confidence recalculation; OSM only identifies positional conflicts; and international cases only provide organisational mechanisms. Web images, map tiles, and third-party trademarks do not enter the deliverables. If the rights or scope of any source changes, the corresponding claim, layer, metric, and figure must be withdrawn or revised together.
