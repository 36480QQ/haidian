...
AI 场景必须落到空间和治理边界：公共空间场景引用 [data:geometry/public_space.geojson#PUBLIC-001]，慢行与交通场景引用 [data:geometry/roads.geojson#ROAD-001]，开放空间场景引用 [data:geometry/green_space.geojson#GREEN-001] 和 [metric:public_space_ratio]、[metric:green_ratio]。这些引用让评审者知道场景不是口号，而是位于具体图层和指标中的设计对象。面向智能体任务书要求不少于10张AI场景卡、不少于3个产业测试验证场景和不少于5类用户画像；本方案已将 10 张场景卡、5 类画像、隐私边界、人工复核和建议运营主体写入正文，并同步进入 HTML、A3/A0 和合规矩阵。
...
三处“AI 朝圣地标”构成公共贡献的可见界面：北段“开源灯塔”以可离线更新的贡献年轮展示经授权的开源项目与公共价值；中段“原点站台”以京张铁路时间轴叠加中关村技术谱系，设置人工策展的成果发布界面；南段“共创穹顶”作为可拆装城市客厅，承载国际路演、居民议事和模型安全公开课。三者均为概念性公共空间组件，不预设建筑审批、投资或实施主体；展示内容需取得授权并提供申诉、更正和退出机制。[standard:MOHURD-URBAN-DESIGN-MEASURES] [data:geometry/public_space.geojson#PUBLIC-001]
