...
**Five regional interfaces.** The proposal uses a problem–capability–credential exchange rather than a list of institutions. Each direction requires separate consent, uses de-identified or public material, and preserves refusal, withdrawal, and non-recognition. [source:DATA-SRC-HAIDIAN-15FYP-20251208] [assumption:A-REGIONAL-SYNERGY-001] [data:visual/assets/site_evidence_baseline.json#REG-NORTH-LATITUDE]

| Directional counterpart | Jing-Zhang input | Minimum exchange output | Intake and exit gate |
| --- | --- | --- | --- |
| Beiwèi Community / AI Origin Community | Resident questions, accessibility gaps, non-digital service experience | De-identified problem card, human-service gap, close reason | Community consent and rights/privacy review; participation does not authorize deployment |
| Future Science City | Edge models, embodied devices, engineering-validation questions | Model card, device passport, failure list, re-test condition | Test owner, IP, and safety scope are explicit; results are not automatically recognized |
| Huairou Science City | Measurement, calibration, and research-method questions | Calibration note, uncertainty statement, independent-review question | Permission and professional responsibility confirmed; no assumed facility or data access |
| Beijing E-Town | Engineering, manufacturing, supply-chain, and maintenance questions | Interoperability evidence, maintenance requirement, stop/recall condition | Voluntary participation, product-safety, and consumer-rights review; no procurement claim |
| Beijing-Tianjin-Hebei | Cross-city common problems and portable rules | Location-agnostic schema, negative result, version difference, maintenance handoff | Local legal and operating review in each jurisdiction; no copying of coordinates or personal data |
